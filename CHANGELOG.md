...
- [`LanguageService.prototype.provideHover`](https://github.com/bhsd-harry/wikiparser-node/wiki/LanguageService#providehover) now provides hover for inline CSS of extension tags, HTML tags and tables
