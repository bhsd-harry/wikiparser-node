...
==`)&&(P++,U=U.slice(1));U=U.toLowerCase();const[M]=U,ie=M==="r"||M==="p"||M==="i",H=M==="{",G=M==="}",K=M==="[",ue=M==="]";let{length:de}=U;if(M==="<"&&!q.has(W.toLowerCase())||K&&y==="ext-link-text"&&(/&(?:rbrack|#93|#x5[Dd];);/u.test(d.slice(P+1))||f!=null&&f.is("ext")&&T==="nowiki"&&((a=f.innerText)!=null&&a.includes("]"))))continue;ue&&(P||de>1)&&l.lastIndex--;let ce=i+P,ne=ce+de,he,ye,V,Y;const fe=m[ne],Se=m[ce-1],Ie=H||K,Ve=H&&Se==="-"&&v.length>0,$e=G&&fe==="-"&&v.length>0,bt=K&&_==="free-ext-link"&&!d.slice(P+1).trim()||ue&&p==="free-ext-link"&&!d.slice(0,P).includes("]");if(ie)he="lonely-http",U=U.toUpperCase(),ye=C.getSeverity(he,U);else if(M==="<"){he="tag-like";let me;/^<\/?\s/u.test(U)||!/[\s/>]/u.test(fe!=null?fe:"")?me="invalid":B.has(W)?me=W:li.has(W)&&!x.includes(W)&&(me="disallowed"),ye=C.getSeverity(he,me)}else if(M==="=")he="syntax-like",ye=C.getSeverity(he,"heading");else if(Ve||$e)he="lonely-bracket",ye=C.getSeverity(he,"converter"),Ve&&P>0?(U="-{",P--,ce--,de=2):$e&&P<d.length-1&&(U="}-",ne++,de=2);else if(bt)he="lonely-bracket",ye=C.getSeverity(he,"extLink");else if(Ie||G||ue)if(he="lonely-bracket",de>1||H&&fe===M||G&&Se===M)ye=C.getSeverity(he,"double");else{if(!K||y!=="ext-link-text"){const me=Rr[M],Le=Ie?d.slice(P+1):d.slice(0,P);if(H&&((u=me.exec(Le))==null?void 0:u[0])==="}"||G&&((o=me.exec(Le))==null?void 0:o[0])==="{")continue;if(!Le.includes(M)){const Me=Ie?"nextSibling":"previousSibling";let Pe=this[Me];for(;Pe&&(Pe.type!=="text"||!me.test(Pe.data));)Pe=Pe[Me];if(Pe&&me.exec(Pe.data)[0]!==M)continue}}ye=C.getSeverity(he,"single")}else he="lonely-http",ye=C.getSeverity(he);if(!ye)continue;const te=this.posFromIndex(P),{line:it,character:qt}=ms(w,A,te.top+1,te.left);if(M==="="){const me=d.indexOf(`
`,P);let Le=f,Me;if(me===-1){let Pe=0;for(;Le&&!(Le.type==="text"&&(Pe=Le.data.indexOf(`
...
`})}}}}),Ya,Yu=I({"src/paramLine.ts"(){"use strict";J(),Ya=class extends z{get type(){return"param-line"}}}}),Za={};ae(Za,{ParamTagToken:()=>ir});var ir,eo=I({"src/multiLine/paramTag.ts"(){"use strict";X(),be(),Ys(),D(),sr(),Yu(),ir=class extends Xs{constructor(e,t,s=N.getConfig(),n=[],r){super(void 0,s,n,{}),t&&this.safeAppend(t.split(`
`).map(i=>r?i:ws(i,s,n,e)).map(i=>new Ya(i,s,n,{}))),n.splice(n.indexOf(this),1),n.push(this)}lint(e=this.getAbsoluteIndex()){{const t="no-ignored",{lintConfig:s}=N,n=s.getSeverity(t,this.name);if(!n)return[];const r=new pe(this,e),i=N.msg("invalid-parameter",this.name),l=[];for(const a of this.childNodes){a.setAttribute("aIndex",e);const u=a.childNodes.filter(({type:o})=>o!=="comment"&&o!=="include"&&o!=="noinclude");if(u.some(({type:o})=>o==="ext"))l.push(Q(a,r,t,i,n));else{const o=u.findIndex(({type:c})=>c!=="text"),d=u.slice(0,o===-1?void 0:o).map(String).join("");if(d&&!(o===-1?/^[a-z]+(?:\[\])?\s*=/iu:/^[a-z]+(?:\[\])?\s*(?:=|$)/iu).test(d)){const c=Q(a,r,t,i,n);s.computeEditInfo&&(c.suggestions=[ee(c)]),l.push(c)}else{const c=a.lint(e,!1);c.length>0&&Array.prototype.push.apply(l,c)}}e+=a.toString().length+1}return l}}}}}),ll,$i,al,_t,to=I({"src/heading.ts"(){"use strict";var e,t,Os,n;X(),Re(),be(),De(),D(),J(),mt(),ll=[Ue],_t=(n=class extends(al=z){constructor(i,l,a,u=[]){super(void 0,a,u);R(this,t);R(this,e);E(this,e,i);const o=new z(l[0],a,u);o.type="heading-title",o.setAttribute("stage",2);const d=new ze(l[1],"heading-trail",a,u);this.append(o,d)}get type(){return"heading"}get level(){return b(this,e)}toString(i){const l=j(this,t,Os).call(this);return l+this.firstChild.toString(i)+l+this.lastChild.toString(i)}text(){const i=j(this,t,Os).call(this);return i+this.firstChild.text()+i}getAttribute(i){return i==="invalid"?this.inHtmlAttrs()===2:i==="padding"?this.level:super.getAttribute(i)}getGaps(){return this.level}lint(i=this.getAbsoluteIndex(),l){{const a=super.lint(i,l),{firstChild:u,level:o}=this,d=u.toString(),c=d.startsWith("="),f=c||d.endsWith("="),g=new pe(this,i),y=this.inHtmlAttrs(),$=["h1","unbalanced-header","format-leakage"],{lintConfig:k}=N,{computeEditInfo:_,fix:T}=k,p=$.map(h=>k.getSeverity(h,"apostrophe"));if(p[0]&&this.level===1){const h=Q(u,g,$[0],"<h1>",p[0]);_&&!f&&(h.suggestions=[Be(h,"h2",`=${d}=`)]),a.push(h)}if(p[1]&&f){const h=N.msg("unbalanced-in-section-header",'"="'),m=Q(u,g,$[1],h,p[1]);if(!(!_||d==="="))if(c){const[x]=/^=+/u.exec(d),S=o+x.length;m.suggestions=[{desc:`h${o}`,range:[m.startIndex,m.startIndex+x.length],text:""}],S<7&&m.suggestions.push({desc:`h${S}`,range:[m.endIndex,m.endIndex],text:x})}else{const x=/[^=](=+)$/u.exec(d)[1],S=o+x.length;m.suggestions=[{desc:`h${o}`,range:[m.endIndex-x.length,m.endIndex],text:""}],S<7&&m.suggestions.push({desc:`h${S}`,range:[m.startIndex,m.startIndex],text:x})}a.push(m)}if(y){const h="parsing-order",m=k.getSeverity(h,y===2?"heading":"templateInTable");m&&a.push(Z(this,g,h,"header-in-html",m))}if(p[2]){const h=this.getRootNode().toString(),m=u.childNodes.filter(Zs("quote")),x=m.filter(({bold:v})=>v),S=m.filter(({italic:v})=>v);if(x.length%2){const v=Q(x[x.length-1],{...g,start:i+o,left:g.left+o},$[2],N.msg("unbalanced-in-section-header","bold-apostrophes"),p[2]);if(_||T){const w=i+o+d.length,A=ee(v);h.slice(v.endIndex,w).trim()?_&&(v.suggestions=[A,Ze(w,"'''")]):x.length===1&&S.length===0?v.fix=A:_&&(v.suggestions=[A])}a.push(v)}if(S.length%2){const v=Q(S[S.length-1],{start:i+o},$[2],N.msg("unbalanced-in-section-header","italic-apostrophes"),p[2]);if(_||T){const w=i+o+d.length;h.slice(v.endIndex,w).trim()?_&&(v.suggestions=[Ze(w,"''")]):S.length===1&&x.length===0?v.fix=ee(v):_&&(v.suggestions=[ee(v)])}a.push(v)}}return a}}print(){const i=j(this,t,Os).call(this);return super.print({pre:i,sep:i})}json(i,l=this.getAbsoluteIndex()){{const a=super.json(void 0,l);return a.level=this.level,a}}},e=new WeakMap,t=new WeakSet,Os=function(){return"=".repeat(this.level)},n),$i=oe(al),_t=le($i,0,"HeadingToken",ll,_t),re($i,1,_t)}}),ol,_i,ul,ss,Zu=I({"src/hidden.ts"(){"use strict";xt(),J(),ol=[tt()],ss=class extends(ul=z){get type(){return"hidden"}getAttribute(e){return e==="invalid"||super.getAttribute(e)}},_i=oe(ul),ss=le(_i,0,"HiddenToken",ol,ss),re(_i,1,ss)}}),dl,Ti,cl,is,ed=I({"src/arg.ts"(){"use strict";var e,so,s;ve(),X(),be(),st(),Gs(),De(),D(),J(),ft(),Zu(),dl=[Ue,Ge("{{{"),ys()],is=(s=class extends(cl=z){constructor(r,i,l=[]){super(void 0,i,l,{});R(this,e);for(let a=0;a<r.length;a++){const u=r[a];if(a===0){const o=new We(u,"arg-name",i,l,{});super.insertAt(o)}else if(a>1){const o=new ss(u,i,l);super.insertAt(o)}else{const o=new z(u,i,l);o.type="arg-default",o.setAttribute("stage",2),super.insertAt(o)}}}get type(){return"arg"}get default(){var r,i;return(i=(r=this.childNodes[1])==null?void 0:r.text())!=null?i:!1}toString(r){return`{{{${super.toString(r,"|")}}}}`}text(){return`{{{${pt(this.childNodes.slice(0,2),"|")}}}}`}afterBuild(){j(this,e,so).call(this),super.afterBuild()}lint(r=this.getAbsoluteIndex(),i){{const{childNodes:[l,a,...u]}=this;l.setAttribute("aIndex",r+3);const o=l.lint(r+3,i);if(a){const $=r+4+l.toString().length;a.setAttribute("aIndex",$);const k=a.lint($,i);k.length>0&&Array.prototype.push.apply(o,k)}const d=["no-ignored","no-arg"],{lintConfig:c}=N,{computeEditInfo:f}=c,g=new pe(this,r),y=d.map($=>c.getSeverity($,"arg"));if(y[0]&&u.length>0&&Array.prototype.push.apply(o,u.map($=>{const k=Q($,g,d[0],"invisible-triple-braces",y[0]);return k.startIndex--,k.startCol--,f&&(k.suggestions=[ee(k),Pt(k.startIndex,"{{!}}")]),k})),y[1]&&!this.getAttribute("include")){const $=Z(this,g,d[1],"unexpected-argument",y[1]);f&&a&&($.suggestions=[Be($,"expand",a.text())]),o.push($)}return o}}print(){return super.print({pre:"{{{",post:"}}}",sep:"|"})}json(r,i=this.getAbsoluteIndex()){{const l=super.json(void 0,i);return l.default=this.default,l}}},e=new WeakSet,so=function(){this.setAttribute("name",this.firstChild.text().trim())},s),Ti=oe(cl),is=le(Ti,0,"ArgToken",dl,is),re(Ti,1,is)}}),io={};ae(io,{parseBraces:()=>Ks});var hl,Ci,Ts,Ii,Ni,Li,gl,Fi,Ks,nr=I({"parser/braces.ts"(){"use strict";et(),ve(),to(),qa(),ed(),hl={"=":String.raw`\n(?!(?:[^\S\n]|\0\d+[cn]\x7F)*\n)`,"{":String.raw`\}{2,}|\|`,"-":String.raw`\}-`,"[":String.raw`\]\]`},Ci=String.raw`\[(?!\[)`,Ts=String.raw`\n(?![=\0])`,Ii=String.raw`|\{{2,}`,Ni=new Map([["!","!"],["!!","+"],["(!","{"],["!)","}"],["!-","-"],["=","~"],["server","m"]]),Li=ct(e=>new RegExp(e,"gmu")),gl=new RegExp(String.raw`\{\{((?:[^\n{}[]|${Ci}|${Ts})*)\}\}(?!\})`+"|"+String.raw`\[\[(?:[^\n[\]{]|${Ts})*\]\]`+"|"+String.raw`-\{(?:[^\n{}[]|${Ci}|${Ts})*\}-`,"gu"),Fi=e=>{const t=jt(Ce(e));return Ni.has(t)?Ni.get(t):/^(?:filepath|(?:full|canonical)urle?):./u.test(t)?"m":/^#vardefine:./u.test(t)?"n":"t"},Ks=(e,t,s)=>{var y,$,k,_,T;const n=String.raw`${t.excludes.includes("heading")?"":String.raw`^((?:\0\d+[cno]\x7F)*)={1,6}|`}\[\[|-\{(?!\{)`,{parserFunction:[,,,r]}=t,i=[],l=[],a=(p,h,m,x)=>{h[h.length-1].push(Ee(p.slice(m,x),l))};let u;do u!==void 0&&(e=u),u=e.replace(gl,(p,h,m)=>{if(h!==void 0||typeof m=="string")try{const{length:x}=s,S=(h!=null?h:m).split("|");return new ot(Ee(S[0],l),S.slice(1).map(v=>{const w=v.indexOf("=");return(w===-1?[v]:[v.slice(0,w),v.slice(w+1)]).map(A=>Ee(A,l))}),t,s),`\0${x}${Fi(S[0])}`}catch(x){if(!(x instanceof SyntaxError)||x.message!=="Invalid template name")throw x}return l.push(Ee(p,l)),`\0${l.length-1}`});while(u!==e);e=u;const o=e.lastIndexOf("}}")-e.length;let d=o+e.length!==-1,c=Li(n+(d?Ii:"")),f=c.exec(e),g;for(;f||g!==void 0&&g<=e.length&&(($=(y=i[i.length-1])==null?void 0:y[0])!=null&&$.startsWith("="));){if(f!=null&&f[1]){const[,{length:B}]=f;f[0]=f[0].slice(B),f.index+=B}const{0:p,index:h}=f!=null?f:{0:`
`,index:e.length},m=(k=i.pop())!=null?k:{},{0:x,index:S,parts:v,findEqual:w,pos:A}=m,C=p==="="&&w;if(p==="]]"||p==="}-")g=h+2;else if(p===`
`){g=h+1;const{pos:B,findEqual:q}=(_=i[i.length-1])!=null?_:{};if(B===void 0||q||Ce(e.slice(B,S))!==""){const O=/^(={1,6})(.+)\1((?:\s|\0\d+[cn]\x7F)*)$/u.exec(e.slice(S,h));O&&(O[2]=Ee(O[2],l),O[2].includes(`
`)||(e=`${e.slice(0,S)}\0${s.length}h${e.slice(h)}`,g=S+4+String(s.length).length,new _t(O[1].length,O.slice(2),t,s)))}}else if(p==="|"||C)g=h+1,a(e,v,A,h),p==="|"&&v.push([]),m.pos=g,m.findEqual=p==="|",i.push(m);else if(p.startsWith("}}")){const B=p.slice(0,Math.min(x.length,3)),q=x.length-B.length,{length:O}=s;g=h+B.length,a(e,v,A,h);let W=!1,F="t";if(B.length===3){const P=v.map(M=>M.join("=")),U=P.length>1&&Ce(P[1]).trim();new is(P,t,s),U&&U.endsWith(":")&&r.includes(U.slice(0,-1).toLowerCase())&&(F="s")}else try{new ot(v[0][0],v.slice(1),t,s),F=Fi(v[0][0])}catch(P){if(P instanceof SyntaxError&&P.message==="Invalid template name")W=!0;else throw P}W||(e=`${e.slice(0,S+q)}\0${O}${F}${e.slice(g)}`,g=S+q+3+String(O).length,q>1?i.push({0:x.slice(0,q),index:S,pos:S+q,parts:[[]]}):q===1&&e[S-1]==="-"&&i.push({0:"-{",index:S-1,pos:S+1,parts:[[]]}))}else g=h+p.length,p.startsWith("{")&&(f.pos=g,f.parts=[[]]),i.push(..."0"in m?[m]:[],f);let L=i[i.length-1];if(d&&o+e.length<g)for(d=!1;(T=L==null?void 0:L[0])!=null&&T.startsWith("{");)i.pop(),L=i[i.length-1];c=Li(n+(d?Ii:"")+(L?`|${hl[L[0][0]]}${L.findEqual?"|=":""}`:"")),c.lastIndex=g,f=c.exec(e)}return Ee(e,l)}}}),no={};ae(no,{InputboxToken:()=>ro});var ro,td=I({"src/multiLine/inputbox.ts"(){"use strict";Ys(),nr(),D(),eo(),ro=class extends ir{constructor(e,t,s=N.getConfig(),n=[]){const r=Symbol("InputboxToken"),i=s.excludes.includes("heading")?s:{...s,excludes:[...s.excludes,"heading"]},{length:l}=n;n.push(r),t&&(t=ws(t,i,n,e)),t&&(t=Ks(t,i,n)),n.splice(l,1),super(e,t,i,n,{})}}}}),Bs={};ae(Bs,{NestedToken:()=>lo});var pl,fl,lo,Ei=I({"src/nested.ts"(){"use strict";var e,t,s;X(),be(),Ys(),nr(),D(),J(),To(),Bt(),pl=new Set(["comment","include","arg","template","magic-word"]),fl=[!1,!0].map(n=>{const r=n?"includeonly":"noinclude";return new RegExp(String.raw`^(?:<${r}(?:\s[^>]*)?/?>|</${r}\s*>)$`,"iu")}),lo=(s=class extends z{constructor(r,i,l,a,u=[]){if(typeof i=="boolean"){const o=Symbol("NestedToken"),{length:d}=u;u.push(o),r&&(r=ws(r,a,u,i)),r&&(r=Ks(r,a,u)),u.splice(d,1)}else r&&(r=r.replace(i,(o,d,c,f,g)=>{const y=`\0${u.length+1}e`;return new Nt(d,c,f,g,a,!1,u),y}));r&&(r=r.replace(/(^|\0\d+.\x7F)([^\0]+)(?=$|\0\d+.\x7F)/gu,(o,d,c)=>(new je(c,a,u),`${d}\0${u.length}n`)));super(r,a,u);R(this,e);R(this,t);E(this,e,[...l]),E(this,t,i)}get type(){return"ext-inner"}lint(r=this.getAbsoluteIndex(),i){{const l=super.lint(r,i),a="no-ignored",{lintConfig:u}=N,o=u.getSeverity(a,this.name);if(!o)return l;const d=new pe(this,r),c=typeof b(this,t)=="boolean"?fl[b(this,t)?1:0]:/^<!--[\s\S]*-->$/u;return[...l,...this.childNodes.filter(f=>{const{type:g,name:y}=f;if(g==="ext")return!b(this,e).includes(y);if(pl.has(g))return!1;const $=f.toString().trim();return $&&!c.test($)}).map(f=>{const g=Q(f,d,a,N.msg("invalid-content",this.name),o);return u.computeEditInfo&&(g.suggestions=[ee(g),zn(g,f.toString())]),g})]}}},e=new WeakMap,t=new WeakMap,s)}});function ml(e,t,s,n,r){t=Ce(t).trim();let i=t.replace(e==="link"?/\0\d+[tq]\x7F/gu:/\0\d+t\x7F/gu,"").trim();switch(e){case"width":return!i&&!!t||/^(?:\d+x?|\d*x\d+)(?:\s*px)?$/u.test(i);case"link":{if(i){if(ao(s.protocol).test(i))return oo(s.protocol).test(i)&&t;i.startsWith("[[")&&i.endsWith("]]")&&(i=i.slice(2,-2))}else return t;const l=N.normalizeTitle(i,0,!1,s,{halfParsed:n,decode:!0,selfLink:!0,page:""});return l.valid&&l}case"lang":return(r==="svg"||r==="svgz")&&!/[^a-z\d-]/u.test(i);case"alt":case"class":case"manualthumb":return!0;case"page":return(r==="djvu"||r==="djv"||r==="pdf")&&Number(i)>0;default:return!!i&&!isNaN(i)}}var ao,oo,xl,vl,Us,bl,uo,sd=I({"src/imageParameter.ts"(){"use strict";var e,t,co,r;et(),ve(),X(),He(),Re(),D(),J(),ao=ct(i=>new RegExp(String.raw`^(?:${i}|//|\0\d+m\x7F)`,"iu")),oo=ct(i=>new RegExp(String.raw`^(?:(?:${i}|//)${Ft}|\0\d+m\x7F)${Et}$`,"iu")),xl=ct(i=>new RegExp(String.raw`^(\s*(?!\s))${i.replace("$1","(.*)")}${i.endsWith("$1")?`(?=$|
)`:""}(\s*)$`,"u")),vl=new Set(["alt","link","lang","page","caption"]),Us=new Set(["tiff","tif","png","gif","jpg","jpeg","webp","xcf","pdf","svg","djvu"]),bl=i=>{if(i)i.startsWith("//")&&(i=`https:${i}`);else return i;return new URL(i).href},uo=(r=class extends z{constructor(l,a,u,o){var i=(...n)=>(super(...n),R(this,t),R(this,e,""),this);let d;const c=Object.entries(u.img).map(([g,y])=>[g,y,xl(g)]),f=c.find(([,g,y])=>(d=y.exec(l),d&&(d.length!==4||ml(g,d[2],u,!0,a)!==!1)));if(f&&d){d.length===3?(i(void 0,u,o),E(this,e,l)):(i(d[2],u,o,{}),E(this,e,d[1]+f[0]+d[3])),this.setAttribute("name",f[1]),f[1]==="alt"&&this.setAttribute("stage",ke-1);return}i(l,u.excludes.includes("list")?u:{...u,excludes:[...u.excludes,"list"]},o),this.setAttribute("name","caption"),this.setAttribute("stage",7)}get type(){return"image-parameter"}get thumb(){return this.name==="manualthumb"?this.normalizeTitle(`File:${super.text().trim()}`,6,{page:""}):void 0}get link(){{if(this.name!=="link")return;const l=super.text().trim();return we.run(()=>{const a=new z(l,this.getAttribute("config"));return a.parseOnce(0,this.getAttribute("include")).parseOnce(),/^\0\d+m\x7F/u.test(a.toString())?l:ml("link",l,this.getAttribute("config"))})}}afterBuild(){var l;(l=this.parentNode)!=null&&l.is("gallery-image")&&!vl.has(this.name)&&this.setAttribute("name","invalid"),super.afterBuild()}toString(l){return b(this,e)?b(this,e).replace("$1",super.toString(l)):super.toString(l)}text(){return b(this,e)?b(this,e).replace("$1",super.text()).trim():super.text().trim()}isPlain(){return this.name==="caption"||this.name==="alt"}getAttribute(l){return l==="invalid"?this.name==="invalid":l==="padding"?Math.max(0,b(this,e).indexOf("$1")):super.getAttribute(l)}lint(l=this.getAbsoluteIndex(),a){{const u=super.lint(l,a),{lintConfig:o}=N,{computeEditInfo:d,fix:c}=o,{link:f,name:g}=this,y=g==="width"&&this.getValue();if(g==="invalid"||y&&y.endsWith("px")){const $="invalid-gallery",k=o.getSeverity($,"parameter");if(k){const _=Z(this,{start:l},$,"invalid-image-parameter",k);(d||c)&&(_.fix=y?ee(_,0,y):ee(_,-1)),u.push(_)}}else if(g==="link"){if(typeof f=="string"){const $="invalid-url",k=o.getSeverity($);if(k&&!this.querySelector("magic-word"))try{bl(f)}catch{u.push(Z(this,{start:l},$,"invalid-url",k))}}else if(f.encoded){const $="url-encoding",k=o.getSeverity($,"file");if(k){const _=Z(this,{start:l},$,"unnecessary-encoding",k);(d||c)&&(_.fix=Un(_,this)),u.push(_)}}}else if(g==="manualthumb"){const $="invalid-gallery",k=o.getSeverity($,"thumb");if(k&&!this.querySelector("arg,magic-word,template")){const{valid:_,ns:T,extension:p}=this.thumb;(!_||T!==6||!Us.has(p))&&u.push(Z(this,{start:l},$,"invalid-thumb",k))}}return u}}getValue(){return this.name==="invalid"?this.text():j(this,t,co).call(this)||super.text()}print(){return b(this,e)?`<span class="wpb-image-parameter${this.name==="invalid"?" wpb-invalid":""}">${b(this,e).replace("$1",`<span class="wpb-image-caption">${Rt(this.childNodes)}</span>`)}</span>`:super.print({class:"image-caption"})}},e=new WeakMap,t=new WeakSet,co=function(){return b(this,e)&&!b(this,e).includes("$1")},r)}}),ji,yl,wl,Ri,Pi,Sl,Oi,rr,ho=I({"src/link/file.ts"(){"use strict";X(),be(),D(),Vs(),sd(),ji=new Map([["manualthumb","Thumb"],["frameless","Frameless"],["framed","Frame"],["thumbnail","Thumb"]]),yl=new Set(["arg"]),wl=new Set(["template","magic-word"]),Ri=new Set(["left","right","center","none"]),Pi=new Set(["baseline","sub","super","top","text-top","middle","bottom","text-bottom"]),Sl=e=>{if(e===void 0)return[];const t=/-\{|\}-|\|/gu,s=[];let n=t.exec(e),r=0,i=0;for(;n;){const{0:l,index:a}=n;l!=="|"?r+=l==="-{"?1:-1:r===0&&(s.push(e.slice(i,a)),{lastIndex:i}=t),n=t.exec(e)}return s.push(e.slice(i)),s},Oi=(e,t)=>e.filter(({childNodes:s})=>!s.some(n=>n.text().trim()&&t.has(n.type))),rr=class extends Xe{get type(){return"file"}get extension(){return this.getAttribute("title").extension}constructor(e,t,s,n=[],r="|"){super(e,void 0,s,n,r);const{extension:i}=this.getTitle(!0,!0);this.safeAppend(Sl(t).map(l=>new uo(l,i,s,n)))}lint(e=this.getAbsoluteIndex(),t){var s;{const n=super.lint(e,t),r=Oi(this.getAllArgs(),yl),i=[...new Set(r.map(({name:x})=>x))],l=i.filter(x=>ji.has(x)),a=i.filter(x=>Ri.has(x)),u=i.filter(x=>Pi.has(x)),[o]=l,d=o==="framed"||o==="manualthumb",c=new pe(this,e),{lintConfig:f}=N,{computeEditInfo:g,fix:y}=f,{ns:$,extension:k}=this.getAttribute("title"),{firstChild:_}=this;let T="nested-link",p=f.getSeverity(T,"file");if(p&&Us.has(k)&&this.closest("ext-link-text")&&((s=this.getValue("link"))==null?void 0:s.trim())!==""){const x=Z(this,c,T,"link-in-extlink",p);if(g||y){const S=this.getArg("link");if(S){const v=e+S.getRelativeIndex();x.fix={desc:N.msg("delink"),range:[v,v+S.toString().length],text:"link="}}else x.fix=Hs(x.endIndex-2,"delink","|link=")}n.push(x)}if(T="invalid-gallery",p=f.getSeverity(T,"extension"),p&&$===6&&!k&&!_.querySelector("arg,magic-word,template")&&n.push(Z(this,c,T,"missing-extension",p)),p=f.getSeverity(T,"parameter"),p&&d)for(const x of r.filter(({name:S})=>S==="width")){const S=Q(x,c,T,"invalid-image-parameter",p);(g||y)&&(S.fix=ee(S,-1)),n.push(S)}if(r.length===i.length&&l.length<2&&a.length<2&&u.length<2)return n;T="no-duplicate";const h=["unknownImageParameter","imageParameter"].map(x=>f.getSeverity(T,x)),m=(x,S,v,w=!0)=>x.map(A=>{if(p=h[Number(typeof w=="function"?w(A):w)],!p)return!1;const C=Q(A,c,T,N.msg(`${S}-image-parameter`,v),p);return g&&(C.suggestions=[ee(C,-1)]),C}).filter(A=>A!==!1);for(const x of i){if(x==="invalid"||x==="width"&&d)continue;const S=x==="caption";let v=r.filter(({name:w})=>w===x);if(S&&(v=[...v.slice(0,-1).filter(w=>w.text()),...v.slice(-1)]),v.length>1){let w=!S||!k||Us.has(k);if(S&&w){const A=Oi(v,wl);w=A.length>1&&(C=>A.includes(C))}Array.prototype.push.apply(n,m(v,"duplicate",x,w))}}return l.length>1&&Array.prototype.push.apply(n,m(r.filter(({name:x})=>ji.has(x)),"conflicting","frame")),a.length>1&&Array.prototype.push.apply(n,m(r.filter(({name:x})=>Ri.has(x)),"conflicting","horizontal-alignment")),u.length>1&&Array.prototype.push.apply(n,m(r.filter(({name:x})=>Pi.has(x)),"conflicting","vertical-alignment")),n}}getAllArgs(){return this.childNodes.slice(1)}getArgs(e){return this.getAllArgs().filter(({name:t})=>e===t)}getArg(e){{const t=this.getArgs(e);return t[e==="manualthumb"?0:t.length-1]}}getValue(e){var t;return(t=this.getArg(e))==null?void 0:t.getValue()}json(e,t=this.getAbsoluteIndex()){{const s=super.json(void 0,t),{extension:n}=this;return n&&(s.extension=n),s}}}}}),Al,Bi,kl,Tt,go=I({"src/link/galleryImage.ts"(){"use strict";var e,kn,s;X(),He(),st(),D(),J(),ho(),Al=[Ge("")],Tt=(s=class extends(kl=rr){constructor(r,i,l,a,u=[]){let o;if(l!==void 0){const{length:d}=u;o=new z(l,a,u);for(let c=0;c<ke-1;c++)o.parseOnce();u.splice(d,1)}super(i,o==null?void 0:o.toString(),a,u);R(this,e);Ne(this,"privateType","imagemap-image");this.setAttribute("bracket",!1),this.privateType=`${r}-image`,this.seal("privateType",!0)}get type(){return this.privateType}getTitle(r){const i=this.type==="imagemap-image";return this.normalizeTitle(this.firstChild.toString(),i?0:6,{halfParsed:!0,temporary:r,decode:!i,page:""})}lint(r=this.getAbsoluteIndex(),i){{const l=super.lint(r,i),a="invalid-gallery",{lintConfig:u}=N,o=u.getSeverity(a,"image");if(o&&j(this,e,kn).call(this)){const d=Z(this,{start:r},a,"invalid-gallery",o);u.computeEditInfo&&(d.suggestions=[Hs(r,"prefix","File:")]),l.push(d)}return l}}getAttribute(r){return r==="invalid"?j(this,e,kn).call(this):super.getAttribute(r)}},e=new WeakSet,kn=function(){const{ns:r}=this.getAttribute("title");return r!==6},s),Bi=oe(kl),Tt=le(Bi,0,"GalleryImageToken",Al,Tt),re(Bi,1,Tt)}}),Ms,po=I({"src/nowiki/commentLine.ts"(){"use strict";Bt(),Ms=class extends je{}}}),fo={};ae(fo,{GalleryToken:()=>mo});var mo,id=I({"src/multiLine/gallery.ts"(){"use strict";var e,xo,$n,n;X(),D(),sr(),go(),po(),mo=(n=class extends Xs{constructor(i,l,a=[]){var u;super(void 0,l,a,{});R(this,e);for(const o of(u=i==null?void 0:i.split(`
`))!=null?u:[]){const d=/^([^|]+)(?:\|(.*))?/u.exec(o);if(!d){super.insertAt(o.trim()?new Ms(o,l,a):o);continue}const[,c,f]=d;j(this,e,xo).call(this,c)?super.insertAt(new Tt("gallery",c,f,l,a)):super.insertAt(new Ms(o,l,a))}}get widths(){return j(this,e,$n).call(this,"widths")}get heights(){return j(this,e,$n).call(this,"heights")}lint(i=this.getAbsoluteIndex(),l){{const{top:a,left:u}=this.getRootNode().posFromIndex(i),o=[],d="no-ignored",{lintConfig:c}=N,f=["Image","NoImage","Comment"].map(g=>c.getSeverity(d,`gallery${g}`));for(let g=0;g<this.length;g++){const y=this.childNodes[g],$=y.toString(),{length:k}=$,_=$.trim(),{type:T}=y,p=a+g,h=g?0:u;if(y.setAttribute("aIndex",i),T==="noinclude"&&_&&!/^<!--.*-->$/u.test(_)){let[m]=f;if(_.startsWith("|")?[,m]=f:(_.startsWith("<!--")||_.endsWith("-->"))&&([,,m]=f),m){const x=i+k,S={rule:d,message:N.msg("invalid-content","gallery"),severity:m,startIndex:i,endIndex:x,startLine:p,endLine:p,startCol:h,endCol:h+k};c.computeEditInfo&&(S.suggestions=[ee(S),zn(S,$)]),o.push(S)}}else if(T!=="noinclude"&&T!=="text"){const m=y.lint(i,l);m.length>0&&Array.prototype.push.apply(o,m)}i+=k+1}return o}}json(i,l=this.getAbsoluteIndex()){{const a=super.json(void 0,l);return Object.assign(a,{widths:this.widths,heights:this.heights}),a}}},e=new WeakSet,xo=function(i){return this.normalizeTitle(i,6,{halfParsed:!0,temporary:!0,decode:!0,page:""}).valid},$n=function(i){var l,a;{const u=(l=this.parentNode)==null?void 0:l.getAttr(i),o=typeof u=="string"&&((a=/^(\d+)\s*(?:px)?$/u.exec(u))==null?void 0:a[1]);return o&&Number(o)||120}},n)}}),lr,vo=I({"src/link/index.ts"(){"use strict";et(),X(),D(),Vs(),lr=class extends Xe{get type(){return"link"}get innerText(){return this.length>1?this.lastChild.text():fs(this.firstChild.text().replace(/^\s*:?/u,""))}lint(e=this.getAbsoluteIndex(),t){{const s=super.lint(e,t),n="nested-link",{lintConfig:r}=N,i=r.getSeverity(n);if(i&&this.closest("ext-link-text")){const l=Z(this,{start:e},n,"link-in-extlink",i);(r.computeEditInfo||r.fix)&&(l.fix=Be(l,"delink",this.innerText)),s.push(l)}return s}}}}}),$l,_l,vs,ar=I({"src/magicLink.ts"(){"use strict";var e,t,_n,n;X(),ve(),be(),D(),J(),$l=String.raw`(?:[${Ye}\t]|&nbsp;|&#0*160;|&#[xX]0*[aA]0;)`,_l=new RegExp(`${$l}+`,"gu"),vs=(n=class extends z{constructor(i,l="free-ext-link",a=N.getConfig(),u){super(i,a,u,{});R(this,t);R(this,e);E(this,e,l)}get type(){return b(this,e)}get innerText(){const i=new Map([["!","|"],["=","="]]);let l=pt(this.childNodes.map(a=>{const{type:u}=a,o=String(a.name);return u==="magic-word"&&i.has(o)?i.get(o):a}));return this.type==="magic-link"&&(l=l.replace(_l," ")),l}get link(){const{innerText:i}=this;return this.type==="magic-link"?i.startsWith("ISBN")?`ISBN ${i.slice(5).replace(/[- ]/gu,"").replace(/x$/u,"X")}`:i:Ca(i).replace(/\n/gu,"%0A")}lint(i=this.getAbsoluteIndex(),l){{const a=super.lint(i,l),u=new pe(this,i),{lintConfig:o}=N,{type:d,childNodes:c}=this;if(d==="magic-link"){const $="invalid-isbn",k=o.getSeverity($);return k&&j(this,t,_n).call(this)&&a.push(Z(this,u,$,"invalid-isbn",k)),a}let f="invalid-url",g=o.getSeverity(f);if(g&&!this.querySelector("magic-word"))try{this.getUrl()}catch{a.push(Z(this,u,f,"invalid-url",g))}const y=d==="ext-link-url";if(f="unterminated-url",g=o.getSeverity(f,y?"pipe":"punctuation"),g){const $=y?/\|/u:/[，；。：！？（）]+/u,k=c.find(_=>_.type==="text"&&$.test(_.data));if(k){const{data:_}=k,T=Q(k,u,f,N.msg("in-url",y?'"|"':"full-width-punctuation"),g);if(o.computeEditInfo){const{index:p,0:h}=$.exec(_),m=T.startIndex+p;T.suggestions=y?[xs(m,1)]:[xs(m),{desc:N.msg("encode"),range:[m,m+h.length],text:encodeURI(h)}]}a.push(T)}}return a}}getUrl(i){{const{type:l}=this;let{link:a}=this;if(l==="magic-link"){if(a.startsWith("ISBN"))return this.normalizeTitle(`BookSources/${a.slice(5)}`,-1,{temporary:!0}).getUrl(i);a=a.startsWith("RFC")?`https://datatracker.ietf.org/doc/html/rfc${a.slice(4)}`:`https://pubmed.ncbi.nlm.nih.gov/${a.slice(5)}`}else a.startsWith("//")&&(a=`https:${a}`);return new URL(a)}this.lspError("MagicLinkToken.getUrl")}getAttribute(i){return i==="invalid"?j(this,t,_n).call(this):super.getAttribute(i)}},e=new WeakMap,t=new WeakSet,_n=function(){if(this.type==="magic-link"){const{link:i}=this;if(i.startsWith("ISBN")){const l=[...i.slice(5)].map(a=>a==="X"?10:Number(a));return l.length===10?l.reduce((a,u,o)=>a+u*(10-o),0)%11!==0:l.length===13&&(l[12]===10||l.reduce((a,u,o)=>a+u*(o%2?3:1),0)%10!==0)}}return!1},n)}}),Tl,qi,Cl,Ct,bo=I({"src/extLink.ts"(){"use strict";var e,t;He(),X(),st(),D(),J(),ar(),Tl=[Ge("[")],Ct=(t=class extends(Cl=z){constructor(n,r="",i="",l,a=[]){super(void 0,l,a,{});R(this,e);const u=n&&/^\0\d+f\x7F$/u.test(n)?a[Number(n.slice(1,-2))]:new vs(n,"ext-link-url",l,a);if(this.insertAt(u),E(this,e,r),i){const o=new z(i,l,a,{});o.type="ext-link-text",o.setAttribute("stage",ke-1),this.insertAt(o)}}get type(){return"ext-link"}toString(n){return this.length===1?`[${super.toString(n)}${b(this,e)}]`:`[${super.toString(n,b(this,e))}]`}text(){return`[${super.text(" ")}]`}getGaps(){return b(this,e).length}lint(n=this.getAbsoluteIndex(),r){{const i=super.lint(n,r),l="var-anchor",a=N.lintConfig.getSeverity(l,"extLink");return a&&this.length===1&&this.closest("heading-title")&&i.push(Z(this,{start:n},l,"variable-anchor",a)),i}}print(){return super.print(this.length===1?{pre:"[",post:`${b(this,e)}]`}:{pre:"[",sep:b(this,e),post:"]"})}},e=new WeakMap,t),qi=oe(Cl),Ct=le(qi,0,"ExtLinkToken",Tl,Ct),re(qi,1,Ct)}}),Tn,nd=I({"src/imagemapLink.ts"(){"use strict";J(),Bt(),vo(),bo(),Tn=class extends z{get type(){return"imagemap-link"}constructor(e,t,s,n,r=[]){super(void 0,n,r),this.append(e,t.length===2?new lr(...t,n,r):new Ct(...t,n,r),new je(s,n,r))}}}}),yo={};ae(yo,{ImagemapToken:()=>wo});var wo,rd=I({"src/multiLine/imagemap.ts"(){"use strict";X(),Re(),be(),D(),sr(),po(),go(),nd(),wo=class extends Xs{get image(){return this.childNodes.find(Zs("imagemap-image"))}constructor(e,t=N.getConfig(),s=[]){if(super(void 0,t,s,{}),!e)return;const n=e.split(`
...
`:"")+L.description},range:O!=null?O:Qe(x)}}async provideSignatureHelp(p,h){if(!this.data)return;const{line:m,character:x}=h,S=p.split(/\r?\n/u,m+1)[m],{lastChild:v}=await j(this,o,En).call(this,`${S.slice(0,x+/^[^{}<]*/u.exec(S.slice(x))[0].length)}}}`);if(!v.is("magic-word")||v.length===1)return;const{name:w,childNodes:A,firstChild:C}=v,L=j(this,o,$t).call(this,w);if(!(L!=null&&L.signatures))return;const B=A.length-1,q=L.signatures.filter(P=>{var U;return(P.length>=B||((U=P[P.length-1])==null?void 0:U.rest))&&P.every(({label:M,const:ie},H)=>{var K;const G=ie&&H<B&&((K=A[H+1])==null?void 0:K.text().trim());return!G||M.toLowerCase().includes(G.toLowerCase())})});if(q.length===0)return;let O=-1;for(let P=v.getAbsoluteIndex()+v.getAttribute("padding");O<B&&(P+=A[O+1].toString().length+1,!(P>x));O++);const W=C.text().trim(),F=v.getAttribute("colon");return{signatures:q.map(P=>({label:`{{${W}${P.length===0?"":F}${P.map(({label:U})=>U).join("|")}}}`,parameters:P.map(({label:U,const:M})=>({label:U,...M?{documentation:"Predefined parameter"}:void 0})),...P.length<B?{activeParameter:Math.min(O,P.length-1)}:void 0})),activeParameter:O}}async provideInlayHints(p){const h=await j(this,o,Fe).call(this,p);let m=[];for(const x of h.querySelectorAll("template,magic-word#invoke").reverse()){const{type:S,childNodes:v}=x;m=[...m,...v.slice(S==="template"?1:3).filter(({anon:w})=>w).reverse().map(w=>({position:St(h,w.getAbsoluteIndex()),label:`${w.name}=`,kind:2}))]}return m}findStyleTokens(){return b(this,r).querySelectorAll(fa).filter(({lastChild:p})=>on(p))}async provideRefactoringAction(p,h){let m,x;if(h){const{start:w,end:A}=h;if(w.line===A.line&&w.character===A.character)return[];m=p.split(/\r?\n/u,A.line+1),x=w.line===A.line?m[A.line].slice(w.character,A.character):`${m[w.line].slice(w.character)}
${m.slice(w.line+1,A.line).join(`
`)}${m.length===2?"":`
`}${m[A.line].slice(0,A.character)}`}else if(p)m=p.split(/\r?\n/u),x=m.join(`
`),h={start:{line:0,character:0},end:{line:m.length-1,character:m[m.length-1].length}};else return[];const S=await j(this,o,En).call(this,x),{viewOnly:v}=N;return N.viewOnly=!1,S.escape(),N.viewOnly=v,[{title:"Escape with magic words",kind:"refactor.rewrite",edit:{changes:{"":[{range:h,newText:S.toString()}]}}}]}},e=new WeakMap,t=new WeakMap,s=new WeakMap,n=new WeakMap,r=new WeakMap,i=new WeakMap,l=new WeakMap,a=new WeakMap,u=new WeakMap,o=new WeakSet,os=function(){return b(this,l)===this.config&&b(this,a)===this.include},Fe=async function(p){var h;return p=hs(p),!b(this,s)&&j(this,o,os).call(this)&&b(this,e)===p?b(this,r):(E(this,e,p),(h=b(this,s))!=null||E(this,s,j(this,o,Fn).call(this)),b(this,s))},Fn=async function(){var m;(m=this.config)!=null||(this.config=N.getConfig()),E(this,l,this.config),E(this,a,this.include);const p=b(this,e),h=await N.partialParse(p,()=>b(this,e),this.include,this.config);return j(this,o,os).call(this)&&b(this,e)===p?(E(this,r,h),E(this,s,void 0),h):(E(this,s,j(this,o,Fn).call(this)),b(this,s))},En=async function(p){var h;return p=hs(p),!b(this,n)&&j(this,o,os).call(this)&&b(this,t)===p?b(this,i):(E(this,t,p),(h=b(this,n))!=null||E(this,n,j(this,o,jn).call(this)),b(this,n))},jn=async function(){var m;(m=this.config)!=null||(this.config=N.getConfig()),E(this,l,this.config),E(this,a,this.include);const p=b(this,t),h=await N.partialParse(p,()=>b(this,t),this.include,this.config);return j(this,o,os).call(this)&&b(this,t)===p?(E(this,i,h),E(this,n,void 0),h):(E(this,n,j(this,o,jn).call(this)),b(this,n))},wu=function(){var p;if(!b(this,u)||b(this,u)[1]!==this.config){(p=this.config)!=null||(this.config=N.getConfig());const{nsid:h,ext:m,html:x,parserFunction:[S,v,...w],doubleUnderscore:A,protocol:C,img:L}=this.config,B=new Set([m,x].flat(2)),q=new RegExp("(?:"+String.raw`<(\/?\w*)`+"|"+String.raw`(\{{2,4}|\[\[)\s*([^|{}<>[\]\s][^|{}<>[\]#]*)?`+"|"+String.raw`(_(?:_(?:(?!__|＿{2})[\p{L}\p{N}_])*)?)`+"|"+String.raw`(＿(?:＿(?:(?!__|＿{2})[\p{L}\p{N}＿])*)?)`+"|"+String.raw`(?<!\[)\[([a-z:/]*)`+"|"+String.raw`\[\[\s*(?:${Object.entries(h).filter(([,W])=>W===6).map(([W])=>W).join("|")})\s*:[^[\]{}<>]+\|([^[\]{}<>|=]*)`+"|"+String.raw`<(\w+)(?:\s(?:[^<>{}|=\s]+(?:\s*=\s*(?:[^\s"']\S*|(["']).*?\9))?(?=\s))*)?\s(\w*)`+")$","iu"),O=A.slice(0,2).flat();E(this,u,[{re:q,ext:m,tags:B,allTags:[...B,"onlyinclude","includeonly","noinclude"],functions:[Object.keys(S),Array.isArray(v)?v:Object.keys(v),w].flat(2),switches:O.filter(dt).map(W=>`__${W}__`),jaSwitches:O.filter(W=>!dt(W)),protocols:C.split("|"),params:Object.keys(L).filter(W=>W.endsWith("$1")||!W.includes("$1")).map(W=>W.replace(/\$1$/u,""))},this.config])}return b(this,u)[0]},Rn=function(p){return this.data.behaviorSwitches.find(({aliases:h})=>h.includes(p))},$t=function(p){return this.data.parserFunctions.find(({aliases:h})=>h.some(m=>m.replace(/^#/u,"")===p))},T)}}),Su={};ae(Su,{default:()=>N});Au.exports=se(Su);var js,pn,ba,lt,fn,ya,N,D=I({"index.ts"(){Wn(),Re(),He(),ve(),Td(),js=!0,pn=new Nn,lt={config:xn,get rules(){return cs},get i18n(){return{...Ia,...ba}},set i18n(e){ba=e},get lintConfig(){return pn},set lintConfig(e){pn=new Nn(e)},get viewOnly(){return js},set viewOnly(e){js&&!e&&we.rev++,js=e},getConfig(e){const t=e!=null?e:this.config,{doubleUnderscore:s,ext:n,parserFunction:r,variable:i}=t;for(let l=0;l<2;l++)s.length>l+2&&s[l].length===0&&(s[l]=Object.keys(s[l+2]));return n.includes("translate")&&!i.includes("translationlanguage")&&(i.push("translationlanguage"),Array.isArray(r[1])?r[1].push("TRANSLATIONLANGUAGE"):r[1].TRANSLATIONLANGUAGE="translationlanguage"),{...xn,...t,excludes:[]}},msg(e,t=""){var s;return e&&((s=this.i18n[e])!=null?s:e).replace("$1",this.msg(t))},normalizeTitle(e,t=0,s,n=lt.getConfig(),r){const{Title:i}=(Cd(),se(mu));let l;if(r!=null&&r.halfParsed)l=new i(e,t,n,r);else{const{Token:a}=(J(),se(ds));l=we.run(()=>{const u=new a(e,n);u.type="root",u.pageName=r==null?void 0:r.page,u.parseOnce(0,s).parseOnce();const o=new i(u.toString(),t,n,r);u.build();for(const d of["main","fragment"]){const c=o[d];if(c!=null&&c.includes("\0")){const f=u.buildFromStr(c,1);d==="main"?o.main=f:o.setFragment(f)}}return o})}return l},parse(e,t,s,n,r){e=hs(e);let i,l,a,u;typeof t=="string"?(i=!!s,l=n,a=r,u=t):(i=!!t,l=s,a=n,u=r),l!=null||(l=ke),a!=null||(a=this.getConfig());let o;typeof l!="number"&&(o=Array.isArray(l)?l:[l],l=Math.max(...o.map(f=>Ta[f]||ke)));const{Token:d}=(J(),se(ds));return we.run(()=>{const f=new d(e,a);return f.type="root",f.pageName=u,f.parse(l,i)})},parseWithRef(e,t,s,n=t.getAttribute("include")){return this.parse(e,n,s,t.getAttribute("config"),t.pageName)},async partialParse(e,t,s,n=lt.getConfig()){{const{Token:r}=(J(),se(ds)),i=typeof setImmediate=="function"?setImmediate:setTimeout,{running:l}=we;we.running=!0;const a=new r(hs(e),n);a.type="root";let u=0;try{await new Promise(o=>{const d=()=>{t()===e?(u++,i(c,0)):o()},c=()=>{u===ke+1?(a.afterBuild(),o()):(a[u===ke?"build":"parseOnce"](u,s),d())};i(c,0)})}catch(o){throw we.running=l,o}return we.running=l,a}},createLanguageService(e={}){var t;{const s=(Id(),se(bu)),{LanguageService:n,tasks:r}=s;return(t=r.get(e))!=null?t:new n(e)}throw new Error("Parser.createLanguageService method is only available in the LSP version!")}},fn={},ya=new Set(["lintConfig","normalizeTitle","parse","createLanguageService"]);for(const e of Object.keys(lt))ya.has(e)||(fn[e]={enumerable:!1});Object.defineProperties(lt,fn),Object.assign(typeof globalThis=="object"?globalThis:self,{Parser:lt}),N=lt}});D()});Nd();})();
