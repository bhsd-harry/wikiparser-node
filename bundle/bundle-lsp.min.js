...
${d}`;continue}const b=/^(?:(\|\}|\0\d+!\x7F\}|\0\d+\}\x7F)|(\|-+|\0\d+!\x7F-+|\0\d+-\x7F-*)(?!-)|(!|(?:\||\0\d+!\x7F)\+?))(.*)$/u.exec(m);if(!b){a(`
${d}`,u),s.push(u);continue}const[,S,k,_,T]=b;if(S){for(;!u.is("table");)u=s.pop();u.close(`
