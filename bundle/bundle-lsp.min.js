...
`})}}return qe(n,a),n}});var vo={};ne(vo,{ParamTagToken:()=>ct});var ko,Si,nd,ct,Ci=w(()=>{"use strict";G();de();Zr();Dn();K();D();Qe();ko=[ur];ct=class extends(nd=S){get type(){return"ext-inner"}constructor(n,e,t=$.getConfig(),r=[],i){if(super(void 0,t,r,{}),e){let s=te;this.append(...e.split(`
...
`,index:a.length},I=(f=i.pop())!=null?f:{},{0:P,index:z,parts:X,findEqual:re,pos:W}=I,V=C==="="&&re;if(C==="]]"||C==="}-")h=A+2;else if(C===`
...
`))},ol=function(){if(c(this,Z).excludes.includes("extLink"))return;let{parseExternalLinks:e}=(us(),Q(Ia));this.setText(e(this.firstChild.toString(),c(this,Z),c(this,ie)))},al=function(){if(c(this,Z).excludes.includes("magicLink"))return;let{parseMagicLinks:e}=(_a(),Q(Oa));this.setText(e(this.firstChild.toString(),c(this,Z),c(this,ie)))},ll=function(){if(c(this,Z).excludes.includes("list"))return;let{parseList:e}=(Ua(),Q(Wa)),{firstChild:t,type:r,name:i}=this,s=t.toString().split(`
