...
`)||(e=`${e.slice(0,h)}\0${s.length}h${e.slice(g)}`,m=h+4+String(s.length).length,new St(O[1].length,O.slice(2),t,s)))}}else if(f==="|"||L)m=g+1,o(e,S,$,g),f==="|"&&S.push([]),x.pos=m,x.findEqual=f==="|",n.push(x);else if(f.startsWith("}}")){const j=f.slice(0,Math.min(v.length,3)),B=v.length-j.length,{length:O}=s;m=g+j.length,o(e,S,$,g);let E=!1,D="t";if(j.length===3){const W=S.map(z=>z.join("=")),q=W.length>1&&_e(W[1]).trim();new es(W,t,s),q&&q.endsWith(":")&&r.includes(q.slice(0,-1).toLowerCase())&&(D="s")}else try{new lt(S[0][0],S.slice(1),t,s),D=Ti(S[0][0])}catch(W){if(W instanceof SyntaxError&&W.message==="Invalid template name")E=!0;else throw W}E||(e=`${e.slice(0,h+B)}\0${O}${D}${e.slice(m)}`,m=h+B+3+String(O).length,B>1?n.push({0:v.slice(0,B),index:h,pos:h+B,parts:[[]]}):B===1&&e[h-1]==="-"&&n.push({0:"-{",index:h-1,pos:h+1,parts:[[]]}))}else m=g+f.length,f.startsWith("{")&&(p.pos=m,p.parts=[[]]),n.push(..."0"in x?[x]:[],p);let I=n[n.length-1];if(u&&a+e.length<m)for(u=!1;(T=I==null?void 0:I[0])!=null&&T.startsWith("{");)n.pop(),I=n[n.length-1];c=_i(i+(u?ki:"")+(I?`|${ll[I[0][0]]}${I.findEqual?"|=":""}`:"")),c.lastIndex=m,p=c.exec(e)}return Fe(e,l)}}}),Ko={};oe(Ko,{InputboxToken:()=>Yo});var Yo,Hu=C({"src/multiLine/inputbox.ts"(){"use strict";Vs(),Yn(),G(),Vo(),Yo=class extends Kn{constructor(e,t,s=N.getConfig(),i=[]){const r=Symbol("InputboxToken"),n=s.excludes.includes("heading")?s:{...s,excludes:[...s.excludes,"heading"]},{length:l}=i;i.push(r),t&&(t=vs(t,n,i,e)),t&&(t=Gs(t,n,i)),i.splice(l,1),super(e,t,n,i,{})}}}}),js={};oe(js,{NestedToken:()=>Zo});var al,ul,Zo,Ci=C({"src/nested.ts"(){"use strict";var e,t,s;K(),me(),Vs(),Yn(),G(),X(),ba(),Pt(),al=new Set(["comment","include","arg","template","magic-word"]),ul=[!1,!0].map(i=>{const r=i?"includeonly":"noinclude";return new RegExp(String.raw`^(?:<${r}(?:\s[^>]*)?/?>|</${r}\s*>)$`,"iu")}),Zo=(s=class extends H{constructor(r,n,l,o,d=[]){if(typeof n=="boolean"){const a=Symbol("NestedToken"),{length:u}=d;d.push(a),r&&(r=vs(r,o,d,n)),r&&(r=Gs(r,o,d)),d.splice(u,1)}else r&&(r=r.replace(n,(a,u,c,p,m)=>{const b=`\0${d.length+1}e`;return new _t(u,c,p,m,o,!1,d),b}));r&&(r=r.replace(/(^|\0\d+.\x7F)([^\0]+)(?=$|\0\d+.\x7F)/gu,(a,u,c)=>(new Ee(c,o,d),`${u}\0${d.length}n`)));super(r,o,d);P(this,e);P(this,t);F(this,e,[...l]),F(this,t,n)}get type(){return"ext-inner"}lint(r=this.getAbsoluteIndex(),n){{const l=super.lint(r,n),o="no-ignored",{lintConfig:d}=N,a=d.getSeverity(o,this.name);if(!a)return l;const u=new ce(this,r),c=typeof w(this,t)=="boolean"?ul[w(this,t)?1:0]:/^<!--[\s\S]*-->$/u;return[...l,...this.childNodes.filter(p=>{const{type:m,name:b}=p;if(m==="ext")return!w(this,e).includes(b);if(al.has(m))return!1;const k=p.toString().trim();return k&&!c.test(k)}).map(p=>{const m=J(p,u,o,N.msg("invalid-content",this.name),a);return d.computeEditInfo&&(m.suggestions=[Z(m),On(m,p.toString())]),m})]}}},e=new WeakMap,t=new WeakMap,s)}});function dl(e,t,s,i,r){t=_e(t).trim();let n=t.replace(e==="link"?/\0\d+[tq]\x7F/gu:/\0\d+t\x7F/gu,"").trim();switch(e){case"width":return!n&&!!t||/^(?:\d+x?|\d*x\d+)(?:\s*px)?$/u.test(n);case"link":{if(n){if(ea(s.protocol).test(n))return ta(s.protocol).test(n)&&t;n.startsWith("[[")&&n.endsWith("]]")&&(n=n.slice(2,-2))}else return t;const l=N.normalizeTitle(n,0,!1,s,{halfParsed:i,decode:!0,selfLink:!0});return l.valid&&l}case"lang":return(r==="svg"||r==="svgz")&&!/[^a-z\d-]/u.test(n);case"alt":case"class":case"manualthumb":return!0;case"page":return(r==="djvu"||r==="djv"||r==="pdf")&&Number(n)>0;default:return!!n&&!isNaN(n)}}var ea,ta,cl,hl,gl,sa,Du=C({"src/imageParameter.ts"(){"use strict";var e,t,ia,r;Ke(),fe(),K(),Xe(),je(),G(),X(),ea=at(n=>new RegExp(String.raw`^(?:${n}|//|\0\d+m\x7F)`,"iu")),ta=at(n=>new RegExp(String.raw`^(?:(?:${n}|//)${It}|\0\d+m\x7F)${Nt}$`,"iu")),cl=at(n=>new RegExp(String.raw`^(\s*(?!\s))${n.replace("$1","(.*)")}${n.endsWith("$1")?`(?=$|
)`:""}(\s*)$`,"u")),hl=new Set(["alt","link","lang","page","caption"]),gl=n=>{if(n)n.startsWith("//")&&(n=`https:${n}`);else return n;return new URL(n).href},sa=(r=class extends H{constructor(l,o,d,a){var n=(...i)=>(super(...i),P(this,t),P(this,e,""),this);let u;const c=Object.entries(d.img).map(([m,b])=>[m,b,cl(m)]),p=c.find(([,m,b])=>(u=b.exec(l),u&&(u.length!==4||dl(m,u[2],d,!0,o)!==!1)));if(p&&u){u.length===3?(n(void 0,d,a),F(this,e,l)):(n(u[2],d,a,{}),F(this,e,u[1]+p[0]+u[3])),this.setAttribute("name",p[1]),p[1]==="alt"&&this.setAttribute("stage",Ae-1);return}n(l,d.excludes.includes("list")?d:{...d,excludes:[...d.excludes,"list"]},a),this.setAttribute("name","caption"),this.setAttribute("stage",7)}get type(){return"image-parameter"}get link(){{if(this.name!=="link")return;const l=super.text().trim();return xe.run(()=>{const o=new H(l,this.getAttribute("config"));return o.parseOnce(0,this.getAttribute("include")).parseOnce(),/^\0\d+m\x7F/u.test(o.toString())?l:dl("link",l,this.getAttribute("config"))})}}afterBuild(){var l;(l=this.parentNode)!=null&&l.is("gallery-image")&&!hl.has(this.name)&&this.setAttribute("name","invalid"),super.afterBuild()}toString(l){return w(this,e)?w(this,e).replace("$1",super.toString(l)):super.toString(l)}text(){return w(this,e)?w(this,e).replace("$1",super.text()).trim():super.text().trim()}isPlain(){return this.name==="caption"||this.name==="alt"}getAttribute(l){return l==="invalid"?this.name==="invalid":l==="padding"?Math.max(0,w(this,e).indexOf("$1")):super.getAttribute(l)}lint(l=this.getAbsoluteIndex(),o){{const d=super.lint(l,o),{lintConfig:a}=N,{computeEditInfo:u,fix:c}=a,{link:p,name:m}=this,b=m==="width"&&this.getValue();if(m==="invalid"||b&&b.endsWith("px")){const k="invalid-gallery",A=a.getSeverity(k,"parameter");if(A){const _=Y(this,{start:l},k,"invalid-image-parameter",A);(u||c)&&(_.fix=b?Z(_,0,b):Z(_,-1)),d.push(_)}}else if(m==="link"){if(typeof p=="string"){const k="invalid-url",A=a.getSeverity(k);if(A&&!this.querySelector("magic-word"))try{gl(p)}catch{d.push(Y(this,{start:l},k,"invalid-url",A))}}else if(p.encoded){const k="url-encoding",A=a.getSeverity(k,"file");if(A){const _=Y(this,{start:l},k,"unnecessary-encoding",A);(u||c)&&(_.fix=Rn(_,this)),d.push(_)}}}return d}}getValue(){return this.name==="invalid"?this.text():R(this,t,ia).call(this)||super.text()}print(){return w(this,e)?`<span class="wpb-image-parameter${this.name==="invalid"?" wpb-invalid":""}">${w(this,e).replace("$1",`<span class="wpb-image-caption">${Ft(this.childNodes)}</span>`)}</span>`:super.print({class:"image-caption"})}},e=new WeakMap,t=new WeakSet,ia=function(){return w(this,e)&&!w(this,e).includes("$1")},r)}}),Ii,pl,fl,Ni,Li,Fi,ml,Ei,Zn,na=C({"src/link/file.ts"(){"use strict";K(),me(),G(),Ms(),Du(),Ii=new Map([["manualthumb","Thumb"],["frameless","Frameless"],["framed","Frame"],["thumbnail","Thumb"]]),pl=new Set(["arg"]),fl=new Set(["template","magic-word"]),Ni=new Set(["left","right","center","none"]),Li=new Set(["baseline","sub","super","top","text-top","middle","bottom","text-bottom"]),Fi=new Set(["tiff","tif","png","gif","jpg","jpeg","webp","xcf","pdf","svg","djvu"]),ml=e=>{if(e===void 0)return[];const t=/-\{|\}-|\|/gu,s=[];let i=t.exec(e),r=0,n=0;for(;i;){const{0:l,index:o}=i;l!=="|"?r+=l==="-{"?1:-1:r===0&&(s.push(e.slice(n,o)),{lastIndex:n}=t),i=t.exec(e)}return s.push(e.slice(n)),s},Ei=(e,t)=>e.filter(({childNodes:s})=>!s.some(i=>i.text().trim()&&t.has(i.type))),Zn=class extends Ge{get type(){return"file"}get extension(){return this.getAttribute("title").extension}constructor(e,t,s,i=[],r="|"){super(e,void 0,s,i,r);const{extension:n}=this.getTitle(!0,!0);this.safeAppend(ml(t).map(l=>new sa(l,n,s,i)))}lint(e=this.getAbsoluteIndex(),t){var s;{const i=super.lint(e,t),r=Ei(this.getAllArgs(),pl),n=[...new Set(r.map(({name:v})=>v))],l=n.filter(v=>Ii.has(v)),o=n.filter(v=>Ni.has(v)),d=n.filter(v=>Li.has(v)),[a]=l,u=a==="framed"||a==="manualthumb",c=new ce(this,e),{lintConfig:p}=N,{computeEditInfo:m,fix:b}=p,{ns:k,extension:A}=this.getAttribute("title"),{firstChild:_}=this;let T="nested-link",f=p.getSeverity(T,"file");if(f&&Fi.has(A)&&this.closest("ext-link-text")&&((s=this.getValue("link"))==null?void 0:s.trim())!==""){const v=Y(this,c,T,"link-in-extlink",f);if(m||b){const h=this.getArg("link");if(h){const S=e+h.getRelativeIndex();v.fix={desc:N.msg("delink"),range:[S,S+h.toString().length],text:"link="}}else v.fix=qs(v.endIndex-2,"delink","|link=")}i.push(v)}if(T="invalid-gallery",f=p.getSeverity(T,"extension"),f&&k===6&&!A&&!_.querySelector("arg,magic-word,template")&&i.push(Y(this,c,T,"missing-extension",f)),f=p.getSeverity(T,"parameter"),f&&u)for(const v of r.filter(({name:h})=>h==="width")){const h=J(v,c,T,"invalid-image-parameter",f);(m||b)&&(h.fix=Z(h,-1)),i.push(h)}if(r.length===n.length&&l.length<2&&o.length<2&&d.length<2)return i;T="no-duplicate";const g=["unknownImageParameter","imageParameter"].map(v=>p.getSeverity(T,v)),x=(v,h,S,y=!0)=>v.map($=>{if(f=g[Number(typeof y=="function"?y($):y)],!f)return!1;const L=J($,c,T,N.msg(`${h}-image-parameter`,S),f);return m&&(L.suggestions=[Z(L,-1)]),L}).filter($=>$!==!1);for(const v of n){if(v==="invalid"||v==="width"&&u)continue;const h=v==="caption";let S=r.filter(({name:y})=>y===v);if(h&&(S=[...S.slice(0,-1).filter(y=>y.text()),...S.slice(-1)]),S.length>1){let y=!h||!A||Fi.has(A);if(h&&y){const $=Ei(S,fl);y=$.length>1&&(L=>$.includes(L))}i.push(...x(S,"duplicate",v,y))}}return l.length>1&&i.push(...x(r.filter(({name:v})=>Ii.has(v)),"conflicting","frame")),o.length>1&&i.push(...x(r.filter(({name:v})=>Ni.has(v)),"conflicting","horizontal-alignment")),d.length>1&&i.push(...x(r.filter(({name:v})=>Li.has(v)),"conflicting","vertical-alignment")),i}}getAllArgs(){return this.childNodes.slice(1)}getArgs(e){return this.getAllArgs().filter(({name:t})=>e===t)}getArg(e){{const t=this.getArgs(e);return t[e==="manualthumb"?0:t.length-1]}}getValue(e){var t;return(t=this.getArg(e))==null?void 0:t.getValue()}json(e,t=this.getAbsoluteIndex()){{const s=super.json(void 0,t),{extension:i}=this;return i&&(s.extension=i),s}}}}}),xl,ji,vl,At,ra=C({"src/link/galleryImage.ts"(){"use strict";var e,bn,s;K(),Xe(),Ze(),G(),X(),na(),xl=[Ue("")],At=(s=class extends(vl=Zn){constructor(r,n,l,o,d=[]){let a;if(l!==void 0){const{length:u}=d;a=new H(l,o,d);for(let c=0;c<Ae-1;c++)a.parseOnce();d.splice(u,1)}super(n,a==null?void 0:a.toString(),o,d);P(this,e);Ne(this,"privateType","imagemap-image");this.setAttribute("bracket",!1),this.privateType=`${r}-image`,this.seal("privateType",!0)}get type(){return this.privateType}getTitle(r){const n=this.type==="imagemap-image";return this.normalizeTitle(this.firstChild.toString(),n?0:6,{halfParsed:!0,temporary:r,decode:!n})}lint(r=this.getAbsoluteIndex(),n){{const l=super.lint(r,n),o="invalid-gallery",{lintConfig:d}=N,a=d.getSeverity(o,"image");if(a&&R(this,e,bn).call(this)){const u=Y(this,{start:r},o,"invalid-gallery",a);d.computeEditInfo&&(u.suggestions=[qs(r,"prefix","File:")]),l.push(u)}return l}}getAttribute(r){return r==="invalid"?R(this,e,bn).call(this):super.getAttribute(r)}},e=new WeakSet,bn=function(){const{ns:r}=this.getAttribute("title");return r!==6},s),ji=ae(vl),At=le(ji,0,"GalleryImageToken",xl,At),re(ji,1,At)}}),Os,la=C({"src/nowiki/commentLine.ts"(){"use strict";Pt(),Os=class extends Ee{}}}),oa={};oe(oa,{GalleryToken:()=>aa});var aa,Gu=C({"src/multiLine/gallery.ts"(){"use strict";var e,ua,wn,i;K(),G(),Xn(),ra(),la(),aa=(i=class extends Ds{constructor(n,l,o=[]){var d;super(void 0,l,o,{});P(this,e);for(const a of(d=n==null?void 0:n.split(`
`))!=null?d:[]){const u=/^([^|]+)(?:\|(.*))?/u.exec(a);if(!u){super.insertAt(a.trim()?new Os(a,l,o):a);continue}const[,c,p]=u;R(this,e,ua).call(this,c)?super.insertAt(new At("gallery",c,p,l,o)):super.insertAt(new Os(a,l,o))}}get widths(){return R(this,e,wn).call(this,"widths")}get heights(){return R(this,e,wn).call(this,"heights")}lint(n=this.getAbsoluteIndex(),l){{const{top:o,left:d}=this.getRootNode().posFromIndex(n),a=[],u="no-ignored",{lintConfig:c}=N,p=["Image","NoImage","Comment"].map(m=>c.getSeverity(u,`gallery${m}`));for(let m=0;m<this.length;m++){const b=this.childNodes[m],k=b.toString(),{length:A}=k,_=k.trim(),{type:T}=b,f=o+m,g=m?0:d;if(b.setAttribute("aIndex",n),T==="noinclude"&&_&&!/^<!--.*-->$/u.test(_)){let[x]=p;if(_.startsWith("|")?[,x]=p:(_.startsWith("<!--")||_.endsWith("-->"))&&([,,x]=p),x){const v=n+A,h={rule:u,message:N.msg("invalid-content","gallery"),severity:x,startIndex:n,endIndex:v,startLine:f,endLine:f,startCol:g,endCol:g+A};c.computeEditInfo&&(h.suggestions=[Z(h),On(h,k)]),a.push(h)}}else if(T!=="noinclude"&&T!=="text"){const x=b.lint(n,l);x.length>0&&a.push(...x)}n+=A+1}return a}}json(n,l=this.getAbsoluteIndex()){{const o=super.json(void 0,l);return Object.assign(o,{widths:this.widths,heights:this.heights}),o}}},e=new WeakSet,ua=function(n){return this.normalizeTitle(n,6,{halfParsed:!0,temporary:!0,decode:!0}).valid},wn=function(n){var l,o;{const d=(l=this.parentNode)==null?void 0:l.getAttr(n),a=typeof d=="string"&&((o=/^(\d+)\s*(?:px)?$/u.exec(d))==null?void 0:o[1]);return a&&Number(a)||120}},i)}}),er,da=C({"src/link/index.ts"(){"use strict";Ke(),K(),G(),Ms(),er=class extends Ge{get type(){return"link"}get innerText(){return this.length>1?this.lastChild.text():hs(this.firstChild.text().replace(/^\s*:?/u,""))}lint(e=this.getAbsoluteIndex(),t){{const s=super.lint(e,t),i="nested-link",{lintConfig:r}=N,n=r.getSeverity(i);if(n&&this.closest("ext-link-text")){const l=Y(this,{start:e},i,"link-in-extlink",n);(r.computeEditInfo||r.fix)&&(l.fix=Pe(l,"delink",this.innerText)),s.push(l)}return s}}}}}),bl,wl,fs,tr=C({"src/magicLink.ts"(){"use strict";var e,t,yn,i;K(),fe(),me(),G(),X(),bl=String.raw`(?:[${Qe}\t]|&nbsp;|&#0*160;|&#[xX]0*[aA]0;)`,wl=new RegExp(`${bl}+`,"gu"),fs=(i=class extends H{constructor(n,l="free-ext-link",o=N.getConfig(),d){super(n,o,d,{});P(this,t);P(this,e);F(this,e,l)}get type(){return w(this,e)}get innerText(){const n=new Map([["!","|"],["=","="]]);let l=dt(this.childNodes.map(o=>{const{type:d}=o,a=String(o.name);return d==="magic-word"&&n.has(a)?n.get(a):o}));return this.type==="magic-link"&&(l=l.replace(wl," ")),l}get link(){const{innerText:n}=this;return this.type==="magic-link"?n.startsWith("ISBN")?`ISBN ${n.slice(5).replace(/[- ]/gu,"").replace(/x$/u,"X")}`:n:yo(n).replace(/\n/gu,"%0A")}lint(n=this.getAbsoluteIndex(),l){{const o=super.lint(n,l),d=new ce(this,n),{lintConfig:a}=N,{type:u,childNodes:c}=this;if(u==="magic-link"){const k="invalid-isbn",A=a.getSeverity(k);return A&&R(this,t,yn).call(this)&&o.push(Y(this,d,k,"invalid-isbn",A)),o}let p="invalid-url",m=a.getSeverity(p);if(m&&!this.querySelector("magic-word"))try{this.getUrl()}catch{o.push(Y(this,d,p,"invalid-url",m))}const b=u==="ext-link-url";if(p="unterminated-url",m=a.getSeverity(p,b?"pipe":"punctuation"),m){const k=b?/\|/u:/[，；。：！？（）]+/u,A=c.find(_=>_.type==="text"&&k.test(_.data));if(A){const{data:_}=A,T=J(A,d,p,N.msg("in-url",b?'"|"':"full-width-punctuation"),m);if(a.computeEditInfo){const{index:f,0:g}=k.exec(_),x=T.startIndex+f;T.suggestions=b?[ps(x,1)]:[ps(x),{desc:N.msg("encode"),range:[x,x+g.length],text:encodeURI(g)}]}o.push(T)}}return o}}getUrl(n){{const{type:l}=this;let{link:o}=this;if(l==="magic-link"){if(o.startsWith("ISBN"))return this.normalizeTitle(`BookSources/${o.slice(5)}`,-1,{temporary:!0}).getUrl(n);o=o.startsWith("RFC")?`https://datatracker.ietf.org/doc/html/rfc${o.slice(4)}`:`https://pubmed.ncbi.nlm.nih.gov/${o.slice(5)}`}else o.startsWith("//")&&(o=`https:${o}`);return new URL(o)}this.lspError("MagicLinkToken.getUrl")}getAttribute(n){return n==="invalid"?R(this,t,yn).call(this):super.getAttribute(n)}},e=new WeakMap,t=new WeakSet,yn=function(){if(this.type==="magic-link"){const{link:n}=this;if(n.startsWith("ISBN")){const l=[...n.slice(5)].map(o=>o==="X"?10:Number(o));return l.length===10?l.reduce((o,d,a)=>o+d*(10-a),0)%11!==0:l.length===13&&(l[12]===10||l.reduce((o,d,a)=>o+d*(a%2?3:1),0)%10!==0)}}return!1},i)}}),yl,Ri,Sl,kt,ca=C({"src/extLink.ts"(){"use strict";var e,t;Xe(),K(),Ze(),G(),X(),tr(),yl=[Ue("[")],kt=(t=class extends(Sl=H){constructor(i,r="",n="",l,o=[]){super(void 0,l,o,{});P(this,e);const d=i&&/^\0\d+f\x7F$/u.test(i)?o[Number(i.slice(1,-2))]:new fs(i,"ext-link-url",l,o);if(this.insertAt(d),F(this,e,r),n){const a=new H(n,l,o,{});a.type="ext-link-text",a.setAttribute("stage",Ae-1),this.insertAt(a)}}get type(){return"ext-link"}toString(i){return this.length===1?`[${super.toString(i)}${w(this,e)}]`:`[${super.toString(i,w(this,e))}]`}text(){return`[${super.text(" ")}]`}getGaps(){return w(this,e).length}lint(i=this.getAbsoluteIndex(),r){{const n=super.lint(i,r),l="var-anchor",o=N.lintConfig.getSeverity(l,"extLink");return o&&this.length===1&&this.closest("heading-title")&&n.push(Y(this,{start:i},l,"variable-anchor",o)),n}}print(){return super.print(this.length===1?{pre:"[",post:`${w(this,e)}]`}:{pre:"[",sep:w(this,e),post:"]"})}},e=new WeakMap,t),Ri=ae(Sl),kt=le(Ri,0,"ExtLinkToken",yl,kt),re(Ri,1,kt)}}),Sn,Vu=C({"src/imagemapLink.ts"(){"use strict";X(),Pt(),da(),ca(),Sn=class extends H{get type(){return"imagemap-link"}constructor(e,t,s,i,r=[]){super(void 0,i,r),this.append(e,t.length===2?new er(...t,i,r):new kt(...t,i,r),new Ee(s,i,r))}}}}),ha={};oe(ha,{ImagemapToken:()=>ga});var ga,Qu=C({"src/multiLine/imagemap.ts"(){"use strict";K(),je(),me(),G(),Xn(),la(),ra(),Vu(),ga=class extends Ds{get image(){return this.childNodes.find(Qs("imagemap-image"))}constructor(e,t=N.getConfig(),s=[]){if(super(void 0,t,s,{}),!e)return;const i=e.split(`
`),r=new Set(t.protocol.split("|"));let n=!0,l=!1;for(const o of i){const d=o.trim();if(!(l||!d||d.startsWith("#"))){if(n){const a=o.indexOf("|"),u=a===-1?o:o.slice(0,a),{valid:c,ns:p}=this.normalizeTitle(u,0,{halfParsed:!0,temporary:!0});if(c&&p===6){const m=new At("imagemap",u,a===-1?void 0:o.slice(a+1),t,s);super.insertAt(m),n=!1;continue}else l=!0}else if(o.trim().split(/[\t ]/u,1)[0]==="desc"){super.insertAt(o);continue}else if(o.includes("[")){const a=o.indexOf("["),u=o.slice(a),c=/^\[\[([^|]+)(?:\|([^\]]*))?\]\][\w\s]*$/u.exec(u);if(c){if(this.normalizeTitle(c[1],0,{halfParsed:!0,temporary:!0,selfLink:!0}).valid){super.insertAt(new Sn(o.slice(0,a),c.slice(1),u.slice(u.indexOf("]]")+2),t,s));continue}}else if(u.startsWith("[//")||r.has(u.slice(1,u.indexOf(":")+1))||r.has(u.slice(1,u.indexOf("//")+2))){const p=/^\[([^\]\s]+)(?:(\s+(?!\s))([^\]]*))?\][\w\s]*$/u.exec(u);if(p){super.insertAt(new Sn(o.slice(0,a),p.slice(1),u.slice(u.indexOf("]")+1),t,s));continue}}}}super.insertAt(new Os(o,t,s))}}lint(e=this.getAbsoluteIndex(),t){{const s=super.lint(e,t),i=new ce(this,e),{childNodes:r,image:n}=this,l="invalid-imagemap",{lintConfig:o}=N,d=o.getSeverity(l,n?"link":"image");return d&&(n?s.push(...r.filter(a=>{const u=a.toString().trim();return a.is("noinclude")&&u&&!u.startsWith("#")}).map(a=>{const u=J(a,i,l,"invalid-imagemap-link",d);return o.computeEditInfo&&(u.suggestions=[Z(u,-1),Pe(u,"comment","# ")]),u})):s.push(Y(this,i,l,"imagemap-without-image",d))),s}}getAttribute(e){return e==="invalid"?!this.image:super.getAttribute(e)}}}}),Al,Pi,kl,$t,pa=C({"src/nowiki/comment.ts"(){"use strict";K(),gt(),Ze(),G(),pt(),Al=[Ye(!1),Ue("<!--")],$t=class extends(kl=Oe){constructor(t,s,i,r){super(t,i,r);Ne(this,"closed");this.closed=s}get type(){return"comment"}lint(t=this.getAbsoluteIndex()){{if(this.closed)return[];const s="unclosed-comment",{lintConfig:i}=N,r=i.getSeverity(s);if(!r)return[];const n=Y(this,{start:t},s,"unclosed-comment",r);return i.computeEditInfo&&(n.suggestions=[Je(n.endIndex,"-->")]),[n]}}toString(t){return t?"":`<!--${this.innerText}${this.closed?"-->":""}`}print(){return super.print({pre:"&lt;!--",post:this.closed?"--&gt;":""})}},Pi=ae(kl),$t=le(Pi,0,"CommentToken",Al,$t),re(Pi,1,$t)}}),fa={};oe(fa,{CommentedToken:()=>ma});var ma,Ju=C({"src/commented.ts"(){"use strict";X(),pa(),ma=class extends H{get type(){return"ext-inner"}constructor(e,t,s=[]){if(super(void 0,t,s,{AstText:":",CommentToken:":"}),e){let i=e.indexOf("<!--"),r=i!==-1&&e.indexOf("-->",i+4),n=0;for(;r!==!1&&r!==-1;)i>n&&this.insertAt(e.slice(n,i)),this.insertAt(new $t(e.slice(i+4,r),!0,t,s)),n=r+3,i=e.indexOf("<!--",n),r=i!==-1&&e.indexOf("-->",i+4);n<e.length&&this.insertAt(e.slice(n))}}lint(e=this.getAbsoluteIndex()){return super.lint(e,new RegExp(String.raw`<\s*(?:\/\s*)?(${this.name})\b`,"giu"))}}}}),xa={};oe(xa,{NowikiToken:()=>va});var $l,_l,va,Xu=C({"src/nowiki/index.ts"(){"use strict";var e,An,s;Ke(),K(),G(),pt(),$l=at(i=>new RegExp(String.raw`<\s*(?:/\s*)${i==="nowiki"?"":"?"}(${i})\b`,"giu")),_l=new Set(["languages","section","templatestyles"]),va=(s=class extends Oe{constructor(){super(...arguments);P(this,e)}get type(){return"ext-inner"}lint(r=this.getAbsoluteIndex()){{const{name:n}=this,{lintConfig:l}=N;let o="void-ext",d=l.getSeverity(o,n);if(d&&R(this,e,An).call(this)){const u=Y(this,{start:r},o,N.msg("nothing-in",n),d);return l.computeEditInfo&&(u.suggestions=[Z(u)]),[u]}return super.lint(r,$l(n))}}getAttribute(r){return r==="invalid"?R(this,e,An).call(this):super.getAttribute(r)}},e=new WeakSet,An=function(){const{name:r,firstChild:{data:n}}=this;return _l.has(r)&&!!n},s)}}),Tl,Oi,Cl,_t,ba=C({"src/tagPair/ext.ts"(){"use strict";K(),me(),G(),Dn(),X(),zn(),Jn(),Tl=[zs()],_t=class extends(Cl=ot){get type(){return"ext"}constructor(e,t,s,i,r=N.getConfig(),n=!1,l=[]){const o=e.toLowerCase(),d=new Hs(!t||/^\s/u.test(t)?t:` ${t}`,"ext-attrs",o,r,l),a={...r,ext:r.ext.filter(c=>c!==o),excludes:[...r.excludes],inExt:!0};let u;switch(o){case"tab":a.ext=a.ext.filter(c=>c!=="tabs");case"indicator":case"poem":case"ref":case"option":case"combooption":case"tabs":case"poll":case"seo":case"langconvert":case"phonos":o==="poem"&&a.excludes.push("heading"),u=new H(s,a,l);break;case"pre":{const{PreToken:c}=(Wu(),se(zo));u=new c(s,a,l);break}case"dynamicpagelist":{const{ParamTagToken:c}=(Vo(),se(Go));u=new c(n,s,a,l);break}case"inputbox":{const{InputboxToken:c}=(Hu(),se(Ko));u=new c(n,s,a,l);break}case"references":{const{NestedToken:c}=(Ci(),se(js));a.excludes.push("heading"),u=new c(s,n,["ref"],a,l);break}case"choose":{const{NestedToken:c}=(Ci(),se(js));u=new c(s,/<(option|choicetemplate)(\s[^>]*?)?(?:\/>|>([\s\S]*?)<\/(\1)>)/gu,["option","choicetemplate"],a,l);break}case"combobox":{const{NestedToken:c}=(Ci(),se(js));u=new c(s,/<(combooption)(\s[^>]*?)?(?:\/>|>([\s\S]*?)<\/(combooption\s*)>)/giu,["combooption"],a,l);break}case"gallery":{const{GalleryToken:c}=(Gu(),se(oa));u=new c(s,a,l);break}case"imagemap":{const{ImagemapToken:c}=(Qu(),se(ha));u=new c(s,a,l);break}case"hiero":{const{CommentedToken:c}=(Ju(),se(fa));u=new c(s,a,l);break}default:{const{NowikiToken:c}=(Xu(),se(xa));u=new c(s,a,l)}}u.setAttribute("name",o),u.type==="plain"&&(u.type="ext-inner"),super(e,d,u,i,r,l),this.seal("closed",!0)}lint(e=this.getAbsoluteIndex(),t){{const s=super.lint(e,t),{lintConfig:i}=N,r=new ce(this,e);if(this.name!=="nowiki"){const n=this.inHtmlAttrs(),l="parsing-order",o=n&&i.getSeverity(l,n===2?"ext":"templateInTable");o&&s.push(Y(this,r,l,"ext-in-html",o))}if(this.name==="ref"){let n="var-anchor",l=i.getSeverity(n,"ref");l&&this.closest("heading-title")&&s.push(Y(this,r,n,"variable-anchor",l)),n="nested-link",l=i.getSeverity(n,"ref"),l&&this.closest("link,ext-link-text")&&s.push(Y(this,r,n,"ref-in-link",l))}return s}}},Oi=ae(Cl),_t=le(Oi,0,"ExtToken",Tl,_t),re(Oi,1,_t)}}),wa={};oe(wa,{parseCommentAndExt:()=>vs});var Bi,Il,$s,Nl,qi,vs,Vs=C({"parser/commentAndExt.ts"(){"use strict";Ke(),fe(),Ru(),Pt(),Ou(),Bu(),ba(),pa(),Bi="<onlyinclude>",Il="</onlyinclude>",{length:$s}=Bi,Nl=[!1,!0].map(e=>{const t=e?"includeonly":"(?:no|only)include",s=e?"noinclude":"includeonly";return $o(i=>new RegExp(String.raw`<!--[\s\S]*?(?:-->|$)|<${t}(?:\s[^>]*)?/?>|</${t}\s*>|<(${i.join("|")})(\s[^>]*?)?(?:/>|>([\s\S]*?)</(${"\\1"}\s*)>)|<(${s})(\s[^>]*?)?(?:/>|>([\s\S]*?)(?:</(${s}\s*)>|$))`,"giu"))}),qi=e=>{const t=e.indexOf(Bi);return{i:t,j:e.indexOf(Il,t+$s)}},vs=(e,t,s,i)=>{if(i){let{i:d,j:a}=qi(e);if(d!==-1&&a!==-1){let u="";const c=p=>{new Ee(p,t,s),u+=`\0${s.length-1}n`};for(;d!==-1&&a!==-1;){const p=`\0${s.length}e`;new Kt(e.slice(d+$s,a),t,s),d>0&&c(e.slice(0,d)),u+=p,e=e.slice(a+$s+1),{i:d,j:a}=qi(e)}return e&&c(e),u}}const{ext:r}=t;let n=r,l=t;if(r.includes("translate")){n=r.filter(a=>a!=="translate"&&a!=="tvar"),l={...t,ext:n};const d=[];e=e.replace(/<nowiki>[\s\S]*?<\/nowiki>/giu,a=>(d.push(a),`\0${d.length-1}`)).replace(/<translate( nowrap)?>([\s\S]+?)?<\/translate>/gu,(a,u,c)=>{const p=s.length;return new Bo(u,c&&Fe(c,d),l,s),`\0${p}g`}),e=Fe(e,d)}const o=Nl[i?1:0](n);return o.lastIndex=0,o.test(e)?e.replace(o,(d,a,u,c,p,m,b,k,A)=>{const _=s.length;let T="n";if(a)T="e",new _t(a,u,c,p,l,m,s);else if(d.startsWith("<!--")){T="c";const f=d.endsWith("-->");new $t(Fe(d,s,1).slice(4,f?-3:void 0),f,t,s)}else m?new Yt(m,b&&Fe(b,s,1),k&&Fe(k,s,1),A,t,s):new Ee(d,t,s,!0);return`\0${_}${T}`}):e}}}),Ll,Fl,El,jl,Wi,Rl,ts,Ku=C({"src/tag/html.ts"(){"use strict";var e,t;K(),me(),Dn(),G(),Oo(),Ll=new Set(["if","ifeq","ifexpr","ifexist","iferror","switch"]),Fl=new Set(["b","big","center","cite","code","del","dfn","em","font","i","ins","kbd","mark","pre","q","s","samp","small","strike","strong","sub","sup","tt","u","var"]),El=new Set(["strike","big","center","font","tt"]),jl=[zs()],ts=(t=class extends(Rl=Hn){constructor(i,r,n,l,o,d){super(i,r,n,o,d);P(this,e);this.setAttribute("name",i.toLowerCase()),F(this,e,l)}get type(){return"html"}get selfClosing(){return w(this,e)}text(){const{closing:i,selfClosing:r,name:n}=this,{html:[,,l]}=this.getAttribute("config");return l.includes(n)?i&&n!=="br"?"":super.text("/"):super.text(r&&!i?"/":"")}lint(i=this.getAbsoluteIndex(),r){var n;{const l=super.lint(i,r),{name:o,parentNode:d,closing:a,selfClosing:u}=this,c=new ce(this,i),{lintConfig:p}=N,{computeEditInfo:m,fix:b}=p,k=this.inTableAttrs();let A="h1",_=p.getSeverity(A,"html");if(_&&o==="h1"&&!a){const h=Y(this,c,A,"<h1>",_);m&&(h.suggestions=[{desc:"h2",range:[i+2,i+3],text:"2"}]),l.push(h)}if(A="parsing-order",_=k&&p.getSeverity(A,k===2?"html":"templateInTable"),_){const h=Y(this,c,A,"html-in-table",_);m&&k===2&&(h.suggestions=[Z(h)]),l.push(h)}if(A="obsolete-tag",_=p.getSeverity(A,o),_&&El.has(o)&&l.push(Y(this,c,A,"obsolete-tag",_)),A="bold-header",_=p.getSeverity(A,o),_&&(o==="b"||o==="strong")&&((n=this.closest("heading-title,ext"))==null?void 0:n.type)==="heading-title"){const h=Y(this,c,A,"bold-in-header",_);m&&(h.suggestions=[Z(h)]),l.push(h)}const{html:[,T,f]}=this.getAttribute("config"),g=f.includes(o),x=T.includes(o),v=!g&&!x;if(A="unmatched-tag",a&&(u||g)||u&&v){if(_=p.getSeverity(A,a?"both":"selfClosing"),_){const h=Y(this,c,A,a?"closing-and-self-closing":"invalid-self-closing",_);if(m||b){const S=Pn(i),y={desc:N.msg("no-self-closing"),range:[h.endIndex-2,h.endIndex-1],text:""};x?m&&(h.suggestions=[S,y]):a?h.fix=g?S:y:m&&(h.suggestions=[y,Je(h.endIndex,`></${o}>`,-2)])}l.push(h)}}else if(!this.findMatchingTag()){const h=Y(this,c,A,a?"unmatched-closing":"unclosed-tag"),S=this.closest("magic-word");if(S&&Ll.has(S.name))_=p.getSeverity(A,"conditional");else if(a)_=p.getSeverity(A,"closing"),h.suggestions=[Z(h)];else{_=p.getSeverity(A,"opening");const y=d==null?void 0:d.childNodes;Fl.has(o)&&(y!=null&&y.slice(0,y.indexOf(this)).some($=>$.type==="html"&&$.name===o&&!$.findMatchingTag())&&(h.suggestions=[Je(i+1,"/")]),this.closest("heading-title")&&(h.rule="format-leakage",_=p.getSeverity("format-leakage",o)))}_&&(h.severity=_,l.push(h))}return l}}getAttribute(i){return i==="invalid"?this.inTableAttrs()===2:super.getAttribute(i)}json(i,r=this.getAbsoluteIndex()){{const n=super.json(void 0,r);return n.selfClosing=w(this,e),n}}},e=new WeakMap,t),Wi=ae(Rl),ts=le(Wi,0,"HtmlToken",jl,ts),re(Wi,1,ts)}}),ya={};oe(ya,{parseHtml:()=>Sa});var Pl,Sa,Yu=C({"parser/html.ts"(){"use strict";Jn(),Ku(),Pl=/^(\/?)([a-z][^\s/>]*)((?:\s|\/(?!>))[^>]*?)?(\/?>)([^<]*)$/iu,Sa=(e,t,s)=>{var l;const{html:i}=t;(l=t.htmlElements)!=null||(t.htmlElements=new Set([...i[0],...i[1],...i[2]]));const r=e.split("<");let n=r.shift();for(const o of r){const d=Pl.exec(o),a=d==null?void 0:d[2],u=a==null?void 0:a.toLowerCase();if(!d||!t.htmlElements.has(u)){n+=`<${o}`;continue}const[,c,,p="",m,b]=d,{length:k}=s,A=new Hs(p,"html-attrs",u,t,s),_=A.hasAttr("itemprop");if(u==="meta"&&!(_&&A.hasAttr("content"))||u==="link"&&!(_&&A.hasAttr("href"))){n+=`<${o}`,s.length=k;continue}n+=`\0${s.length}x${b}`,new ts(a,A,c==="/",m==="/>",t,s)}return n}}}),Ol,Bl,Ui,ql,Tt,Aa=C({"src/table/base.ts"(){"use strict";Dn(),G(),X(),ht(),Jn(),Ol=e=>{const t=e.childNodes.map(i=>i.type==="text"?i.data.replace(/\|\|/gu,"{{!!}}").replace(/\|/gu,"{{!}}"):i.toString()).join(""),{childNodes:s}=N.parse(t,e.getAttribute("include"),2,e.getAttribute("config"));e.safeReplaceChildren(s)},Bl=[zs(1)],Tt=class extends(ql=H){constructor(e,t,s,i,r,n=[],l){super(void 0,r,n,l),this.append(new qe(t,"table-syntax",r,n),new Hs(i,"table-attrs",s,r,n))}escape(){for(const e of this.childNodes)e instanceof qe?Ol(e):e.escape()}},Ui=ae(ql),Tt=le(Ui,0,"TableBaseToken",Bl,Tt),re(Ui,1,Tt)}}),Wl,Mi,Se,_s,Ht,Dt,Bs,ka=C({"src/table/td.ts"(){"use strict";K(),me(),Mn(),G(),X(),Aa(),Bs=class extends(Mi=Tt,Wl=[Ws(!1)],Mi){constructor(e,t,s,i=[]){var o;let r=/\||\0\d+!\x7F/u.exec(t!=null?t:""),n=r?t.slice(0,r.index):"";/\[\[|-\{/u.test(n)&&(r=null,n=""),super(/^(?:\n[^\S\n]*(?:[|!]|\|\+|\{\{\s*!\s*\}\}\+?)|(?:\||\{\{\s*!\s*\}\}){2}|!!|\{\{\s*!!\s*\}\})$/u,e,"td",n,s,i),re(_s,5,this),De(this,Ht),De(this,Se,""),r&&([ku(this,Se)._]=r);const l=new H(t==null?void 0:t.slice(((o=r==null?void 0:r.index)!=null?o:NaN)+pe(this,Se).length),s,i);l.type="td-inner",l.setAttribute("stage",4),this.insertAt(l)}get type(){return"td"}get rowspan(){return this.getAttr("rowspan")}get colspan(){return this.getAttr("colspan")}get subtype(){return cn(this,Ht,Dt).call(this).subtype}afterBuild(){pe(this,Se).includes("\0")&&ke(this,Se,this.buildFromStr(pe(this,Se),0)),super.afterBuild()}toString(e){const{childNodes:[t,s,i]}=this;return t.toString(e)+s.toString(e)+pe(this,Se)+i.toString(e)}text(){const{childNodes:[e,t,s]}=this;return e.text()+t.text()+pe(this,Se)+s.text()}getGaps(e){return e===1?pe(this,Se).length:0}lint(e=this.getAbsoluteIndex(),t){{const s=super.lint(e,t),i=new ce(this,e+this.getRelativeIndex(this.length-1)),r="pipe-like",{lintConfig:n}=N,{computeEditInfo:l,fix:o}=n,d=["td","double"].map(a=>n.getSeverity(r,a));for(const a of this.lastChild.childNodes)if(a.type==="text"){const{data:u}=a;if(u.includes("|")){const c=u.includes("||"),p=d[c?1:0];if(p){const m=J(a,i,r,"pipe-in-table",p);if(l||o)if(c){const b={caption:"|+",td:"|",th:"!"}[this.subtype];m.fix=Pe(m,"newline",u.replace(/\|\|/gu,`
${b}`))}else l&&(m.suggestions=[qn(m.startIndex,u)]);s.push(m)}}}return s}}isIndependent(){return this.firstChild.text().startsWith(`
`)}getAttr(e){{const t=super.getAttr(e);return e==="rowspan"||e==="colspan"?parseInt(t)||1:t}}escape(){super.escape(),this.childNodes[1].toString()&&(pe(this,Se)||ke(this,Se,"{{!}}")),pe(this,Se)==="|"&&ke(this,Se,"{{!}}")}print(){const{childNodes:[e,t,s]}=this;return`<span class="wpb-td">${e.print()}${t.print()}${pe(this,Se)}${s.print()}</span>`}json(e,t=this.getAbsoluteIndex()){{const s=super.json(void 0,t),{rowspan:i,colspan:r}=this;return Object.assign(s,{subtype:this.subtype},i!==1&&{rowspan:i},r!==1&&{colspan:r}),s}}},_s=ae(Mi),Se=new WeakMap,Ht=new WeakSet,Dt=function(){var e;const t=this.firstChild.text(),s=t.slice(-1);let i="td";if(s==="!"?i="th":s==="+"&&(i="caption"),this.isIndependent())return{subtype:i};const{previousSibling:r}=this;return{...cn(e=r,Ht,Dt).call(e)}},Dt=le(_s,17,"#getSyntax",Wl,Ht,Dt),Fn(_s,Bs)}}),sr,$a=C({"src/table/trBase.ts"(){"use strict";K(),G(),Aa(),ka(),sr=class extends Tt{lint(e=this.getAbsoluteIndex(),t){{const s=super.lint(e,t),i=this.childNodes.find(({type:o})=>o==="table-inter");if(!i)return s;const r=ls(i),n="fostered-content",l=r&&N.lintConfig.getSeverity(n,r===2?void 0:"transclusion");if(l){const o=J(i,{start:e},n,"content-outside-table",l);o.startIndex++,o.startLine++,o.startCol=0,s.push(o)}return s}}getRowCount(){return Number(this.childNodes.some(e=>e instanceof Bs&&e.isIndependent()&&!e.firstChild.text().endsWith("+")))}}}}),Ul,Ml,zl,Hl,zi,Ts,Rs,Zu=C({"src/table/index.ts"(){"use strict";K(),je(),me(),Mn(),G(),$a(),ht(),Ul=(e,t)=>new Array(e).fill(void 0).map((s,i)=>t(i)),Ml=({type:e})=>e==="tr"||e==="table-syntax",zl=class extends Array{},Rs=class extends(zi=sr,Hl=[Ws(!1)],zi){constructor(e,t,s,i){super(/^(?:\{\||\{\{\{\s*!\s*\}\}|\{\{\s*\(!\s*\}\})$/u,e,"table",t,s,i,{}),re(Ts,5,this)}get type(){return"table"}get closed(){return this.lastChild.is("table-syntax")}lint(e=this.getAbsoluteIndex(),t){{const s=super.lint(e,t),i=new ce(this,e),r=["unclosed-table","table-layout"],n=r.map(l=>N.lintConfig.getSeverity(l));if(n[0]&&!this.closed&&s.push(J(this.firstChild,i,r[0],"unclosed-table",n[0])),n[1]){const l=this.getLayout(),{length:o}=l;if(o>1){let d=1,a=1/0,u=0;for(;u<o;u++){const c=l[u],p=c.length;if(p<d)break;p<a&&(a=p);const m=c.indexOf(c[p-1])+1;if(m>a)break;m>d&&(d=m)}if(u<o){const c=this.getNthRow(u),p=J(c,i,r[1],"inconsistent-table",n[1]);p.startIndex++,p.startLine++,p.startCol=0,s.push(p)}}}return s}}close(e=`
|}`,t){const s=this.getAttribute("config"),i=this.getAttribute("accum");xe.run(()=>{const r=new qe(t?e:void 0,"table-syntax",s,i);super.insertAt(r)})}getLayout(e){{const t=this.getAllRows(),{length:s}=t,i=zl.from(Ul(s,()=>[]));for(let r=0;r<i.length;r++){const n=i[r];let l=0,o=0,d;for(const a of t[r].childNodes.slice(2))if(a.is("td")){if(a.isIndependent()&&(d=a.subtype!=="caption"),d){const u={row:r,column:l},{rowspan:c,colspan:p}=a;for(l++;n[o];)o++;for(let m=r;m<Math.min(r+c,s);m++)for(let b=o;b<o+p;b++)i[m][b]=u;o+=p}}else if(Ml(a))break}return i}}getAllRows(){return[...super.getRowCount()?[this]:[],...this.childNodes.slice(1).filter(e=>e.is("tr")&&e.getRowCount()>0)]}getNthRow(e,t,s){{const i=super.getRowCount();if(e===0&&i)return this;i&&e--;for(const r of this.childNodes.slice(2)){const{type:n}=r;if(n==="tr"&&r.getRowCount()&&(e--,e<0))return r}return}}json(e,t=this.getAbsoluteIndex()){{const s=super.json(void 0,t);return s.closed=this.closed,s}}},Ts=ae(zi),le(Ts,1,"getLayout",Hl,Rs),Fn(Ts,Rs)}}),_a,ed=C({"src/table/tr.ts"(){"use strict";$a(),_a=class extends sr{get type(){return"tr"}constructor(e,t,s,i){super(/^\n[^\S\n]*(?:\|-+|\{\{\s*!\s*\}\}-+|\{\{\s*!-\s*\}\}-*)$/u,e,"tr",t,s,i)}}}}),ir,Ta=C({"src/nowiki/listBase.ts"(){"use strict";pt(),ir=class extends Oe{get indent(){return this.innerText.split(":").length-1}json(e,t=this.getAbsoluteIndex()){{const s=super.json(void 0,t),{indent:i}=this;return i&&(s.indent=i),s}}}}}),nr,Ca=C({"src/nowiki/dd.ts"(){"use strict";Ta(),nr=class extends ir{get type(){return"dd"}}}}),Ia={};oe(Ia,{parseTable:()=>Na});var Dl,Hi,Na,td=C({"parser/table.ts"(){"use strict";X(),Zu(),ed(),ka(),Ca(),Dl=e=>e.lastChild.constructor!==H,Hi=(e,t)=>e.is("td")?t.pop():e,Na=({firstChild:{data:e},type:t,name:s},i,r)=>{const n=[],l=e.split(`
