...
`){l=v+1;const{pos:G,findEqual:W}=($=t.at(-1))!=null?$:{};if(!G||W||g(u.slice(G,F))!==""){const B=/^(={1,6})(.+)\1((?:\s|\0\d+c\x7F)*)$/u.exec(u.slice(F,v));if(B){u=`${u.slice(0,F)}\0${p.length}h\x7F${u.slice(v)}`,l=F+4+String(p.length).length;const q=e(9450);new q(B[1].length,B.slice(2),a,p)}}}else if(N==="|"||M)l=v+1,z.at(-1).push(u.slice(U,v)),N==="|"&&z.push([]),b.pos=l,b.findEqual=N==="|",t.push(b);else if(N.startsWith("}}")){const G=N.slice(0,Math.min(I.length,3)),W=I.length-G.length,{length:B}=p;l=v+G.length,z.at(-1).push(u.slice(U,v));let q=!1,Q="t";if(G.length===3){const J=e(9544);new J(z.map(V=>V.join("=")),a,p)}else{const J=g(z[0][0]);J in n?Q=n[J]:/^(?:fullurl|canonicalurl|filepath):./iu.test(J)&&(Q="m");try{const V=e(1782);new V(z[0][0],z.slice(1),a,p)}catch(V){if(V instanceof Error&&V.message.startsWith("\u975E\u6CD5\u7684\u6A21\u677F\u540D\u79F0\uFF1A"))l=F+I.length,q=!0;else throw V}}q||(u=`${u.slice(0,F+W)}\0${B}${Q}\x7F${u.slice(l)}`,l=F+W+3+String(B).length,W>1?t.push({0:I.slice(0,W),index:F,pos:F+W,parts:[[]]}):W===1&&u[F-1]==="-"&&t.push({0:"-{",index:F-1,pos:F+1,parts:[[]]}))}else l=v+N.length,N[0]==="{"&&(o.pos=l,o.parts=[[]]),t.push(..."0"in b?[b]:[],o);r&&(r=u.slice(l).includes("}}"));let X=t.at(-1);!r&&((k=X==null?void 0:X[0])==null?void 0:k[0])==="{"&&(t.pop(),X=t.at(-1)),i=new RegExp(h+(X?`|${s[X[0][0]]}${X.findEqual?"|=":""}`:""),"gmu"),i.lastIndex=l,o=i.exec(u)}return u};m.exports=d},4907:(m,C,e)=>{"use strict";const g=e(6010),f=(d,u=g.getConfig(),a=[],p=!1)=>{const h=/<onlyinclude>(.*?)<\/onlyinclude>/gsu;if(p&&d.search(h)!==-1)return d.replaceAll(h,(o,r)=>{const l=`\0${a.length}e\x7F`,c=e(851);return new c(r,u,a),l}).replaceAll(/(^|\0\d+e\x7F)(.*?)(?=$|\0\d+e\x7F)/gsu,(o,r,l)=>{if(l==="")return r;const c=e(3423);return new c(l,u,a),`${r}\0${a.length-1}c\x7F`});const t=u.ext.join("|"),s=p?"includeonly":"(?:no|only)include",n=p?"noinclude":"includeonly",i=new RegExp(`<!--.*?(?:-->|$)|<${s}(?:\\s[^>]*?)?>|</${s}\\s*>|<(${t})(\\s[^>]*?)?(?:/>|>(.*?)</(\\1\\s*)>)|<(${n})(\\s[^>]*?)?(?:/>|>(.*?)(?:</(\\5\\s*)>|$))`,"gisu");return d.replaceAll(i,(o,r,l,c,x,A,$,k,N)=>{const v=`\0${a.length}${r?"e":"c"}\x7F`;if(r){const b=e(7267);new b(r,l,c,x,u,a)}else if(o.startsWith("<!--")){const b=e(5749),I=o.endsWith("-->");new b(o.slice(4,I?-3:void 0),I,u,a)}else if(A){const b=e(8655);new b(A,$,k,N,u,a)}else{const b=e(3423);new b(o,u,a)}return v})};m.exports=f},3765:(m,C,e)=>{"use strict";const g=e(6010),f=(d,u=g.getConfig(),a=[])=>{const p=e(9910),h=/-\{/gu,t=/-\{|\}-/gu,s=[];let n=h,i=n.exec(d);for(;i;){const{0:o,index:r}=i;if(o==="}-"){const l=s.pop(),{length:c}=a,x=d.slice(l.index+2,r),A=x.indexOf("|"),[$,k]=A===-1?[[],x]:[x.slice(0,A).split(";"),x.slice(A+1)],N=k.replaceAll(/(&[#a-z\d]+);/giu,"$1"),v=`(?:${u.variants.join("|")})`,b=N.split(new RegExp(`;(?=\\s*(?:${v}|[^;]*?=>\\s*${v})\\s*:)`,"u")).map(I=>I.replaceAll("",";"));new p($,b,u,a),d=`${d.slice(0,l.index)}\0${c}v\x7F${d.slice(r+2)}`,s.length===0&&(n=h),n.lastIndex=l.index+3+String(c).length}else s.push(i),n=t;i=n.exec(d)}return d};m.exports=f},7513:(m,C,e)=>{"use strict";const{extUrlChar:g}=e(231),f=e(6010),d=(u,a=f.getConfig(),p=[])=>{const h=e(741),t=new RegExp(`\\[((?:${a.protocol}|//)${g}|\0\\d+m\x7F)(\\p{Zs}*)([^\\]-\b
-\uFFFD]*)\\]`,"giu");return u.replaceAll(t,(s,n,i,o)=>{const{length:r}=p,l=/&[lg]t;/u.exec(n);return l&&(n=n.slice(0,l.index),i="",o=`${n.slice(l.index)}${i}${o}`),new h(n,i,o,a,p),`\0${r}w\x7F`})};m.exports=d},2937:(m,C,e)=>{"use strict";const g=e(6010),f=({firstChild:{data:d},type:u,name:a},p=g.getConfig(),h=[])=>{const t=e(7507),s=e(8138),n=e(2582),i=e(7815),{doubleUnderscore:o}=p;return u!=="root"&&(u!=="ext-inner"||a!=="poem")&&(d=`\0${d}`),d=d.replaceAll(/^((?:\0\d+c\x7F)*)(-{4,})/gmu,(r,l,c)=>(new n(c.length,p,h),`${l}\0${h.length-1}r\x7F`)).replaceAll(new RegExp(`__(${o.flat().join("|")})__`,"giu"),(r,l)=>o[0].includes(l.toLowerCase())||o[1].includes(l)?(new i(l,p,h),`\0${h.length-1}u\x7F`):r),u==="root"||u==="ext-inner"&&a==="poem"?d:d.slice(1)};m.exports=f},5130:(m,C,e)=>{"use strict";const g=e(6010),f=(d,u=g.getConfig(),a=[])=>{const p=/^(\/?)([a-z][^\s/>]*)(\s[^>]*?)?(\/?>)([^<]*)$/iu,h=u.html.flat(),t=d.split("<");let s=t.shift();for(const n of t){const i=p.exec(n),o=i==null?void 0:i[2],r=o==null?void 0:o.toLowerCase();if(!i||!h.includes(r)){s+=`<${n}`;continue}const l=e(5037),[,c,,x="",A,$]=i,k=new l(x,"html-attr",r,u,a),N=k.getAttr("itemprop");if(r==="meta"&&(N===void 0||k.getAttr("content")===void 0)||r==="link"&&(N===void 0||k.getAttr("href")===void 0)){s+=`<${n}`,a.pop();continue}s+=`\0${a.length}x\x7F${$}`;const v=e(2350);new v(o,k,c==="/",A==="/>",u,a)}return s};m.exports=f},1452:(m,C,e)=>{"use strict";const g=e(6010),f=(d,u=g.getConfig(),a=[])=>{const p=e(3360),h=/^((?:(?!\0\d+!\x7F)[^\n<>[\]{}|])+)(?:(\||\0\d+!\x7F)(.*?[^\]]))?\]\](.*)$/su,t=/^((?:(?!\0\d+!\x7F)[^\n<>[\]{}|])+)(\||\0\d+!\x7F)(.*)$/su,s=new RegExp(`^\\s*(?:${u.protocol})`,"iu"),n=d.split("[[");let i=n.shift();for(let o=0;o<n.length;o++){let r,l,c,x,A;const $=n[o],k=h.exec($);if(k)[,l,c,x,A]=k,A[0]==="]"&&(x==null?void 0:x.includes("["))&&(x+="]",A=A.slice(1));else{const O=t.exec($);O&&(r=!0,[,l,c,x]=O)}if(l===void 0||s.test(l)||/\0\d+[exhbru]\x7F/u.test(l)){i+=`[[${$}`;continue}let N=l;if(l.includes("%"))try{N=decodeURIComponent(l)}catch(O){}const v=l.trim()[0]===":";if(v&&r){i+=`[[${$}`;continue}const b=g.normalizeTitle(N,0,!1,u,!0),{ns:I,valid:F}=b;if(F){if(r){if(I!==6){i+=`[[${$}`;continue}let O;for(o++;o<n.length;o++){const U=n[o],M=U.split("]]");if(M.length>2){O=!0,x+=`[[${M[0]}]]${M[1]}`,A=M.slice(2).join("]]");break}else if(M.length===2)x+=`[[${M[0]}]]${M[1]}`;else{x+=`[[${U}`;break}}if(x=f(x,u,a),!O){i+=`[[${l}${c}${x}`;continue}}}else{i+=`[[${$}`;continue}x&&(x=p(x,u,a)),i+=`\0${a.length}l\x7F${A}`;let z=e(3905);v||(I===6?z=e(7625):I===14&&(z=e(337))),new z(l,x,b,u,a,c)}return i};m.exports=f},6622:(m,C,e)=>{"use strict";const g=e(6010),f=(d,u=g.getConfig(),a=[])=>{const p=/^((?:\0\d+c\x7F)*)([;:*#]+)/u.exec(d);if(!p)return d;const h=e(962),[t,s,n]=p;d=`${s}\0${a.length}d\x7F${d.slice(t.length)}`,new h(n,u,a);let i=n.split(";").length-1;if(!i)return d;const o=e(3434);let r=/:+|-\{/gu,l=r.exec(d),c=0;for(;l&&i;){const{0:x,index:A}=l;if(x[0]===":"){if(x.length>=i)return new o(":".repeat(i),u,a),`${d.slice(0,A)}\0${a.length-1}d\x7F${d.slice(A+i)}`;d=`${d.slice(0,A)}\0${a.length}d\x7F${d.slice(r.lastIndex)}`,i-=x.length,r.lastIndex=A+4+String(a.length).length,new o(x,u,a)}else if(x==="-{"){if(!c){const{lastIndex:$}=r;r=/-\{|\}-/gu,r.lastIndex=$}c++}else if(c--,!c){const{lastIndex:$}=r;r=/:+|-\{/gu,r.lastIndex=$}l=r.exec(d)}return d};m.exports=f},4737:(m,C,e)=>{"use strict";const{extUrlChar:g}=e(231),f=e(6010),d=(u,a=f.getConfig(),p=[])=>{const h=e(8962),t=new RegExp(`\\b(?:${a.protocol})(${g})`,"giu");return u.replaceAll(t,(s,n)=>{let i="",o=s;const r=/&(?:lt|gt|nbsp|#x0*(?:3[ce]|a0)|#0*(?:6[02]|160));/iu.exec(o);r&&(i=o.slice(r.index),o=o.slice(0,r.index));const l=new RegExp(`[,;.:!?${o.includes("(")?"":")"}]+$`,"u"),c=l.exec(o);if(c){let x=0;c[0][0]===";"&&/&(?:[a-z]+|#x[\da-f]+|#\d+)$/iu.test(o.slice(0,c.index))&&(x=1),i=`${o.slice(c.index+x)}${i}`,o=o.slice(0,c.index+x)}return i.length>=n.length?s:(new h(o,!1,a,p),`\0${p.length-1}w\x7F${i}`)})};m.exports=d},3360:(m,C,e)=>{"use strict";const g=e(6010),f=(d,u=g.getConfig(),a=[])=>{var l;const p=d.split(/('{2,})/u),{length:h}=p;if(h===1)return d;let t=0,s=0,n,i,o;for(let c=1;c<h;c+=2){const{length:x}=p[c];switch(x){case 2:s++;break;case 4:p[c-1]+="'",p[c]="'''";case 3:if(t++,n)break;p[c-1].at(-1)===" "?!i&&!o&&(o=c):p[c-1].at(-2)===" "?n=c:i||(i=c);break;default:p[c-1]+="'".repeat(x-5),p[c]="'''''",s++,t++}}if(s%2===1&&t%2===1){const c=(l=n!=null?n:i)!=null?l:o;p[c]="''",p[c-1]+="'"}const r=e(6714);for(let c=1;c<h;c+=2)new r(p[c].length,u,a),p[c]=`\0${a.length-1}q\x7F`;return p.join("")};m.exports=f},4624:(m,C,e)=>{"use strict";const g=e(6010),f=e(7507),d=e(8138),u=e(2840),a=e(3125),p=e(5567),h=({firstChild:{data:t},type:s,name:n},i=g.getConfig(),o=[])=>{const r=[],l=t.split(`
`);let c=s==="root"||s==="parameter-value"||s==="ext-inner"&&n==="poem"?"":`
${l.shift()}`;const x=(A,$)=>{if(!$){c+=A;return}const{lastChild:k}=$;if(k.constructor===d)k.setText(String(k)+A);else{const N=new d(A,i,!0,o);N.type="table-inter",$.insertAt(N.setAttribute("stage",3))}};for(const A of l){let $=r.pop();const[k]=/^(?:\s|\0\d+c\x7F)*/u.exec(A),N=A.slice(k.length),v=/^(:*)((?:\s|\0\d+c\x7F)*)(\{\||\{\0\d+!\x7F|\0\d+\{\x7F)(.*)$/u.exec(N);if(v){for(;$&&$.type!=="td";)$=r.pop();const[,U,M,X,G]=v;if(U){const B=e(3434);new B(U,i,o)}x(`
...
${k}${I}`,!0),x(O,r.at(-1))}else if(F){$.type==="td"&&($=r.pop()),$.type==="tr"&&($=r.pop());const U=new a(`
...
`)}getGaps(){return 1}print(){return super.print({sep:`
`})}lint(o=0){const r=super.lint(o),l=this.getRootNode().posFromIndex(o);return this.image?r.push(...this.childNodes.filter(c=>{const x=String(c).trim();return c.type==="noinclude"&&x&&x[0]!=="#"}).map(c=>f(c,l,"\u65E0\u6548\u7684<imagemap>\u94FE\u63A5"))):r.push(g(this,l,"\u7F3A\u5C11\u56FE\u7247\u7684<imagemap>")),r}}m.exports=s},2571:(m,C,e)=>{"use strict";const g=e(8138),f=e(3905),d=e(741);class u extends g{constructor(h,t,s,n,i){const o=e(6986),r=e(7507),l=e(3423),c=t[2]instanceof o?f:d;super(void 0,n,!0,i);S(this,"type","imagemap-link");this.append(new r(h),new c(...t,n,i),new l(s,n,i))}}m.exports=u},8138:(m,C,e)=>{var p,h,t,s,n,i,o,ot,l,lt,x,at,$,ht,N,dt,b,ut,F,pt,O,ct,M,gt,G,ft,B,xt;"use strict";const g=e(6010),f=e(9205),d=e(7507),{MAX_STAGE:u}=g,Q=class extends f{constructor(y,P=g.getConfig(),E=!1,Z=[],_=null){super();w(this,o);w(this,l);w(this,x);w(this,$);w(this,N);w(this,b);w(this,F);w(this,O);w(this,M);w(this,G);w(this,B);S(this,"type","root");w(this,p,0);w(this,h,void 0);w(this,t,void 0);w(this,s,(y=T(this,p),P=!1)=>{if(y<T(this,p)||!this.isPlain()||this.childNodes.length===0)return this;switch(y){case 0:this.type==="root"&&T(this,t).shift(),D(this,o,ot).call(this,P);break;case 1:D(this,l,lt).call(this);break;case 2:D(this,x,at).call(this);break;case 3:D(this,$,ht).call(this);break;case 4:D(this,N,dt).call(this);break;case 5:D(this,b,ut).call(this);break;case 6:D(this,F,pt).call(this);break;case 7:D(this,O,ct).call(this);break;case 8:D(this,M,gt).call(this);break;case 9:D(this,G,ft).call(this);break;case 10:D(this,B,xt).call(this)}if(this.type==="root")for(const E of T(this,t))E.getAttribute("parseOnce")(y,P);return et(this,p)._++,this});w(this,n,y=>y.split(/[\0\x7F]/u).map((P,E)=>{if(E%2===0)return new d(P);if(isNaN(P.at(-1)))return T(this,t)[Number(P.slice(0,-1))];throw new Error(`\u89E3\u6790\u9519\u8BEF\uFF01\u672A\u6B63\u786E\u6807\u8BB0\u7684 Token\uFF1A${P}`)}));w(this,i,()=>{H(this,p,u);const{length:y,firstChild:P}=this,E=String(P);if(y===1&&P.type==="text"&&E.includes("\0")&&(this.replaceChildren(...T(this,n).call(this,E)),this.normalize(),this.type==="root"))for(const Z of T(this,t))Z.getAttribute("build")()});typeof y=="string"&&this.insertAt(E?y:y.replaceAll(/[\0\x7F]/gu,"")),H(this,h,P),H(this,t,Z),Z.push(this)}getAttribute(y){switch(y){case"config":return structuredClone(T(this,h));case"accum":return T(this,t);case"parseOnce":return T(this,s);case"buildFromStr":return T(this,n);case"build":return T(this,i);default:return super.getAttribute(y)}}setAttribute(y,P){switch(y){case"stage":return T(this,p)===0&&this.type==="root"&&T(this,t).shift(),H(this,p,P),this;default:return super.setAttribute(y,P)}}isPlain(){return this.constructor===Q}insertAt(y,P=this.childNodes.length){return typeof y=="string"&&(y=new d(y)),super.insertAt(y,P),y.type==="root"&&(y.type="plain"),y}normalizeTitle(y,P=0,E=!1){return g.normalizeTitle(y,P,!1,T(this,h),E)}afterBuild(){if(this.type==="root")for(const y of T(this,t))y.afterBuild();return this}parse(y=u,P=!1){for(;T(this,p)<y;)T(this,s).call(this,T(this,p),P);return y&&(T(this,i).call(this),this.afterBuild()),this}};let a=Q;p=new WeakMap,h=new WeakMap,t=new WeakMap,s=new WeakMap,n=new WeakMap,i=new WeakMap,o=new WeakSet,ot=function(y){const P=e(4907);this.setText(P(String(this),T(this,h),T(this,t),y))},l=new WeakSet,lt=function(){const y=e(8275),P=this.type==="root"?String(this):`\0${String(this)}`,E=y(P,T(this,h),T(this,t));this.setText(this.type==="root"?E:E.slice(1))},x=new WeakSet,at=function(){const y=e(5130);this.setText(y(String(this),T(this,h),T(this,t)))},$=new WeakSet,ht=function(){const y=e(4624),P=e(2840);this.setText(y(this,T(this,h),T(this,t)));for(const E of T(this,t))if(E instanceof P&&E.type!=="td"){E.normalize();const{childNodes:[,Z]}=E;if(typeof Z=="string"&&Z.includes("\0")){E.removeAt(1);const _=new Q(Z,T(this,h),!0,T(this,t));E.insertAt(_,1),_.setAttribute("stage",4)}}},N=new WeakSet,dt=function(){const y=e(2937);this.setText(y(this,T(this,h),T(this,t)))},b=new WeakSet,ut=function(){const y=e(1452);this.setText(y(String(this),T(this,h),T(this,t)))},F=new WeakSet,pt=function(){const y=e(3360),P=String(this).split(`
