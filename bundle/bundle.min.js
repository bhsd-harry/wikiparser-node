...
`})}};vr=new WeakSet,Pi=function(e){return this.normalizeTitle(e,6,!0,!0).valid}});var At,un=b(()=>{"use strict";j();Gt();At=class extends $e{get type(){return"link"}lint(n=this.getAbsoluteIndex(),e){let t=super.lint(n,e);return this.closest("ext-link-text")&&t.push($(this,{start:n},"nested-link","internal link in an external link")),t}}});var wo,So,Vt,Le,Ar=b(()=>{"use strict";j();Q();X();R();B();wo=String.raw`(?:[\p{Zs}\t]|&nbsp;|&#0*160;|&#[xX]0*[aA]0;)`,So=new RegExp(`${wo}+`,"gu"),Le=class extends T{constructor(e,t="free-ext-link",r=f.getConfig(),i){super(e,r,i,{});y(this,Vt);A(this,Vt,t)}get type(){return c(this,Vt)}get link(){let e={"!":"|","=":"="},t=de(this.childNodes.map(r=>{let{type:i,name:s}=r;return i==="magic-word"&&String(s)in e?e[s]:r}));return this.type==="magic-link"&&(t=t.replace(So," "),t.startsWith("ISBN")&&(t=`ISBN ${t.slice(5).replace(/[- ]/gu,"").replace(/x$/u,"X")}`)),t}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t),i=new F(this,e);if(this.type==="magic-link"){let{link:g}=this;if(g.startsWith("ISBN")){let p=[...g.slice(5)].map(d=>d==="X"?10:Number(d));(p.length===10&&p.reduce((d,u,h)=>d+u*(10-h),0)%11||p.length===13&&(p[12]===10||p.reduce((d,u,h)=>d+u*(h%2?3:1),0)%10))&&r.push($(this,i,"invalid-isbn","invalid ISBN"))}return r}let s=`[\uFF0C\uFF1B\u3002\uFF1A\uFF01\uFF1F\uFF08\uFF09]+${this.type==="ext-link-url"?String.raw`|\|+`:""}`,o=new RegExp(s,"u"),l=new RegExp(s,"gu");for(let g of this.childNodes){let{type:p,data:d}=g;if(p!=="text"||!o.test(d))continue;let u=C(g,i,"unterminated-url","","warning");l.lastIndex=0;for(let h=l.exec(d);h;h=l.exec(d)){let{index:m,0:x}=h,k=d.slice(0,m).split(`
`),E=k.length,w=k[E-1].length,v=u.startIndex+m,S=u.startLine+E-1,L=E===1?u.startCol+w:w,P=x.startsWith("|"),q={...u,message:f.msg("$1 in URL",P?'"|"':"full-width punctuation"),startIndex:v,endIndex:v+x.length,startLine:S,endLine:S,startCol:L,endCol:L+x.length};P?x.length===1&&(q.suggestions=[{desc:"whitespace",range:[v,v+1],text:" "}]):q.suggestions=[{desc:"whitespace",range:[v,v],text:" "},{desc:"escape",range:[v,q.endIndex],text:encodeURI(x)}],r.push(q)}}return r}};Vt=new WeakMap});var Fe,wt,cn=b(()=>{"use strict";Ce();j();R();B();Ar();wt=class extends T{constructor(e,t="",r="",i=f.getConfig(),s=[]){super(void 0,i,s,{});y(this,Fe);let o=e&&/\0\d+f\x7F/u.test(e)?s[Number(e.slice(1,-2))]:new Le(e,"ext-link-url",i,s);if(this.insertAt(o),A(this,Fe,t),r){let l=new T(r,i,s,{});l.type="ext-link-text",l.setAttribute("stage",10),this.insertAt(l)}}get type(){return"ext-link"}toString(){return this.length===1?`[${super.toString()}${c(this,Fe)}]`:`[${super.toString(c(this,Fe))}]`}text(){return`[${super.text(" ")}]`}getAttribute(e){return e==="padding"?1:super.getAttribute(e)}getGaps(){return c(this,Fe).length}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t);return this.length===1&&this.closest("heading-title")&&r.push($(this,{start:e},"var-anchor","variable anchor in a section header")),r}print(){return super.print(this.length===1?{pre:"[",post:`${c(this,Fe)}]`}:{pre:"[",sep:c(this,Fe),post:"]"})}};Fe=new WeakMap});var Xt,qi=b(()=>{"use strict";R();B();_e();un();cn();Xt=class extends T{get type(){return"imagemap-link"}constructor(n,e,t,r=f.getConfig(),i=[]){super(void 0,r,i),this.append(n,e.length===2?new At(...e,r,i):new wt(...e,r,i),new D(t,r,i))}}});var _i={};H(_i,{ImagemapToken:()=>hn});var hn,Gi=b(()=>{"use strict";j();Q();be();R();B();_e();gn();qi();hn=class extends T{get type(){return"ext-inner"}get image(){return this.childNodes.find(Ke("imagemap-image"))}constructor(n,e=f.getConfig(),t=[]){if(super(void 0,e,t,{}),!n)return;let r=n.split(`
...
`})}}});var Oi={};H(Oi,{NowikiToken:()=>mn});var mn,zi=b(()=>{"use strict";j();R();qe();mn=class extends Y{get type(){return"ext-inner"}lint(n=this.getAbsoluteIndex()){let{name:e,firstChild:{data:t}}=this;if((e==="templatestyles"||e==="section")&&t){let r=$(this,{start:n},"void-ext",f.msg("nothing should be in <$1>",e));return r.fix={range:[n-1,r.endIndex+e.length+3],text:"/>"},[r]}return super.lint(n,new RegExp(String.raw`<\s*(?:/\s*)${e==="nowiki"?"":"?"}(${e})\b`,"giu"))}}});var Mi,bt,sn=b(()=>{"use strict";j();Q();R();B();Dr();ur();Mi=(a,n)=>{let e=new Set(a);return e.delete(n),[...e]},bt=class extends ct{get type(){return"ext"}constructor(n,e,t,r,i=f.getConfig(),s=[]){var d;let o=n.toLowerCase(),l=new ze(!e||e.trimStart()!==e?e:` ${e}`,"ext-attrs",o,i,s),g={...i,ext:Mi(i.ext,o),excludes:[...(d=i.excludes)!=null?d:[]]},p;switch(g.inExt=!0,o){case"tab":g.ext=Mi(g.ext,"tabs");case"indicator":case"poem":case"ref":case"option":case"combooption":case"tabs":case"poll":case"seo":o==="poem"&&g.excludes.push("heading"),p=new T(t,g,s);break;case"pre":{let{PreToken:u}=(Ti(),O(xi));p=new u(t,g,s);break}case"dynamicpagelist":{let{ParamTagToken:u}=(Qr(),O(bi));p=new u(t,g,s);break}case"inputbox":{g.excludes.push("heading");let{InputboxToken:u}=(Ei(),O(Ni));p=new u(t,g,s);break}case"references":{let{NestedToken:u}=(Tr(),O(xr));p=new u(t,/<!--.*?(?:-->|$)|<(ref)(\s[^>]*)?>(.*?)<\/(ref\s*)>/gisu,["ref"],g,s);break}case"choose":{let{NestedToken:u}=(Tr(),O(xr));p=new u(t,/<(option|choicetemplate)(\s[^>]*)?>(.*?)<\/(\1)>/gsu,["option","choicetemplate"],g,s);break}case"combobox":{let{NestedToken:u}=(Tr(),O(xr));p=new u(t,/<(combooption)(\s[^>]*)?>(.*?)<\/(combooption\s*)>/gisu,["combooption"],g,s);break}case"gallery":{let{GalleryToken:u}=(ji(),O(Bi));p=new u(t,g,s);break}case"imagemap":{let{ImagemapToken:u}=(Gi(),O(_i));p=new u(t,g,s);break}default:{let{NowikiToken:u}=(zi(),O(Oi));p=new u(t,g,s)}}p.setAttribute("name",o),p.type==="plain"&&(p.type="ext-inner"),super(n,l,p,r,i,s),this.seal("closed",!0)}lint(n=this.getAbsoluteIndex(),e){let t=super.lint(n,e),r=new F(this,n);return this.name!=="nowiki"&&this.closest("html-attrs, table-attrs")&&t.push($(this,r,"parsing-order","extension tag in HTML tag attributes")),this.name==="ref"&&this.closest("heading-title")&&t.push($(this,r,"var-anchor","variable anchor in a section header")),t}}});var Wi={};H(Wi,{parseCommentAndExt:()=>Co});var Co,Ui=b(()=>{"use strict";si();_e();ai();sn();rn();Co=(a,n,e,t)=>{let r="<onlyinclude>",i="</onlyinclude>",{length:s}=r,o=()=>{let u=a.indexOf(r);return{i:u,j:a.indexOf(i,u+s)}};if(t){let{i:u,j:h}=o();if(u!==-1&&h!==-1){let m="",x=k=>{new D(k,n,e),m+=`\0${e.length-1}c\x7F`};for(;u!==-1&&h!==-1;){let k=`\0${e.length}e\x7F`;new lr(a.slice(u+s,h),n,e),u>0&&x(a.slice(0,u)),m+=k,a=a.slice(h+s+1),{i:u,j:h}=o()}return a&&x(a),m}}let l=n.ext.join("|"),g=t?"includeonly":"(?:no|only)include",p=t?"noinclude":"includeonly",d=new RegExp(String.raw`<!--.*?(?:-->|$)|<${g}(?:\s[^>]*)?/?>|</${g}\s*>|<(${l})(\s[^>]*?)?(?:/>|>(.*?)</(\1\s*)>)|<(${p})(\s[^>]*?)?(?:/>|>(.*?)(?:</(${p}\s*)>|$))`,"gisu");return a.replace(d,(u,h,m,x,k,E,w,v,S)=>{let L=`\0${e.length}${h?"e":"c"}\x7F`;if(h)new bt(h,m,x,k,n,e);else if(u.startsWith("<!--")){let P=u.endsWith("-->");new Ie(u.slice(4,P?-3:void 0),P,n,e)}else E?new Xe(E,w,v,S,n,e):new D(u,n,e);return L})}});var $o,No,Eo,St,he,Me,wr,Di=b(()=>{"use strict";j();Q();X();B();$o=new Set(["if","ifeq","ifexpr","ifexist","iferror","switch"]),No=new Set(["b","big","center","cite","code","del","dfn","em","font","i","ins","kbd","mark","pre","q","s","samp","small","strike","strong","sub","sup","tt","u","var"]),Eo=new Set(["strike","big","center","font","tt"]),wr=class extends T{constructor(e,t,r,i,s,o){super(void 0,s,o);y(this,St);y(this,he);y(this,Me);this.insertAt(t),this.setAttribute("name",e.toLowerCase()),A(this,St,r),A(this,he,i),A(this,Me,e)}get type(){return"html"}get selfClosing(){return c(this,he)}get closing(){return c(this,St)}toString(){return`<${this.closing?"/":""}${c(this,Me)}${super.toString()}${c(this,he)?"/":""}>`}text(){let{closing:e}=this,t=c(this,Me)+(e?"":super.text());return`<${e?"/":""}${t}${c(this,he)?"/":""}>`}getAttribute(e){return e==="padding"?c(this,Me).length+(this.closing?2:1):super.getAttribute(e)}lint(e=this.getAbsoluteIndex(),t){var s;let r=super.lint(e,t),i=new F(this,e);this.name==="h1"&&!this.closing&&r.push($(this,i,"h1","<h1>")),this.closest("table-attrs")&&r.push($(this,i,"parsing-order","HTML tag in table attributes"));try{this.findMatchingTag()}catch(o){if(o instanceof SyntaxError){let{message:l}=o,g=l.split(":")[0].toLowerCase(),p=$(this,i,"unmatched-tag",g);if(g==="unclosed tag"&&!this.closest("heading-title"))if(No.has(this.name)){let d=(s=this.parentNode)==null?void 0:s.childNodes,u=d==null?void 0:d.indexOf(this);d!=null&&d.slice(0,u).some(({type:h,name:m})=>h==="html"&&m===this.name)||(p.severity="warning")}else p.severity="warning";else if(g==="unmatched closing tag"){let d=this.closest("magic-word");d&&$o.has(d.name)?p.severity="warning":p.suggestions=[{desc:"remove",range:[e,p.endIndex],text:""}]}else if(g==="tag that is both closing and self-closing"){let{html:[,,d]}=this.getAttribute("config");d.includes(this.name)&&(p.fix={range:[e+1,e+2],text:""})}r.push(p)}}return Eo.has(this.name)&&r.push($(this,i,"obsolete-tag","obsolete HTML tag","warning")),(this.name==="b"||this.name==="strong")&&this.closest("heading-title")&&r.push($(this,i,"bold-header","bold in section header","warning")),r}findMatchingTag(){let{html:[e,t,r]}=this.getAttribute("config"),{name:i,parentNode:s,closing:o}=this,l=Wn(this.toString());if(o&&(c(this,he)||r.includes(i)))throw new SyntaxError(`Tag that is both closing and self-closing: ${l}`);if(r.includes(i)||c(this,he)&&t.includes(i))return this;if(c(this,he)&&e.includes(i))throw new SyntaxError(`Invalid self-closing tag: ${l}`);if(!s)return;let{childNodes:g}=s,p=g.indexOf(this),d=(o?g.slice(0,p).reverse():g.slice(p+1)).filter(h=>h.type==="html"&&h.name===i),u=o?-1:1;for(let h of d)if(c(h,St)?u--:u++,u===0)return h;throw new SyntaxError(`${o?"Unmatched closing":"Unclosed"} tag: ${l}`)}print(){return super.print({pre:`&lt;${this.closing?"/":""}${c(this,Me)}`,post:`${c(this,he)?"/":""}&gt;`})}json(){let e=super.json();return Object.assign(e,{closing:this.closing,selfClosing:c(this,he)}),e}};St=new WeakMap,he=new WeakMap,Me=new WeakMap});var Hi={};H(Hi,{parseHtml:()=>Io});var Io,Vi=b(()=>{"use strict";ur();Di();Io=(a,n,e)=>{let t=/^(\/?)([a-z][^\s/>]*)((?:\s|\/(?!>))[^>]*?)?(\/?>)([^<]*)$/iu,{html:r}=n,i=new Set([...r[0],...r[1],...r[2]]),s=a.split("<"),o=s.shift();for(let l of s){let g=t.exec(l),p=g==null?void 0:g[2],d=p==null?void 0:p.toLowerCase();if(!g||!i.has(d)){o+=`<${l}`;continue}let[,u,,h="",m,x]=g,{length:k}=e,E=new ze(h,"html-attrs",d,n,e),w=E.getAttr("itemprop");if(d==="meta"&&(w===void 0||E.getAttr("content")===void 0)||d==="link"&&(w===void 0||E.getAttr("href")===void 0)){o+=`<${l}`,e.length=k;continue}o+=`\0${e.length}x\x7F${x}`,new wr(p,E,u==="/",m==="/>",n,e)}return o}});var Xi,Zi=b(()=>{"use strict";be();Xi=(a=0)=>(n,e)=>{var r,Qi;class t extends n{constructor(){super(...arguments);y(this,r)}getAttr(l){return c(this,r,Qi).getAttr(l)}}return r=new WeakSet,Qi=function(){return this.childNodes[a]},or(t,n),t}});var Ct,fn=b(()=>{"use strict";Zi();R();B();gt();ur();Ct=class extends Xi(1)(T){constructor(n,e,t,r,i=f.getConfig(),s=[],o={}){super(void 0,i,s,o),this.append(new ue(e,n,"table-syntax",i,s,{}),new ze(r,"table-attrs",t,i,s))}}});var me,Qt,et,xn,Ki,Ye,Tn=b(()=>{"use strict";j();Q();Ce();be();R();B();fn();Ye=class extends Ct{constructor(e,t,r=f.getConfig(),i=[]){var g;let s=/\||\0\d+!\x7F/u.exec(t!=null?t:""),o=s?t.slice(0,s.index):"";/\[\[|-\{/u.test(o)&&(s=null,o="");super(/^(?:\n[^\S\n]*(?:[|!]|\|\+|\{\{\s*!\s*\}\}\+?)|(?:\||\{\{\s*!\s*\}\}){2}|!!|\{\{\s*!!\s*\}\})$/u,e,"td",o,r,i);y(this,et);y(this,me,"");y(this,Qt);s&&([tr(this,me)._]=s);let l=new T(t==null?void 0:t.slice(((g=s==null?void 0:s.index)!=null?g:NaN)+c(this,me).length),r,i);l.type="td-inner",l.setAttribute("stage",4),this.insertAt(l)}get type(){return"td"}get rowspan(){return this.getAttr("rowspan")}get colspan(){return this.getAttr("colspan")}get subtype(){return N(this,et,xn).call(this).subtype}afterBuild(){c(this,me).includes("\0")&&A(this,me,this.buildFromStr(c(this,me),0)),super.afterBuild()}toString(){let{childNodes:[e,t,r]}=this;return e.toString()+t.toString()+c(this,me)+r.toString()}text(){let{childNodes:[e,t,r]}=this;return e.text()+t.text()+c(this,me)+r.text()}getGaps(e){return e===1?c(this,me).length:0}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t),i=new F(this,e+this.getRelativeIndex(this.length-1));for(let s of this.lastChild.childNodes)if(s.type==="text"){let{data:o}=s;if(o.includes("|")){let l=o.includes("||"),g=C(s,i,"pipe-like",'additional "|" in a table cell',l?"error":"warning");if(l){let p={caption:"|+",td:"|",th:"!"}[this.subtype];g.fix={range:[g.startIndex,g.endIndex],text:o.replace(/\|\|/gu,`
...
`)}getAttr(e){let t=super.getAttr(e);return e==="rowspan"||e==="colspan"?parseInt(t)||1:t}print(){let{childNodes:[e,t,r]}=this;return`<span class="wpb-td">${e.print()}${t.print()}${c(this,me)}${r.print()}</span>`}json(){let e=super.json();return e.subtype=this.subtype,e}};me=new WeakMap,Qt=new WeakMap,et=new WeakSet,xn=function(){var t;let{rev:e}=ye;return(t=c(this,Qt))!=null||A(this,Qt,[e,N(this,et,Ki).call(this)]),c(this,Qt)[1]},Ki=function(){var o;let e=this.firstChild.text(),t=e.slice(-1),r="td";if(t==="!"?r="th":t==="+"&&(r="caption"),this.isIndependent())return{subtype:r};let{previousSibling:i}=this;return{...N(o=i,et,xn).call(o)}}});var $t,bn=b(()=>{"use strict";j();be();fn();Tn();$t=class extends Ct{lint(n=this.getAbsoluteIndex(),e){let t=super.lint(n,e),r=this.childNodes.find(({type:p})=>p==="table-inter");if(!r)return t;let i=r.childNodes.find(p=>p.text().trim()),s=/^\s*(?:!|\{\{\s*![!-]?\s*\}\})/u,o=Ke("arg"),l=Ke("magic-word");if(!i||s.test(i.toString())||o(i)&&s.test(i.default||""))return t;if(l(i))try{if(i.getPossibleValues().every(p=>s.test(p.text())))return t}catch(p){}let g=C(r,{start:n},"fostered-content","content to be moved out from the table");return g.severity=i.type==="template"?"warning":"error",g.startIndex++,g.startLine++,g.startCol=0,t.push(g),t}getRowCount(){return Number(this.childNodes.some(n=>n instanceof Ye&&n.isIndependent()&&!n.firstChild.text().endsWith("+")))}getNthCol(n,e){let t=0;for(let r of this.childNodes.slice(2))if(r instanceof Ye&&(r.isIndependent()&&(t=+(r.subtype!=="caption")),n-=t,n<0))return r}}});var Lo,Fo,kn,Sr,Ji=b(()=>{"use strict";j();Q();be();R();bn();gt();Lo=/^\n[^\S\n]*(?:\|\}|\{\{\s*!\s*\}\}\}|\{\{\s*!\)\s*\}\})$/u,Fo=({type:a})=>a==="tr"||a==="table-syntax",kn=class extends Array{},Sr=class extends $t{get type(){return"table"}get closed(){return this.lastChild.type==="table-syntax"}constructor(n,e,t,r){super(/^(?:\{\||\{\{\{\s*!\s*\}\}|\{\{\s*\(!\s*\}\})$/u,n,"table",e,t,r,{})}lint(n=this.getAbsoluteIndex(),e){let t=super.lint(n,e),r=new F(this,n);this.closed||t.push(C(this.firstChild,r,"unclosed-table",f.msg("unclosed $1","table")));let i=this.getLayout(),{length:s}=i;if(s>1){let o=1,l=1/0,g=0;for(;g<s;g++){let p=i[g],d=p.length;if(d<o)break;d<l&&(l=d);let u=p.indexOf(p[d-1])+1;if(u>l)break;u>o&&(o=u)}if(g<s){let p=C(this.getNthRow(g),r,"table-layout","inconsistent table layout","warning");p.startIndex++,p.startLine++,p.startCol=0,t.push(p)}}return t}close(n=`
|}`,e){let t=this.getAttribute("config"),r=this.getAttribute("accum"),i=e?[n]:f.parse(n,this.getAttribute("include"),2,t).childNodes;ye.run(()=>{let s=new ue(void 0,Lo,"table-syntax",t,r,{});super.insertAt(s)}),this.lastChild.replaceChildren(...i)}getLayout(n){let e=this.getAllRows(),{length:t}=e,r=new kn(...Yi(t,()=>[]));for(let i=0;i<t;i++){let s=r[i],o=0,l=0,g;for(let p of e[i].childNodes.slice(2))if(p.type==="td"){if(p.isIndependent()&&(g=p.subtype!=="caption"),g){let d={row:i,column:o},{rowspan:u,colspan:h}=p;for(o++;s[l];)l++;for(let m=i;m<Math.min(i+u,t);m++)for(let x=l;x<l+h;x++)r[m][x]=d;l+=h}}else if(Fo(p))break}return r}getAllRows(){return[...super.getRowCount()?[this]:[],...this.childNodes.slice(1).filter(n=>n.type==="tr"&&n.getRowCount()>0)]}getNthCell(n){var t;let e=n;return e&&((t=this.getNthRow(e.row,!1,!1))==null?void 0:t.getNthCol(e.column))}getNthRow(n,e,t){let r=super.getRowCount();if(n===0&&r)return this;r&&n--;for(let i of this.childNodes.slice(2))if(i.type==="tr"&&i.getRowCount()&&(n--,n<0))return i}json(){let n=super.json();return n.closed=this.closed,n}}});var Cr,es=b(()=>{"use strict";bn();Cr=class extends $t{get type(){return"tr"}constructor(n,e,t,r){super(/^\n[^\S\n]*(?:\|-+|\{\{\s*!\s*\}\}-+|\{\{\s*!-\s*\}\}-*)$/u,n,"tr",e,t,r,{})}}});var Nt,yn=b(()=>{"use strict";qe();Nt=class extends Y{}});var Et,vn=b(()=>{"use strict";yn();Et=class extends Nt{get type(){return"dd"}}});var ts={};H(ts,{parseTable:()=>Po});var Ro,Po,rs=b(()=>{"use strict";B();Ji();es();Tn();vn();Ro=a=>a.lastChild.constructor!==T,Po=({firstChild:{data:a},type:n,name:e},t,r)=>{let i=[],s=a.split(`
...
${u}${S&&`\0${r.length-1}d\x7F`}${L}\0${r.length}b\x7F`,l),i.push(...l?[l]:[],new Sr(P,q,t,r));continue}else if(!l){o+=`
...
${u}${k}`,!0),g(v,i[i.length-1])}else if(E){l=p(),l.type==="tr"&&(l=i.pop());let S=new Cr(`
${u}${E}`,v,t,r);i.push(l,S),l.insertAt(S)}else{l=p();let S=w==="!"?/!!|(?:\||\0\d+!\x7F){2}|\0\d+\+\x7F/gu:/(?:\||\0\d+!\x7F){2}|\0\d+\+\x7F/gu,L=S.exec(v),P=0,q=`
${u}${w}`,V=re=>{let xe=new Ye(q,v.slice(P,L==null?void 0:L.index),t,r);return re.insertAt(xe),xe};for(;L;)V(l),{lastIndex:P}=S,[q]=L,L=S.exec(v);i.push(l,V(l))}}return o.slice(1)}});var $r,ns=b(()=>{"use strict";qe();$r=class extends Y{get type(){return"hr"}}});var is,An,Bo,tt,ss=b(()=>{"use strict";De();qe();is=[pe(!0)];tt=class extends(Bo=Y){get type(){return"double-underscore"}constructor(n,e,t,r){super(n,t,r)}getAttribute(n){return n==="padding"?2:super.getAttribute(n)}toString(){return`__${this.innerText}__`}print(){return super.print({pre:"__",post:"__"})}};An=se(Bo),tt=ae(An,0,"DoubleUnderscoreToken",is,tt),oe(An,1,tt)});var os={};H(os,{parseHrAndDoubleUnderscore:()=>jo});var jo,as=b(()=>{"use strict";ns();ss();Zr();jo=({firstChild:{data:a},type:n,name:e},t,r)=>{let{doubleUnderscore:i}=t,s=new Set(i[0]),o=new Set(i[1]);return n!=="root"&&(n!=="ext-inner"||e!=="poem")&&(a=`\0${a}`),a=a.replace(/^((?:\0\d+c\x7F)*)(-{4,})/gmu,(l,g,p)=>(new $r(p,t,r),`${g}\0${r.length-1}r\x7F`)).replace(new RegExp(`__(${[...i[0],...i[1]].join("|")})__`,"giu"),(l,g)=>{let p=o.has(g);return p||s.has(g.toLowerCase())?(new tt(g,p,t,r),`\0${r.length-1}u\x7F`):l}).replace(/^((?:\0\d+c\x7F)*)(={1,6})(.+)\2((?:[^\S\n]|\0\d+c\x7F)*)$/gmu,(l,g,p,d,u)=>{let h=`${g}\0${r.length}h\x7F`;return new xt(p.length,[d,u],t,r),h}),n==="root"||n==="ext-inner"&&e==="poem"?a:a.slice(1)}});var Nr,ls=b(()=>{"use strict";j();Q();R();qe();Nr=class extends Y{get type(){return"quote"}get bold(){return this.innerText.length!==2}get italic(){return this.innerText.length!==3}lint(n=this.getAbsoluteIndex()){let{previousSibling:e,nextSibling:t,bold:r}=this,i=f.msg('lonely "$1"',"'"),s=[],o=new F(this,n),l,g=(p,d,u)=>({desc:"escape",range:[p,d],text:"&apos;".repeat(u)});if((e==null?void 0:e.type)==="text"&&e.data.endsWith("'")){l=$(this,o,"lonely-apos",i);let{startIndex:p,startLine:d,startCol:u}=l,[,{length:h}]=/(?:^|[^'])('+)$/u.exec(e.data),m=n-h;s.push({...l,startIndex:m,endIndex:p,startCol:u-h,endLine:d,endCol:u,suggestions:[g(m,p,h)]})}if((t==null?void 0:t.type)==="text"&&t.data.startsWith("'")){l!=null||(l=$(this,o,"lonely-apos",i));let{endIndex:p,endLine:d,endCol:u}=l,[{length:h}]=/^'+/u.exec(t.data),m=p+h;s.push({...l,startIndex:p,endIndex:m,startLine:d,startCol:u,endCol:u+h,suggestions:[g(p,m,h)]})}return r&&this.closest("heading-title")&&s.push($(this,o,"bold-header","bold in section header","warning")),s}json(){let n=super.json();return Object.assign(n,{bold:this.bold,italic:this.italic}),n}}});var ds={};H(ds,{parseQuotes:()=>wn});var wn,Sn=b(()=>{"use strict";ls();wn=(a,n,e)=>{var p;let t=a.split(/('{2,})/u),{length:r}=t;if(r===1)return a;let i=0,s=0,o,l,g;for(let d=1;d<r;d+=2){let u=t[d].length;switch(u){case 2:s++;break;case 4:t[d-1]+="'",t[d]="'''";case 3:if(i++,o!==void 0)break;t[d-1].endsWith(" ")?l===void 0&&g===void 0&&(g=d):t[d-1].slice(-2,-1)===" "?o=d:l!=null||(l=d);break;default:t[d-1]+="'".repeat(u-5),t[d]="'''''",s++,i++}}if(s%2===1&&i%2===1){let d=(p=o!=null?o:l)!=null?p:g;d!==void 0&&(t[d]="''",t[d-1]+="'")}for(let d=1;d<r;d+=2)new Nr(t[d],n,e),t[d]=`\0${e.length-1}q\x7F`;return t.join("")}});var gs={};H(gs,{parseExternalLinks:()=>Cn});var Cn,$n=b(()=>{"use strict";X();cn();Ar();Cn=(a,n,e,t)=>{let r=new RegExp(String.raw`\[(\0\d+f\x7F|(?:(?:${n.protocol}|//)${we}|\0\d+m\x7F)${Se}(?=[[\]<>"\t\p{Zs}]|\0\d))(\p{Zs}*(?!\p{Zs}))([^\]\x01-\x08\x0A-\x1F\uFFFD]*)\]`,"giu");return a.replace(r,(i,s,o,l)=>{let{length:g}=e,p=/&[lg]t;/u.exec(s);return p&&(s=s.slice(0,p.index),o="",l=s.slice(p.index)+o+l),t?(new Le(s,"ext-link-url",n,e),`[\0${g}f\x7F${o}${l}]`):(new wt(s,o,l,n,e),`\0${g}w\x7F`)})}});var Er,ps=b(()=>{"use strict";Gt();Er=class extends $e{get type(){return"category"}}});var cs={};H(cs,{parseLinks:()=>us});var us,hs=b(()=>{"use strict";R();Sn();$n();un();dn();ps();us=(a,n,e)=>{let t=n.inExt?/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(?:(\||\0\d+!\x7F)(.*?[^\]]))?\]\](.*)$/su:/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(?:(\||\0\d+!\x7F)(.*?[^\]])?)?\]\](.*)$/su,r=/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(\||\0\d+!\x7F)(.*)$/su,i=new RegExp(String.raw`^\s*(?:${n.protocol}|//)`,"iu"),s=a.split("[["),o=s.shift();for(let l=0;l<s.length;l++){let g=!1,p,d,u,h,m=s[l],x=t.exec(m);if(x)[,p,d,u,h]=x,h.startsWith("]")&&(u!=null&&u.includes("["))&&(u+="]",h=h.slice(1));else{let P=r.exec(m);P&&(g=!0,[,p,d,u]=P)}if(p===void 0||i.test(p)||/\0\d+[exhbru]\x7F/u.test(p)){o+=`[[${m}`;continue}let k=p.trim().startsWith(":");if(k&&g){o+=`[[${m}`;continue}let E=f.normalizeTitle(p,0,!1,n,!0,!0,!0),{ns:w,valid:v,interwiki:S}=E;if(v){if(g){if(S||w!==6){o+=`[[${m}`;continue}let P=!1;for(l++;l<s.length;l++){let q=s[l],V=q.split("]]");if(V.length>2){P=!0,u+=`[[${V[0]}]]${V[1]}`,h=V.slice(2).join("]]");break}else if(V.length===2)u+=`[[${V[0]}]]${V[1]}`;else{u+=`[[${q}`;break}}if(u=us(u,n,e),!P){o+=`[[${p}${d}${u}`;continue}}}else{o+=`[[${m}`;continue}u&&(u=wn(u,n,e));let L=At;k||(!S&&w===6?(u&&(u=Cn(u,n,e,!0)),L=yt):!S&&w===14&&(L=Er)),u===void 0&&d&&(u=""),o+=`\0${e.length}l\x7F${h}`,new L(p,u,n,e,d)}return o}});var ms={};H(ms,{parseMagicLinks:()=>Go});var qo,_o,Go,fs=b(()=>{"use strict";X();Ar();qo=/[^,;\\.:!?)][,;\\.:!?)]+$/u,_o=/[^,;\\.:!?][,;\\.:!?]+$/u,Go=(a,n,e)=>{let t=String.raw`[\p{Zs}\t]|&nbsp;|&#0*160;|&#x0*a0;`,r=`(?:${t}|-)`,i=new RegExp(String.raw`(^|[^\p{L}\d_])(?:(?:${n.protocol})(${we}${Se})|(?:RFC|PMID)(?:${t})+\d+\b|ISBN(?:${t})+(?:97[89]${r}?)?(?:\d${r}?){9}[\dx]\b)`,"giu");return a.replace(i,(s,o,l)=>{let g=o?s.slice(o.length):s;if(l){let p="",d=/&(?:lt|gt|nbsp|#x0*(?:3[ce]|a0)|#0*(?:6[02]|160));/iu.exec(g);d&&(p=g.slice(d.index),g=g.slice(0,d.index));let u=g.includes("(")?_o:qo,h=u.exec(g);if(h){let m=1;h[0][1]===";"&&/&(?:[a-z]+|#x[\da-f]+|#\d+)$/iu.test(g.slice(0,h.index))&&(m=2),p=g.slice(h.index+m)+p,g=g.slice(0,h.index+m)}return p.length>=l.length?s:(new Le(g,void 0,n,e),`${o}\0${e.length-1}w\x7F${p}`)}else if(!/^(?:RFC|PMID|ISBN)/u.test(g))return s;return new Le(g,"magic-link",n,e),`${o}\0${e.length-1}i\x7F`})}});var Ir,xs=b(()=>{"use strict";yn();Ir=class extends Nt{get type(){return"list"}}});var Ts={};H(Ts,{parseList:()=>Oo});var Oo,bs=b(()=>{"use strict";xs();vn();Oo=(a,n,e)=>{let t=/^((?:\0\d+c\x7F)*)([;:*#]+)/u.exec(a);if(!t)return a;let[r,i,s]=t,o=`${i}\0${e.length}d\x7F${a.slice(r.length)}`,l=s.split(";").length-1;if(new Ir(s,n,e),!l)return o;let{html:[g]}=n,p=/:+|-\{|\0\d+[xq]\x7F/gu,d=p,u=d.exec(o),h=0,m=!1,x=!1,k=0,E=(v,S)=>(new Et(v,n,e),`${o.slice(0,S)}\0${e.length-1}d\x7F${o.slice(S+v.length)}`),w=v=>{v?h&&h--:h++};for(;u&&l;){let{0:v,index:S}=u;if(v==="-{"){if(!k){let{lastIndex:L}=d;d=/-\{|\}-/gu,d.lastIndex=L}k++}else if(v==="}-"){if(k--,!k){let{lastIndex:L}=d;d=p,d.lastIndex=L}}else if(v.endsWith("x\x7F")){let{name:L,closing:P,selfClosing:q}=e[Number(v.slice(1,-2))];(!q||g.includes(L))&&w(P)}else if(v.endsWith("q\x7F")){let{bold:L,italic:P}=e[Number(v.slice(1,-2))];L&&(w(m),m=!m),P&&(w(x),x=!x)}else if(h===0){if(v.length>=l)return E(v.slice(0,l),S);l-=v.length,d.lastIndex=S+4+String(e.length).length,o=E(v,S)}u=d.exec(o)}return o}});var ks,Re,Lr,ys=b(()=>{"use strict";j();Q();R();B();Ee();ks=new Set(["A","T","R","D","-","H","N"]),Lr=class extends T{constructor(e,t=f.getConfig(),r=[]){super(void 0,t,r,{});y(this,Re);this.append(...e.map(i=>new z(i,"converter-flag",t,r)))}get type(){return"converter-flags"}afterBuild(){A(this,Re,this.childNodes.map(e=>e.text().trim())),super.afterBuild()}toString(){return super.toString(";")}text(){return super.text(";")}getGaps(){return 1}getUnknownFlags(){return new Set(c(this,Re).filter(e=>/\{{3}[^{}]+\}{3}/u.test(e)))}getVariantFlags(){let e=new Set(this.getAttribute("config").variants);return new Set(c(this,Re).filter(t=>e.has(t)))}lint(e=this.getAbsoluteIndex(),t){let r=this.getVariantFlags(),i=this.getUnknownFlags(),s=new Set(c(this,Re).filter(h=>ks.has(h))),o=c(this,Re).filter(h=>!h).length,l=c(this,Re).length-i.size-o,g=super.lint(e,t);if(r.size===l||s.size===l)return g;let p=new F(this,e),{childNodes:d,length:u}=this;for(let h=0;h<u;h++){let m=d[h],x=m.text().trim();if(x&&!r.has(x)&&!i.has(x)&&(r.size>0||!s.has(x))){let k=C(m,p,"no-ignored","invalid conversion flag");r.size===0&&ks.has(x.toUpperCase())?k.fix={range:[k.startIndex,k.endIndex],text:x.toUpperCase()}:k.suggestions=[{desc:"remove",range:[k.startIndex,k.endIndex],text:""}],g.push(k)}}return g}print(){return super.print({sep:";"})}};Re=new WeakMap});var It,vs=b(()=>{"use strict";R();B();Ee();It=class extends T{get type(){return"converter-rule"}constructor(n,e=!0,t=f.getConfig(),r=[]){super(void 0,t,r);let i=n.indexOf(":"),s=n.slice(0,i).indexOf("=>"),o=s===-1?n.slice(0,i):n.slice(s+2,i);e&&t.variants.includes(o.trim())?(super.insertAt(new z(o,"converter-rule-variant",t,r)),super.insertAt(new z(n.slice(i+1),"converter-rule-to",t,r)),s!==-1&&super.insertAt(new z(n.slice(0,s),"converter-rule-from",t,r),0)):super.insertAt(new z(n,"converter-rule-to",t,r))}toString(){let{childNodes:n}=this;if(n.length===3){let[e,t,r]=n;return`${e.toString()}=>${t.toString()}:${r.toString()}`}return super.toString(":")}text(){let{childNodes:n}=this;if(n.length===3){let[e,t,r]=n;return`${e.text()}=>${t.text()}:${r.text()}`}return super.text(":")}getGaps(n){return n===0&&this.length===3?2:1}print(){let{childNodes:n}=this;if(n.length===3){let[e,t,r]=n;return`<span class="wpb-converter-rule">${e.print()}=>${t.print()}:${r.print()}</span>`}return super.print({sep:":"})}}});var Fr,As=b(()=>{"use strict";X();R();B();ys();vs();Fr=class extends T{get type(){return"converter"}constructor(n,e,t=f.getConfig(),r=[]){super(void 0,t,r),this.append(new Lr(n,t,r));let[i]=e,s=i.includes(":"),o=new It(i,s,t,r);s&&o.length===1?this.insertAt(new It(e.join(";"),!1,t,r)):this.append(o,...e.slice(1).map(l=>new It(l,!0,t,r)))}toString(){let{childNodes:[n,...e]}=this;return`-{${n.toString()}${n.length>0?"|":""}${e.map(String).join(";")}}-`}text(){let{childNodes:[n,...e]}=this;return`-{${n.text()}|${de(e,";")}}-`}getAttribute(n){return n==="padding"?2:super.getAttribute(n)}getGaps(n){return n||this.firstChild.length>0?1:0}print(){let{childNodes:[n,...e]}=this;return`<span class="wpb-converter">-{${n.print()}${n.length>0?"|":""}${Ne(e,{sep:";"})}}-</span>`}}});var ws={};H(ws,{parseConverter:()=>zo});var zo,Ss=b(()=>{"use strict";As();zo=(a,n,e)=>{let t=`(?:${n.variants.join("|")})`,r=/-\{/gu,i=/-\{|\}-/gu,s=new RegExp(String.raw`;(?=(?:[^;]*?=>)?\s*${t}\s*:|(?:\s|\0\d+c\x7F)*$)`,"u"),o=[],l=r,g=l.exec(a);for(;g;){let{0:p,index:d}=g;if(p==="}-"){let u=o.pop(),{length:h}=e,m=a.slice(u.index+2,d),x=m.indexOf("|"),[k,E]=x===-1?[[],m]:[m.slice(0,x).split(";"),m.slice(x+1)],w=E.replace(/(&[#a-z\d]+);/giu,"$1"),v=w.split(s).map(S=>S.replace(/\x01/gu,";"));new Fr(k,v,n,e),a=`${a.slice(0,u.index)}\0${h}v\x7F${a.slice(d+2)}`,o.length===0&&(l=r),l.lastIndex=u.index+3+String(h).length}else o.push(g),l=i,l.lastIndex=d+2;g=l.exec(a)}return a}});var Rr={};H(Rr,{Token:()=>T});var Zt,fe,_,M,rt,Lt,Kt,G,Cs,$s,Ns,Es,Is,Ls,Fs,Rs,Ps,Bs,js,qs,Nn,T,B=b(()=>{"use strict";X();Ce();be();j();R();Qn();Jn();Nn=class Nn extends ir{constructor(e,t=f.getConfig(),r=[],i){super();y(this,G);y(this,Zt,"plain");y(this,fe,0);y(this,_);y(this,M);y(this,rt);y(this,Lt,!1);y(this,Kt);typeof e=="string"&&this.insertAt(e),A(this,_,t),A(this,M,r),r.push(this)}get type(){return c(this,Zt)}set type(e){A(this,Zt,e)}parseOnce(e=c(this,fe),t=!1){if(e<c(this,fe)||!this.getAttribute("plain")||this.length===0)return this;if(c(this,fe)>=11)return this;switch(e){case 0:if(this.type==="root"){c(this,M).shift();let r=N(this,G,Cs).call(this);t&&(t=!r)}A(this,rt,t),N(this,G,$s).call(this,t);break;case 1:N(this,G,Ns).call(this);break;case 2:N(this,G,Es).call(this);break;case 3:N(this,G,Is).call(this);break;case 4:N(this,G,Ls).call(this);break;case 5:N(this,G,Fs).call(this);break;case 6:N(this,G,Rs).call(this);break;case 7:N(this,G,Ps).call(this);break;case 8:N(this,G,Bs).call(this);break;case 9:N(this,G,js).call(this);break;case 10:N(this,G,qs).call(this)}if(this.type==="root")for(let r of c(this,M))r.parseOnce(e,t);return tr(this,fe)._++,this}buildFromStr(e,t){let r=e.split(/[\0\x7F]/u).map((i,s)=>{if(s%2===0)return new jt(i);if(isNaN(i.slice(-1)))return c(this,M)[Number(i.slice(0,-1))];throw new Error(`Failed to build! Unrecognized token: ${i}`)});return t===0?r.map(String).join(""):t===1?de(r):r}build(){A(this,fe,11);let{length:e,firstChild:t}=this,r=String(t);if(e===1&&t.type==="text"&&r.includes("\0")&&(this.replaceChildren(...this.buildFromStr(r)),this.normalize(),this.type==="root"))for(let i of c(this,M))i.build()}afterBuild(){if(this.type==="root")for(let e of c(this,M))e.afterBuild();A(this,Lt,!0)}parse(e=11,t){for(e=Math.min(e,11);c(this,fe)<e;)this.parseOnce(c(this,fe),t);return e&&(this.build(),this.afterBuild()),this}getAttribute(e){var t;switch(e){case"plain":return this.constructor===Nn;case"config":return c(this,_);case"include":return(t=c(this,rt))!=null?t:!!c(this.getRootNode(),rt);case"accum":return c(this,M);case"built":return c(this,Lt);default:return super.getAttribute(e)}}setAttribute(e,t){switch(e){case"stage":c(this,fe)===0&&this.type==="root"&&c(this,M).shift(),A(this,fe,t);break;default:super.setAttribute(e,t)}}insertAt(e,t=this.length){let r=typeof e=="string"?new jt(e):e;return super.insertAt(r,t),r.type==="root"&&(r.type="plain"),r}normalizeTitle(e,t=0,r,i,s){return f.normalizeTitle(e,t,c(this,rt),c(this,_),r,i,s)}lint(e=this.getAbsoluteIndex(),t){var i;let r=super.lint(e,t);if(this.type==="root"){let s={};for(let h of this.querySelectorAll("category")){let m=s[h.name];m?m.add(h):s[h.name]=new Set([h])}for(let h of Object.values(s))h.size>1&&r.push(...[...h].map(m=>{let x=$(m,{start:m.getAbsoluteIndex()},"no-duplicate","duplicated category");return x.suggestions=[{desc:"remove",range:[x.startIndex,x.endIndex],text:""}],x}));let o=/<!--\s*lint-(disable(?:(?:-next)?-line)?|enable)(\s[\sa-z,-]*)?-->/gu,l=this.toString(),g=[],p=o.exec(l),d=0,u=0;for(;p;){let{1:h,index:m}=p,x=(i=p[2])==null?void 0:i.trim();u+=l.slice(d,m).split(`
`).length-1,d=m,g.push({line:u+(h==="disable-line"?0:1),from:h==="disable"?o.lastIndex:void 0,to:h==="enable"?o.lastIndex:void 0,rules:x?new Set(x.split(",").map(k=>k.trim())):void 0}),p=o.exec(l)}r=r.filter(({rule:h,startLine:m,startIndex:x})=>{let k={pos:0};for(let{line:E,from:w,to:v,rules:S}of g){if(E>m+1)break;if(S&&!S.has(h))continue;if(E===m&&w===void 0&&v===void 0)return!1;w<=x&&w>k.pos?(k.pos=w,k.type="from"):v<=x&&v>k.pos&&(k.pos=v,k.type="to")}return k.type!=="from"})}return r}toString(e){var i;let{rev:t}=ye,r=this.getRootNode();return r.type==="root"&&c(r,Lt)?((i=c(this,Kt))!=null||A(this,Kt,[t,super.toString(e)]),c(this,Kt)[1]):super.toString(e)}};Zt=new WeakMap,fe=new WeakMap,_=new WeakMap,M=new WeakMap,rt=new WeakMap,Lt=new WeakMap,Kt=new WeakMap,G=new WeakSet,Cs=function(){let{parseRedirect:e}=(ii(),O(ni)),t=this.firstChild.toString(),r=e(t,c(this,_),c(this,M));return r&&this.setText(r),!!r},$s=function(e){let{parseCommentAndExt:t}=(Ui(),O(Wi));this.setText(t(this.firstChild.toString(),c(this,_),c(this,M),e))},Ns=function(){let{parseBraces:e}=(Yr(),O($i)),t=this.type==="root"?this.firstChild.toString():`\0${this.firstChild.toString()}`,r=e(t,c(this,_),c(this,M));this.setText(this.type==="root"?r:r.slice(1))},Es=function(){var t;if((t=c(this,_).excludes)!=null&&t.includes("html"))return;let{parseHtml:e}=(Vi(),O(Hi));this.setText(e(this.firstChild.toString(),c(this,_),c(this,M)))},Is=function(){var t;if((t=c(this,_).excludes)!=null&&t.includes("table"))return;let{parseTable:e}=(rs(),O(ts));this.setText(e(this,c(this,_),c(this,M)))},Ls=function(){var t;if((t=c(this,_).excludes)!=null&&t.includes("hr"))return;let{parseHrAndDoubleUnderscore:e}=(as(),O(os));this.setText(e(this,c(this,_),c(this,M)))},Fs=function(){let{parseLinks:e}=(hs(),O(cs));this.setText(e(this.firstChild.toString(),c(this,_),c(this,M)))},Rs=function(){var r;if((r=c(this,_).excludes)!=null&&r.includes("quote"))return;let{parseQuotes:e}=(Sn(),O(ds)),t=this.firstChild.toString().split(`
...
`))},qs=function(){if(c(this,_).variants.length>0){let{parseConverter:e}=(Ss(),O(ws));this.setText(e(this.firstChild.toString(),c(this,_),c(this,M)))}};T=Nn});var ye,Ke,Mr,Yi,or,be=b(()=>{"use strict";ye={running:!1,run(a){let{running:n}=this;this.running=!0;try{let{Token:e}=(B(),O(Rr)),t=a();return t instanceof e&&!t.getAttribute("built")&&t.afterBuild(),this.running=n,t}catch(e){throw this.running=n,e}},rev:0},Ke=a=>n=>n.type===a,Mr=(a,n,e,t=[])=>{let r=[...a.childNodes],i=r.splice(n,e,...t);a.setAttribute("childNodes",r);for(let s of t)s.setAttribute("parentNode",a);return i},Yi=(a,n)=>new Array(a).fill(void 0).map((e,t)=>n(t)),or=(a,n)=>{Object.defineProperty(a,"name",{value:n.name})}});var Gs={};H(Gs,{Title:()=>En});var _s,Jt,Yt,En,Os=b(()=>{"use strict";X();_s=a=>decodeURIComponent(a.replace(/%(?![\da-f]{2})/giu,"%25")),En=class{constructor(n,e,t,r,i){y(this,Jt);y(this,Yt);U(this,"ns");U(this,"fragment");U(this,"interwiki","");U(this,"valid");U(this,"encoded",!1);let s=n.trim().startsWith("../");if(n=Mn(n),r&&n.includes("%"))try{let l=/%(?!21|3[ce]|5[bd]|7[b-d])[\da-f]{2}/iu.test(n);n=_s(n),this.encoded=l}catch(l){}if(n=n.replace(/_/gu," ").trim(),s)this.ns=0;else{let l=e;n.startsWith(":")&&(l=0,n=n.slice(1).trim());let g=n.split(":");if(g.length>1){let p=t.nsid[g[0].trim().toLowerCase()];p&&(l=p,n=g.slice(1).join(":").trim())}this.ns=l}let o=n.indexOf("#");if(o!==-1){let l=n.slice(o+1).trimEnd();if(l.includes("%"))try{l=_s(l)}catch(g){}this.fragment=l,n=n.slice(0,o).trim()}this.valid=!!(n||this.interwiki||i&&this.ns===0&&this.fragment!==void 0)&&!/^:|\0\d+[eh!+-]\x7F|[<>[\]{}|\n]|%[\da-f]{2}|(?:^|\/)\.{1,2}(?:$|\/)/iu.test(s?/^(?:\.\.\/)+(.*)/u.exec(n)[1]:n),this.main=n,Object.defineProperties(this,{encoded:{enumerable:!1,writable:!1}}),A(this,Yt,t.namespaces)}get main(){return c(this,Jt)}set main(n){n=n.replace(/_/gu," ").trim(),A(this,Jt,n&&n[0].toUpperCase()+n.slice(1))}get prefix(){let n=c(this,Yt)[this.ns];return n+(n&&":")}get title(){return(this.interwiki+(this.interwiki&&":")+this.prefix+this.main).replace(/ /gu,"_")}get extension(){let{main:n}=this,e=n.lastIndexOf(".");return e===-1?void 0:n.slice(e+1).toLowerCase()}toString(){return`${this.title}${this.fragment===void 0?"":`#${this.fragment}`}`}};Jt=new WeakMap,Yt=new WeakMap});var nt,zs,Mo,f,R=b(()=>{Gn();be();Ce();X();nt={i18n:void 0,rules:_n,getConfig(){return{...Dn,...this.config,excludes:[]}},msg(a,n=""){var e,t;return a&&((t=(e=this.i18n)==null?void 0:e[a])!=null?t:a).replace("$1",this.msg(n))},normalizeTitle(a,n=0,e,t=nt.getConfig(),r,i=!1,s=!1){let{Title:o}=(Os(),O(Gs));if(r)return new o(a,n,t,i,s);let{Token:l}=(B(),O(Rr));return ye.run(()=>{let g=new l(a,t);g.type="root",g.parseOnce(0,e).parseOnce();let p=new o(g.toString(),n,t,i,s);for(let d of["main","fragment"]){let u=p[d];u!=null&&u.includes("\0")&&(p[d]=g.buildFromStr(u,1))}return p})},parse(a,n,e=11,t=nt.getConfig()){a=zn(a);let{Token:r}=(B(),O(Rr));return ye.run(()=>{let s=new r(a,t);return s.type="root",s.parse(e,n)})}},zs={},Mo=new Set(["normalizeTitle","parse"]);for(let a in nt)Mo.has(a)||(zs[a]={enumerable:!1});Object.defineProperties(nt,zs);typeof self=="object"?Object.assign(self,{Parser:nt}):typeof globalThis=="object"&&Object.assign(globalThis,{Parser:nt});f=nt});R();})();
