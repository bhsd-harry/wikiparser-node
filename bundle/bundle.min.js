...
|}`,t){le.run(()=>{const s=new xe(t?e:void 0,"table-syntax",this.getAttribute("config"),this.getAttribute("accum"));super.insertAt(s)})}getLayout(e){}getAllRows(){}getNthRow(e,t,s){}json(e,t=this.getAbsoluteIndex()){}},St=q(Fs),O(St,1,"getLayout",Ui,Nt),tr(St,Nt)}}),ua,Hl=f({"src/table/tr.ts"(){"use strict";oa(),ua=class extends gr{get type(){return"tr"}constructor(e,t,s,r){super(/^\n[^\S\n]*(?:\|-+|\{\{\s*!\s*\}\}-+|\{\{\s*!-\s*\}\}-*)$/u,e,"tr",t,s,r)}}}}),xr,ha=f({"src/nowiki/listBase.ts"(){"use strict";ke(),xr=class extends ie{get indent(){}json(e,t=this.getAbsoluteIndex()){}}}}),mr,da=f({"src/nowiki/dd.ts"(){"use strict";ha(),mr=class extends xr{get type(){return"dd"}}}}),pa={};W(pa,{parseTable:()=>ca});var zi,Ls,ca,Dl=f({"parser/table.ts"(){"use strict";E(),zl(),Hl(),Ul(),da(),zi=e=>e.lastChild.constructor!==N,Ls=(e,t)=>e.is("td")?t.pop():e,ca=({firstChild:{data:e},type:t,name:s},r,i)=>{const n=[],a=e.split(`
