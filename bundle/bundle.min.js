...
`})}}});var jt,dt,rr,gt,Or=y(()=>{"use strict";B();L();R();it();gt=class extends k{constructor(e,t,r=f.getConfig(),n=[]){super(void 0,r,n);v(this,dt);T(this,"type","heading");v(this,jt);N(this,jt,e);let s=new k(t[0],r,n);s.type="heading-title",s.setAttribute("stage",2);let a=new ue(t[1],/^[^\S\n]*$/u,"heading-trail",r,n,{});this.append(s,a)}get level(){return h(this,jt)}toString(){let e=h(this,dt,rr);return e+this.firstChild.toString()+e+this.lastChild.toString()}text(){let e=h(this,dt,rr);return e+this.firstChild.text()+e}getAttribute(e){return e==="padding"?this.level:super.getAttribute(e)}getGaps(){return this.level}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t),{firstChild:n,level:s}=this,a=n.toString(),o=n.childNodes.filter(u=>u.type==="quote"),g=o.filter(({bold:u})=>u),p=o.filter(({italic:u})=>u),l;return this.level===1&&(l={start:e,...this.getRootNode().posFromIndex(e)},r.push($(n,l,"h1","<h1>"))),(a.startsWith("=")||a.endsWith("="))&&(l!=null||(l={start:e,...this.getRootNode().posFromIndex(e)}),r.push($(n,l,"unbalanced-header",f.msg("unbalanced $1 in a section header",'"="')))),this.closest("html-attrs, table-attrs")&&(l!=null||(l={start:e,...this.getRootNode().posFromIndex(e)}),r.push(I(this,l,"parsing-order","section header in a HTML tag"))),g.length%2&&(l!=null||(l={start:e,...this.getRootNode().posFromIndex(e)}),r.push($(g[g.length-1],{...l,start:e+s,left:l.left+s},"format-leakage",f.msg("unbalanced $1 in a section header","bold apostrophes")))),p.length%2&&(l!=null||(l={start:e,...this.getRootNode().posFromIndex(e)}),r.push($(p[p.length-1],{start:e+s},"format-leakage",f.msg("unbalanced $1 in a section header","italic apostrophes")))),r}print(){let e=h(this,dt,rr);return super.print({pre:e,sep:e})}json(){let e=super.json();return e.level=this.level,e}};jt=new WeakMap,dt=new WeakSet,rr=function(){return"=".repeat(this.level)}});var so,oo,nr,mi=y(()=>{"use strict";H();B();L();R();so=d=>d.text().replace(/^[ \t\n\0\v]+|([^ \t\n\0\v])[ \t\n\0\v]+$/gu,"$1"),oo=new RegExp(`https?://${ke}${ye}$`,"iu"),nr=class extends k{constructor(e,t,r=f.getConfig(),n=[]){super(void 0,r,n);T(this,"type","parameter");let s=new k(typeof e=="number"?void 0:e,r,n,{}),a=new k(t,r,n);s.type="parameter-key",a.type="parameter-value",a.setAttribute("stage",2),this.append(s,a)}get anon(){return this.firstChild.length===0}afterBuild(){if(!this.anon){let{parentNode:e,firstChild:t}=this,r=so(t);this.setAttribute("name",r),e&&e.getArgs(r,!1,!1).add(this)}}toString(){return this.anon?this.lastChild.toString():super.toString("=")}text(){return this.anon?this.lastChild.text():super.text("=")}getGaps(){return this.anon?0:1}lint(e=this.getAbsoluteIndex(),t){var a;let r=super.lint(e,t),{firstChild:n}=this,s=(a=oo.exec(n.text()))==null?void 0:a[0];if(s&&new URL(s).search){let o=$(n,{start:e},"unescaped","unescaped query string in an anonymous parameter");o.startIndex=o.endIndex,o.startLine=o.endLine,o.startCol=o.endCol,o.endIndex++,o.endCol++,o.fix={range:[o.startIndex,o.endIndex],text:"{{=}}"},r.push(o)}return r}print(){return super.print({sep:this.anon?"":"="})}json(){let e=super.json();return e.anon=this.anon,e}}});var ao,Ue,De,pt,fi,xi,Bt,Ti=y(()=>{"use strict";H();B();ve();be();L();R();mi();Ce();it();ao=new Set(["pageid","articlepath","server","servername","scriptpath","stylepath"]),Bt=class extends k{constructor(e,t,r=f.getConfig(),n=[]){var u,c;super(void 0,r,n,{});v(this,pt);T(this,"type","template");T(this,"modifier","");v(this,Ue,!1);v(this,De,new Map);let{parserFunction:[s,a]}=r,o=(u=/^(?:\s|\0\d+c\x7F)*\0\d+s\x7F/u.exec(e))==null?void 0:u[0];if(o)this.setAttribute("modifier",o),e=e.slice(o.length);else if(e.includes(":")){let[m,...x]=e.split(":"),[b]=/^(?:\s|\0\d+c\x7F)*/u.exec((c=x[0])!=null?c:"");this.setModifier(`${m}:${b}`)&&(e=x.join(":").slice(b.length))}let g=e.includes(":");if(g||t.length===0&&!h(this,Ue)){let[m,...x]=e.split(":"),b=le(m),S=b[x.length>0?"trimStart":"trim"](),w=S.toLowerCase(),C=s[w],A=a.includes(S);if(A||ao.has(C)||g&&C){this.setAttribute("name",C!=null?C:w),this.type="magic-word";let j=new RegExp(`^\\s*${S}\\s*$`,A?"u":"iu"),J=new ue(m,j,"magic-word-name",r,n,{});if(super.insertAt(J),x.length>0&&t.unshift([x.join(":")]),this.name==="invoke")for(let D=0;D<2;D++){let te=t.shift();if(!te)break;let X=new G(te.join("="),`invoke-${D?"function":"module"}`,r,n);super.insertAt(X)}}}if(this.type==="template"){let m=le(e).trim();if(!this.normalizeTitle(m,10,!0).valid)throw n.pop(),new SyntaxError("\u975E\u6CD5\u7684\u6A21\u677F\u540D\u79F0");let x=new G(e,"template-name",r,n,{});super.insertAt(x)}let p=this.isTemplate(),l=1;for(let m=0;m<t.length;m++){let x=t[m];!p&&!(this.name==="switch"&&m>0)&&(x[0]=x.join("="),x.length=1),x.length===1&&(x.unshift(l),l++),this.insertAt(new nr(...x,r,n))}this.seal("modifier")}setModifier(e){let{parserFunction:[,,t,r]}=this.getAttribute("config"),n=le(e).trim();if(e&&!n.endsWith(":"))return!1;let s=n.slice(0,-1).toLowerCase(),a=t.includes(s),o=r.includes(s);return h(this,Ue)&&a||!h(this,Ue)&&(o||e==="")||(Ie.running||this.length>1)&&(a||o||e==="")?(this.setAttribute("modifier",e),N(this,Ue,a),!!e):!1}isTemplate(){return this.type==="template"||this.name==="invoke"}afterBuild(){this.modifier.includes("\0")&&this.setAttribute("modifier",this.buildFromStr(this.modifier,0))}toString(){return`{{${this.modifier}${this.type==="magic-word"?`${this.firstChild.toString()}${this.length===1?"":":"}${this.childNodes.slice(1).map(String).join("|")}`:super.toString("|")}}}`}text(){let{childNodes:e,length:t,firstChild:r,modifier:n,type:s,name:a}=this;return s==="magic-word"&&a==="vardefine"?"":`{{${n}${s==="magic-word"?r.text()+(t===1?"":":")+de(e.slice(1),"|"):super.text("|")}}}`}getAttribute(e){switch(e){case"padding":return this.modifier.length+2;default:return super.getAttribute(e)}}getGaps(){return 1}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t),{type:n,childNodes:s,length:a}=this,o;if(!this.isTemplate())return r;let g=E(this,pt,fi).call(this);if(g.fragment!==void 0){o={start:e,...this.getRootNode().posFromIndex(e)};let l=s[n==="template"?0:1],u=$(l,o,"no-ignored","useless fragment"),c=l.childNodes.find(m=>m.type==="text"&&m.data.includes("#"));c&&(u.fix={range:[u.startIndex+c.getRelativeIndex()+c.data.indexOf("#"),u.endIndex],text:""}),r.push(u)}if(g.valid||(o!=null||(o={start:e,...this.getRootNode().posFromIndex(e)}),r.push($(s[1],o,"invalid-invoke","illegal module name"))),n==="magic-word"&&a===2)return o!=null||(o={start:e,...this.getRootNode().posFromIndex(e)}),r.push(I(this,o,"invalid-invoke","missing module function")),r;let p=this.getDuplicatedArgs().filter(([,l])=>!l[0].querySelector("ext"));return p.length>0&&(o!=null||(o={start:e,...this.getRootNode().posFromIndex(e)}),r.push(...p.flatMap(([,l])=>l).map(l=>$(l,o,"no-duplicate","duplicated parameter")))),r}insertAt(e,t=this.length){return super.insertAt(e,t),e.anon?E(this,pt,xi).call(this,e):e.name&&this.getArgs(e.name,!1,!1).add(e),e}getAllArgs(){return this.childNodes.filter(Ge("parameter"))}getAnonArgs(){return this.getAllArgs().filter(({anon:e})=>e)}getArgs(e,t,r=!0){let n=String(e).replace(/^[ \t\n\0\v]+|([^ \t\n\0\v])[ \t\n\0\v]+$/gu,"$1"),s;return h(this,De).has(n)?s=h(this,De).get(n):(s=new Set(this.getAllArgs().filter(({name:a})=>n===a)),h(this,De).set(n,s)),s}getDuplicatedArgs(){return[...h(this,De)].filter(([,{size:e}])=>e>1).map(([e,t])=>[e,[...t]])}getPossibleValues(){let{type:e,name:t,childNodes:r,constructor:{name:n}}=this;if(e==="template")throw new Error(`${n}.getPossibleValues \u65B9\u6CD5\u4EC5\u4F9B\u7279\u5B9A\u9B54\u672F\u5B57\u4F7F\u7528\uFF01`);let s;switch(t){case"if":case"ifexist":case"ifexpr":case"iferror":s=2;break;case"ifeq":s=3;break;default:throw new Error(`${n}.getPossibleValues \u65B9\u6CD5\u4EC5\u4F9B\u7279\u5B9A\u9B54\u672F\u5B57\u4F7F\u7528\uFF01`)}let a=r.slice(s,s+2).map(({childNodes:[,o]})=>o);for(let o=0;o<a.length;){let{length:g,0:p}=a[o].childNodes.filter(l=>l.text().trim());if(g===0)a.splice(o,1);else if(g>1||p.type!=="magic-word")o++;else try{let l=p.getPossibleValues();a.splice(o,1,...l),o+=l.length}catch(l){o++}}return a}print(){let{childNodes:e,length:t,firstChild:r,modifier:n,type:s}=this;return`<span class="wpb-${s}">{{${rt(n)}${s==="magic-word"?r.print()+(t===1?"":":")+we(e.slice(1),{sep:"|"}):we(e,{sep:"|"})}}}</span>`}};Ue=new WeakMap,De=new WeakMap,pt=new WeakSet,fi=function(){let e=this.type==="template",t=this.childNodes[e?0:1];return this.normalizeTitle(t.text(),e?10:828)},xi=function(e){let t=this.getAnonArgs(),r=typeof e!="number";for(let n=r?t.indexOf(e):e-1;n<t.length;n++){let s=t[n],{name:a}=s,o=String(n+1);a!==o&&(s.setAttribute("name",o),this.getArgs(o,!1,!1).add(s))}}});var bi,Mr,lo,He,ki=y(()=>{"use strict";Oe();R();bi=[pe(!0)];He=class extends(lo=k){constructor(){super(...arguments);T(this,"type","hidden")}};Mr=se(lo),He=ae(Mr,0,"HiddenToken",bi,He),oe(Mr,1,He)});var ir,yi=y(()=>{"use strict";H();B();L();R();Ce();ki();ir=class extends k{constructor(e,t=f.getConfig(),r=[]){super(void 0,t,r,{});T(this,"type","arg");for(let n=0;n<e.length;n++)if(n===0){let s=new G(e[n],"arg-name",t,r,{});super.insertAt(s)}else if(n>1){let s=new He(e[n],t,r);super.insertAt(s)}else{let s=new k(e[n],t,r);s.type="arg-default",s.setAttribute("stage",2),super.insertAt(s)}}get default(){var e,t;return(t=(e=this.childNodes[1])==null?void 0:e.text())!=null?t:!1}toString(){return`{{{${super.toString("|")}}}}`}text(){return`{{{${de(this.childNodes.slice(0,2),"|")}}}}`}getAttribute(e){return e==="padding"?3:super.getAttribute(e)}getGaps(){return 1}lint(e=this.getAbsoluteIndex(),t){let{childNodes:[r,n,...s]}=this;if(!this.getAttribute("include")){let o=I(this,{start:e},"no-arg","unexpected template argument");return n&&(o.fix={range:[e,o.endIndex],text:n.text()}),[o]}let a=r.lint(e+3,t);if(n&&a.push(...n.lint(e+4+r.toString().length,t)),s.length>0){let o={start:e,...this.getRootNode().posFromIndex(e)};a.push(...s.map(g=>{let p=$(g,o,"no-ignored","invisible content inside triple braces");return p.startIndex--,p.startCol--,p.suggestions=[{desc:"remove",range:[p.startIndex,p.endIndex],text:""},{desc:"escape",range:[p.startIndex,p.startIndex+1],text:"{{!}}"}],p}))}return a}print(){return super.print({pre:"{{{",post:"}}}",sep:"|"})}json(){let e=super.json();return e.default=this.default,e}}});var Ai={};W(Ai,{parseBraces:()=>zr});var go,sr,po,zr,Wr=y(()=>{"use strict";H();Or();Ti();yi();go={"=":`
`,"{":"\\}{2,}|\\|","-":"\\}-","[":"\\]\\]"},sr=new Map([["!","!"],["!!","+"],["(!","{"],["!)","}"],["!-","-"],["=","~"]]),po=new RegExp(`\\{\\{\\s*(${[...sr.keys()].map(Ht).join("|")})\\s*\\}\\}(?!\\})`,"gu"),zr=(d,i,e)=>{var p,l,u,c,m,x;let t=`${(p=i.excludes)!=null&&p.includes("heading")?"":"^(\0\\d+c\x7F)*={1,6}|"}\\[\\[|\\{{2,}|-\\{(?!\\{)`,{parserFunction:[,,,r]}=i,n=[];d=d.replace(po,(b,S)=>(new Bt(b.slice(2,-2),[],i,e),`\0${e.length-2}${sr.get(S)}\x7F`));let s=new RegExp(t,"gmu"),a=s.exec(d),o=d.includes("}}"),g;for(;a||g!==void 0&&g<=d.length&&((u=(l=n[n.length-1])==null?void 0:l[0])!=null&&u.startsWith("="));){if(a!=null&&a[1]){let[,{length:Q}]=a;a[0]=a[0].slice(Q),a.index+=Q}let{0:b,index:S}=a!=null?a:{0:`
`,index:d.length},w=(c=n.pop())!=null?c:{},{0:C,index:A,parts:F,findEqual:j,pos:J}=w,D=b==="="&&j,te=Q=>{F[F.length-1].push(Q.slice(J,S))};if(b==="]]"||b==="}-")g=S+2;else if(b===`
`){g=S+1;let{pos:Q,findEqual:ne}=(m=n[n.length-1])!=null?m:{};if(Q===void 0||ne||le(d.slice(Q,A))!==""){let Z=/^(={1,6})(.+)\1((?:\s|\0\d+c\x7F)*)$/u.exec(d.slice(A,S));Z&&(d=`${d.slice(0,A)}\0${e.length}h\x7F${d.slice(S)}`,g=A+4+String(e.length).length,new gt(Z[1].length,Z.slice(2),i,e))}}else if(b==="|"||D)g=S+1,te(d),b==="|"&&F.push([]),w.pos=g,w.findEqual=b==="|",n.push(w);else if(b.startsWith("}}")){let Q=b.slice(0,Math.min(C.length,3)),ne=C.length-Q.length,{length:Z}=e;g=S+Q.length,te(d);let P=!1,Te="t";if(Q.length===3){let U=F.map(Mt=>Mt.join("=")),Ke=U.length>1&&le(U[1]).trim();new ir(U,i,e),Ke&&Ke.endsWith(":")&&r.includes(Ke.slice(0,-1).toLowerCase())&&(Te="s")}else try{new Bt(F[0][0],F.slice(1),i,e);let U=le(F[0][0]).trim();sr.has(U)?Te=sr.get(U):/^(?:filepath|(?:full|canonical)urle?):.|^server$/iu.test(U)?Te="m":/^#vardefine:./iu.test(U)&&(Te="c")}catch(U){if(U instanceof SyntaxError&&U.message==="\u975E\u6CD5\u7684\u6A21\u677F\u540D\u79F0")P=!0;else throw U}P||(d=`${d.slice(0,A+ne)}\0${Z}${Te}\x7F${d.slice(g)}`,g=A+ne+3+String(Z).length,ne>1?n.push({0:C.slice(0,ne),index:A,pos:A+ne,parts:[[]]}):ne===1&&d[A-1]==="-"&&n.push({0:"-{",index:A-1,pos:A+1,parts:[[]]}))}else g=S+b.length,b.startsWith("{")&&(a.pos=g,a.parts=[[]]),n.push(..."0"in w?[w]:[],a);o&&(o=d.slice(g).includes("}}"));let X=n[n.length-1];!o&&((x=X==null?void 0:X[0])!=null&&x.startsWith("{"))&&(n.pop(),X=n[n.length-1]),s=new RegExp(t+(X?`|${go[X[0][0]]}${X.findEqual?"|=":""}`:""),"gmu"),s.lastIndex=g,a=s.exec(d)}return d}});var vi={};W(vi,{InputboxToken:()=>Ur});var Ur,wi=y(()=>{"use strict";Wr();L();Gr();Ur=class extends Pt{constructor(i,e=f.getConfig(),t=[]){let r=Symbol("InputboxToken"),{length:n}=t;t.push(r),i&&(i=zr(i,e,t)),t.splice(n,1),super(i,e,t,{})}}});var Ci,Dr,uo,Se,Hr=y(()=>{"use strict";B();Oe();L();Le();Ci=[pe()];Se=class extends(uo=ee){constructor(e,t=!0,r,n){super(e,r,n);T(this,"type","comment");T(this,"closed");this.closed=t}getAttribute(e){return e==="padding"?4:super.getAttribute(e)}lint(e=this.getAbsoluteIndex()){if(this.closed)return[];let t=I(this,{start:e},"unclosed-comment",f.msg("unclosed $1","HTML comment"));return t.fix={range:[t.endIndex,t.endIndex],text:"-->"},[t]}toString(){return`<!--${this.innerText}${this.closed?"-->":""}`}print(){return super.print({pre:"&lt;!--",post:this.closed?"--&gt;":""})}};Dr=se(uo),Se=ae(Dr,0,"CommentToken",Ci,Se),oe(Dr,1,Se)});var or={};W(or,{NestedToken:()=>Vr});var Vr,ar=y(()=>{"use strict";B();L();R();Xr();Re();Hr();Vr=class extends k{constructor(e,t,r,n=f.getConfig(),s=[]){e=e==null?void 0:e.replace(t,(a,o,g,p,l)=>{let u=`\0${s.length+1}${o?"e":"c"}\x7F`;if(o)new ut(o,g,p,l,n,s);else{let c=a.endsWith("-->");new Se(a.slice(4,c?-3:void 0),c,n,s)}return u}).replace(/(^|\0\d+[ce]\x7F)([^\0]+)(?=$|\0\d+[ce]\x7F)/gu,(a,o,g)=>(new z(g,n,s),`${o}\0${s.length}c\x7F`));super(e,n,s,{});T(this,"type","ext-inner")}lint(e=this.getAbsoluteIndex(),t){let r;return[...super.lint(e,t),...this.childNodes.filter(n=>{if(n.type==="ext"||n.type==="comment")return!1;let s=n.toString().trim();return s&&!/^<!--.*-->$/su.test(s)}).map(n=>{r!=null||(r={start:e,...this.getRootNode().posFromIndex(e)});let s=$(n,r,"no-ignored",f.msg("invalid content in <$1>",this.name));return s.suggestions=[{desc:"remove",range:[s.startIndex,s.endIndex],text:""},{desc:"comment",range:[s.startIndex,s.startIndex],text:`<!--${n.toString()}-->`}],s})]}}});function Si(d,i,e,t,r){i=i.trim();let n=i.replace(/\0\d+t\x7F/gu,"").trim();switch(d){case"width":return!n||/^(?:\d+x?|\d*x\d+)(?:\s*px)?$/u.test(n);case"link":{if(!n||new RegExp(`^(?:(?:${e.protocol}|//)${ke}|\0\\d+m\x7F)${ye}$`,"iu").test(n))return i;n.startsWith("[[")&&n.endsWith("]]")&&(n=n.slice(2,-2));let a=f.normalizeTitle(n,0,!1,e,t,!0,!0);return a.valid&&a}case"lang":return(r==="svg"||r==="svgz")&&!/[^a-z\d-]/u.test(n);case"alt":case"class":case"manualthumb":return!0;case"page":return(r==="djvu"||r==="djv"||r==="pdf")&&Number(n)>0;default:return!!n&&!isNaN(n)}}var co,re,dr,Ni,lr,$i=y(()=>{"use strict";H();B();L();R();co=new Set(["alt","link","lang","page","caption"]);lr=class extends k{constructor(e,t,r=f.getConfig(),n){var i=(...Sd)=>(super(...Sd),v(this,dr),T(this,"type","image-parameter"),v(this,re,""),this);var g;let s,a=Object.entries(r.img).map(([p,l])=>[p,l,new RegExp(`^(\\s*(?!\\s))${p.replace("$1","(.*)")}${p.endsWith("$1")?`(?=$|
)`:""}(\\s*)$`,"u")]),o=a.find(([,p,l])=>(s=l.exec(e),s&&(s.length!==4||Si(p,s[2],r,!0,t)!==!1)));if(o&&s){s.length===3?(i(void 0,r,n),N(this,re,e)):(i(s[2],r,n,{}),N(this,re,s[1]+o[0]+s[3])),this.setAttribute("name",o[1]);return}i(e,{...r,excludes:[...(g=r.excludes)!=null?g:[],"list"]},n),this.setAttribute("name","caption"),this.setAttribute("stage",7)}get link(){return this.name==="link"?Si("link",super.text(),this.getAttribute("config")):void 0}afterBuild(){var e;((e=this.parentNode)==null?void 0:e.type)==="gallery-image"&&!co.has(this.name)&&this.setAttribute("name","invalid")}toString(){return h(this,re)?h(this,re).replace("$1",super.toString()):super.toString()}text(){return h(this,re)?h(this,re).replace("$1",super.text()).trim():super.text().trim()}getAttribute(e){return e==="plain"?this.name==="caption":e==="padding"?Math.max(0,h(this,re).indexOf("$1")):super.getAttribute(e)}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t),{link:n,name:s}=this;if(s==="invalid"){let a=I(this,{start:e},"invalid-gallery","invalid gallery image parameter");a.fix={range:[e,e+a.endIndex],text:""},r.push(a)}else typeof n=="object"&&n.encoded&&r.push(I(this,{start:e},"url-encoding","unnecessary URL encoding in an internal link"));return r}getValue(){return this.name==="invalid"?this.text():E(this,dr,Ni).call(this)||super.text()}print(){return h(this,re)?`<span class="wpb-image-parameter">${h(this,re).replace("$1",`<span class="wpb-image-caption">${we(this.childNodes)}</span>`)}</span>`:super.print({class:"image-caption"})}};re=new WeakMap,dr=new WeakSet,Ni=function(){return h(this,re)&&!h(this,re).includes("$1")}});var Qr,Zr,Kr,ho,ct,gr,ht,Jr=y(()=>{"use strict";H();B();L();Lt();$i();Qr=new Set(["manualthumb","frameless","framed","thumbnail"]),Zr=new Set(["left","right","center","none"]),Kr=new Set(["baseline","sub","super","top","text-top","middle","bottom","text-bottom"]),ho=(d,i,e,t)=>{if(t===void 0)return[];let r=new RegExp(`${[d,i,e].map(Ht).join("|")}`,"gu"),n=[],s=r.exec(t),a=0,o=0;for(;s;){let{0:g,index:p}=s;g!==e?a+=g===d?1:-1:a===0&&(n.push(t.slice(o,p)),{lastIndex:o}=r),s=r.exec(t)}return n.push(t.slice(o)),n},ht=class extends Ae{constructor(e,t,r=f.getConfig(),n=[],s="|"){super(e,void 0,r,n,s);v(this,ct);T(this,"type","file");let{extension:a}=this.getTitle(!0);this.append(...ho("-{","}-","|",t).map(o=>new lr(o,a,r,n)))}get extension(){return this.getTitle().extension}lint(e=this.getAbsoluteIndex(),t){var u;let r=super.lint(e,t),n=this.getAllArgs().filter(({childNodes:c})=>{let m=c.filter(x=>x.text().trim());return m.length!==1||m[0].type!=="arg"}),s=[...new Set(n.map(({name:c})=>c))].filter(c=>c!=="invalid"),a=s.filter(c=>Qr.has(c)),o=s.filter(c=>Zr.has(c)),g=s.filter(c=>Kr.has(c));if(this.closest("ext-link-text")&&((u=this.getValue("link"))==null?void 0:u.trim())!==""&&r.push(I(this,{start:e},"nested-link","internal link in an external link")),n.length===s.length&&a.length<2&&o.length<2&&g.length<2)return r;let p={start:e,...this.getRootNode().posFromIndex(e)},l=(c,m)=>x=>$(x,p,"no-duplicate",f.msg(`${c} image $1 parameter`,m));for(let c of s){let m=n.filter(({name:x})=>x===c);c==="caption"&&(m=[...m.slice(0,-1).filter(x=>x.text()),...m.slice(-1)]),m.length>1&&r.push(...m.map(l("duplicated",c)))}return a.length>1&&r.push(...n.filter(({name:c})=>Qr.has(c)).map(l("conflicting","frame"))),o.length>1&&r.push(...n.filter(({name:c})=>Zr.has(c)).map(l("conflicting","horizontal-alignment"))),g.length>1&&r.push(...n.filter(({name:c})=>Kr.has(c)).map(l("conflicting","vertical-alignment"))),r}getAllArgs(){return this.childNodes.slice(1)}getArgs(e){return this.getAllArgs().filter(({name:t})=>e===t)}getFrameArgs(){return E(this,ct,gr).call(this,Qr,"\u6846\u67B6")}getHorizAlignArgs(){return E(this,ct,gr).call(this,Zr,"\u6C34\u5E73\u5BF9\u9F50")}getVertAlignArgs(){return E(this,ct,gr).call(this,Kr,"\u5782\u76F4\u5BF9\u9F50")}getArg(e){let t=this.getArgs(e);return t[t.length-1]}getValue(e){var t;return(t=this.getArg(e))==null?void 0:t.getValue()}};ct=new WeakSet,gr=function(e,t){return this.getAllArgs().filter(({name:n})=>e.has(n))}});var pr,Ei,mt,Yr=y(()=>{"use strict";B();be();L();R();Jr();mt=class extends ht{constructor(e,t,r,n=f.getConfig(),s=[]){let a;if(r!==void 0){let{length:o}=s;a=new k(r,n,s);for(let g=1;g<11;g++)a.parseOnce();s.splice(o,1)}super(t,a==null?void 0:a.toString(),n,s);v(this,pr);this.setAttribute("bracket",!1),this.type=`${e}-image`}getTitle(){let e=this.type==="imagemap-image";return this.normalizeTitle(this.firstChild.toString(),e?0:6,!0,!e)}getAttribute(e){return e==="padding"?0:super.getAttribute(e)}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t),{ns:n,interwiki:s}=this.getAttribute("title");return(s||n!==6)&&r.push(I(this,{start:e},"invalid-gallery","invalid gallery image")),r}afterBuild(){E(this,pr,Ei).call(this,this.getTitle())}};pr=new WeakSet,Ei=function(e){this.setAttribute("title",e)}});var Fi={};W(Fi,{GalleryToken:()=>en});var ur,Ii,en,Li=y(()=>{"use strict";L();R();Yr();Re();en=class extends k{constructor(e,t=f.getConfig(),r=[]){var n;super(void 0,t,r,{});v(this,ur);T(this,"type","ext-inner");for(let s of(n=e==null?void 0:e.split(`
`))!=null?n:[]){let a=/^([^|]+)(?:\|(.*))?/u.exec(s);if(!a){super.insertAt(s.trim()?new z(s,t):s);continue}let[,o,g]=a;E(this,ur,Ii).call(this,o)?super.insertAt(new mt("gallery",o,g,t,r)):super.insertAt(new z(s,t))}}toString(){return super.toString(`
`)}text(){return super.text(`
`).replace(/\n\s*\n/gu,`
...
`})}};ur=new WeakSet,Ii=function(e){return this.normalizeTitle(e,6,!0,!0).valid}});var ft,tn=y(()=>{"use strict";B();Lt();ft=class extends Ae{constructor(){super(...arguments);T(this,"type","link")}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t);return this.closest("ext-link-text")&&r.push(I(this,{start:e},"nested-link","internal link in an external link")),r}}});var mo,fo,Ne,cr=y(()=>{"use strict";B();H();L();R();mo="(?:[\\p{Zs}	]|&nbsp;|&#0*160;|&#[xX]0*[aA]0;)",fo=new RegExp(`${mo}+`,"gu"),Ne=class extends k{get link(){let i={"!":"|","=":"="},e=de(this.childNodes.map(t=>{let{type:r,name:n}=t;return r==="magic-word"&&String(n)in i?i[n]:t}));return this.type==="magic-link"&&(e=e.replace(fo," "),e.startsWith("ISBN")&&(e=`ISBN ${e.slice(5).replace(/[- ]/gu,"").replace(/x$/u,"X")}`)),e}constructor(i,e="free-ext-link",t=f.getConfig(),r){super(i,t,r,{}),this.type=e}lint(i=this.getAbsoluteIndex(),e){let t=super.lint(i,e),r;if(this.type==="magic-link"){let{link:o}=this;if(o.startsWith("ISBN")){let g=[...o.slice(5)].map(p=>p==="X"?10:Number(p));(g.length===10&&g.reduce((p,l,u)=>p+l*(10-u),0)%11||g.length===13&&(g[12]===10||g.reduce((p,l,u)=>p+l*(u%2?3:1),0)%10))&&(r={start:i,...this.getRootNode().posFromIndex(i)},t.push(I(this,r,"invalid-isbn","invalid ISBN")))}return t}let n=`[\uFF0C\uFF1B\u3002\uFF1A\uFF01\uFF1F\uFF08\uFF09]+${this.type==="ext-link-url"?"|\\|+":""}`,s=new RegExp(n,"u"),a=new RegExp(n,"gu");for(let o of this.childNodes){let{type:g,data:p}=o;if(g!=="text"||!s.test(p))continue;r!=null||(r={start:i,...this.getRootNode().posFromIndex(i)});let l=$(o,r,"unterminated-url","","warning");a.lastIndex=0;for(let u=a.exec(p);u;u=a.exec(p)){let{index:c,0:m}=u,x=p.slice(0,c).split(`
`),b=x.length,S=x[b-1].length,w=l.startIndex+c,C=l.startLine+b-1,A=b===1?l.startCol+S:S,F=m.startsWith("|"),j={...l,message:f.msg("$1 in URL",F?'"|"':"full-width punctuation"),startIndex:w,endIndex:w+m.length,startLine:C,endLine:C,startCol:A,endCol:A+m.length};F?m.length===1&&(j.suggestions=[{desc:"whitespace",range:[w,w+1],text:" "}]):j.suggestions=[{desc:"whitespace",range:[w,w],text:" "},{desc:"escape",range:[w,j.endIndex],text:encodeURI(m)}],t.push(j)}}return t}}});var $e,xt,rn=y(()=>{"use strict";be();B();L();R();cr();xt=class extends k{constructor(e,t="",r="",n=f.getConfig(),s=[]){super(void 0,n,s,{});T(this,"type","ext-link");v(this,$e);let a=e&&/\0\d+f\x7F/u.test(e)?s[Number(e.slice(1,-2))]:new Ne(e,"ext-link-url",n,s);if(this.insertAt(a),N(this,$e,t),r){let o=new k(r,n,s,{});o.type="ext-link-text",o.setAttribute("stage",10),this.insertAt(o)}}toString(){return this.length===1?`[${super.toString()}${h(this,$e)}]`:`[${super.toString(h(this,$e))}]`}text(){return`[${super.text(" ")}]`}getAttribute(e){return e==="padding"?1:super.getAttribute(e)}getGaps(){return h(this,$e).length}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t);return this.length===1&&this.closest("heading-title")&&r.push(I(this,{start:e},"var-anchor","variable anchor in a section header")),r}print(){return super.print(this.length===1?{pre:"[",post:`${h(this,$e)}]`}:{pre:"[",sep:h(this,$e),post:"]"})}};$e=new WeakMap});var qt,Ri=y(()=>{"use strict";L();R();Re();tn();rn();qt=class extends k{constructor(e,t,r,n=f.getConfig(),s=[]){super(void 0,n,s);T(this,"type","imagemap-link");this.append(e,t.length===2?new ft(...t,n,s):new xt(...t,n,s),new z(r,n,s))}}});var Pi={};W(Pi,{ImagemapToken:()=>nn});var nn,ji=y(()=>{"use strict";B();ve();L();R();Re();Yr();Ri();nn=class extends k{constructor(e,t=f.getConfig(),r=[]){super(void 0,t,r,{});T(this,"type","ext-inner");if(!e)return;let n=e.split(`
...
${l}`,o),n.push(o);continue}let[,b,S,w,C]=x;if(b){for(;o.type!=="table";)o=n.pop();o.close(`
${u}${b}`,!0),g(C,n[n.length-1])}else if(S){o=p(),o.type==="tr"&&(o=n.pop());let A=new fr(`
${u}${S}`,C,t,r);n.push(o,A),o.insertAt(A)}else{o=p();let A=w==="!"?/!!|(?:\||\0\d+!\x7F){2}|\0\d+\+\x7F/gu:/(?:\||\0\d+!\x7F){2}|\0\d+\+\x7F/gu,F=A.exec(C),j=0,J=`
${u}${w}`,D=te=>{let X=new Ve(J,C.slice(j,F==null?void 0:F.index),t,r);return te.insertAt(X),X};for(;F;)D(o),{lastIndex:j}=A,[J]=F,F=A.exec(C);n.push(o,D(o))}}return a.slice(1)}});var xr,Ki=y(()=>{"use strict";Le();xr=class extends ee{constructor(){super(...arguments);T(this,"type","hr")}}});var Ji,cn,So,Xe,Yi=y(()=>{"use strict";Oe();Le();Ji=[pe(!0)];Xe=class extends(So=ee){constructor(e,t,r,n){super(e,r,n);T(this,"type","double-underscore")}getAttribute(e){return e==="padding"?2:super.getAttribute(e)}toString(){return`__${this.innerText}__`}print(){return super.print({pre:"__",post:"__"})}};cn=se(So),Xe=ae(cn,0,"DoubleUnderscoreToken",Ji,Xe),oe(cn,1,Xe)});var es={};W(es,{parseHrAndDoubleUnderscore:()=>No});var No,ts=y(()=>{"use strict";Ki();Yi();Or();No=({firstChild:{data:d},type:i,name:e},t,r)=>{let{doubleUnderscore:n}=t,s=new Set(n[0]),a=new Set(n[1]);return i!=="root"&&(i!=="ext-inner"||e!=="poem")&&(d=`\0${d}`),d=d.replace(/^((?:\0\d+c\x7F)*)(-{4,})/gmu,(o,g,p)=>(new xr(p,t,r),`${g}\0${r.length-1}r\x7F`)).replace(new RegExp(`__(${[...n[0],...n[1]].join("|")})__`,"giu"),(o,g)=>{let p=a.has(g);return p||s.has(g.toLowerCase())?(new Xe(g,p,t,r),`\0${r.length-1}u\x7F`):o}).replace(/^((?:\0\d+c\x7F)*)(={1,6})(.+)\2((?:[^\S\n]|\0\d+c\x7F)*)$/gmu,(o,g,p,l,u)=>{let c=`${g}\0${r.length}h\x7F`;return new gt(p.length,[l,u],t,r),c}),i==="root"||i==="ext-inner"&&e==="poem"?d:d.slice(1)}});var Tr,rs=y(()=>{"use strict";B();L();Le();Tr=class extends ee{constructor(){super(...arguments);T(this,"type","quote")}get bold(){return this.innerText.length!==2}get italic(){return this.innerText.length!==3}lint(e=this.getAbsoluteIndex()){let{previousSibling:t,nextSibling:r,bold:n}=this,s=f.msg('lonely "$1"',"'"),a=[],o;if((t==null?void 0:t.type)==="text"&&t.data.endsWith("'")){o=I(this,{start:e},"lonely-apos",s);let{startIndex:g,startLine:p,startCol:l}=o,[,{length:u}]=/(?:^|[^'])('+)$/u.exec(t.data),c=e-u;a.push({...o,startIndex:c,endIndex:g,startCol:l-u,endLine:p,endCol:l,suggestions:[{desc:"escape",range:[c,g],text:"&apos;".repeat(u)}]})}if((r==null?void 0:r.type)==="text"&&r.data.startsWith("'")){o!=null||(o=I(this,{start:e},"lonely-apos",s));let{endIndex:g,endLine:p,endCol:l}=o,[{length:u}]=/^'+/u.exec(r.data),c=g+u;a.push({...o,startIndex:g,endIndex:c,startLine:p,startCol:l,endCol:l+u,suggestions:[{desc:"escape",range:[g,c],text:"&apos;".repeat(u)}]})}return n&&this.closest("heading-title")&&(o!=null||(o=I(this,{start:e},"lonely-apos",s)),a.push({...o,rule:"bold-header",message:f.msg("bold in section header"),severity:"warning"})),a}json(){let e=super.json();return Object.assign(e,{bold:this.bold,italic:this.italic}),e}}});var ns={};W(ns,{parseQuotes:()=>hn});var hn,mn=y(()=>{"use strict";rs();hn=(d,i,e)=>{var p;let t=d.split(/('{2,})/u),{length:r}=t;if(r===1)return d;let n=0,s=0,a,o,g;for(let l=1;l<r;l+=2){let u=t[l].length;switch(u){case 2:s++;break;case 4:t[l-1]+="'",t[l]="'''";case 3:if(n++,a!==void 0)break;t[l-1].endsWith(" ")?o===void 0&&g===void 0&&(g=l):t[l-1].slice(-2,-1)===" "?a=l:o!=null||(o=l);break;default:t[l-1]+="'".repeat(u-5),t[l]="'''''",s++,n++}}if(s%2===1&&n%2===1){let l=(p=a!=null?a:o)!=null?p:g;l!==void 0&&(t[l]="''",t[l-1]+="'")}for(let l=1;l<r;l+=2)new Tr(t[l],i,e),t[l]=`\0${e.length-1}q\x7F`;return t.join("")}});var is={};W(is,{parseExternalLinks:()=>fn});var fn,xn=y(()=>{"use strict";H();rn();cr();fn=(d,i,e,t)=>{let r=new RegExp(`\\[(${`\0\\d+f\x7F|(?:(?:${i.protocol}|//)${ke}|\0\\d+m\x7F)${ye}(?=[[\\]<>"	\\p{Zs}]|\0\\d)`})(\\p{Zs}*(?!\\p{Zs}))([^\\]-\b
-\uFFFD]*)\\]`,"giu");return d.replace(r,(n,s,a,o)=>{let{length:g}=e,p=/&[lg]t;/u.exec(s);return p&&(s=s.slice(0,p.index),a="",o=s.slice(p.index)+a+o),t?(new Ne(s,"ext-link-url",i,e),`[\0${g}f\x7F${a}${o}]`):(new xt(s,a,o,i,e),`\0${g}w\x7F`)})}});var br,ss=y(()=>{"use strict";Lt();br=class extends Ae{constructor(){super(...arguments);T(this,"type","category")}}});var as={};W(as,{parseLinks:()=>os});var os,ls=y(()=>{"use strict";L();mn();xn();tn();Jr();ss();os=(d,i,e)=>{let t=i.inExt?/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(?:(\||\0\d+!\x7F)(.*?[^\]]))?\]\](.*)$/su:/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(?:(\||\0\d+!\x7F)(.*?[^\]])?)?\]\](.*)$/su,r=/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(\||\0\d+!\x7F)(.*)$/su,n=new RegExp(`^\\s*(?:${i.protocol}|//)`,"iu"),s=d.split("[["),a=s.shift();for(let o=0;o<s.length;o++){let g=!1,p,l,u,c,m=s[o],x=t.exec(m);if(x)[,p,l,u,c]=x,c.startsWith("]")&&(u!=null&&u.includes("["))&&(u+="]",c=c.slice(1));else{let j=r.exec(m);j&&(g=!0,[,p,l,u]=j)}if(p===void 0||n.test(p)||/\0\d+[exhbru]\x7F/u.test(p)){a+=`[[${m}`;continue}let b=p.trim().startsWith(":");if(b&&g){a+=`[[${m}`;continue}let S=f.normalizeTitle(p,0,!1,i,!0,!0,!0),{ns:w,valid:C,interwiki:A}=S;if(C){if(g){if(A||w!==6){a+=`[[${m}`;continue}let j=!1;for(o++;o<s.length;o++){let J=s[o],D=J.split("]]");if(D.length>2){j=!0,u+=`[[${D[0]}]]${D[1]}`,c=D.slice(2).join("]]");break}else if(D.length===2)u+=`[[${D[0]}]]${D[1]}`;else{u+=`[[${J}`;break}}if(u=os(u,i,e),!j){a+=`[[${p}${l}${u}`;continue}}}else{a+=`[[${m}`;continue}u&&(u=hn(u,i,e));let F=ft;b||(!A&&w===6?(u&&(u=fn(u,i,e,!0)),F=ht):!A&&w===14&&(F=br)),u===void 0&&l&&(u=""),a+=`\0${e.length}l\x7F${c}`,new F(p,u,i,e,l)}return a}});var ds={};W(ds,{parseMagicLinks:()=>Io});var $o,Eo,Io,gs=y(()=>{"use strict";H();cr();$o=/[^,;\\.:!?)][,;\\.:!?)]+$/u,Eo=/[^,;\\.:!?][,;\\.:!?]+$/u,Io=(d,i,e)=>{let t="[\\p{Zs}	]|&nbsp;|&#0*160;|&#x0*a0;",r=`(?:${t}|-)`,n=new RegExp(`(^|[^\\p{L}\\d_])(?:(?:${i.protocol})(${ke}${ye})|(?:RFC|PMID)(?:${t})+\\d+\\b|ISBN(?:${t})+(?:97[89]${r}?)?(?:\\d${r}?){9}[\\dx]\\b)`,"giu");return d.replace(n,(s,a,o)=>{let g=a?s.slice(a.length):s;if(o){let p="",l=/&(?:lt|gt|nbsp|#x0*(?:3[ce]|a0)|#0*(?:6[02]|160));/iu.exec(g);l&&(p=g.slice(l.index),g=g.slice(0,l.index));let u=g.includes("(")?Eo:$o,c=u.exec(g);if(c){let m=1;c[0][1]===";"&&/&(?:[a-z]+|#x[\da-f]+|#\d+)$/iu.test(g.slice(0,c.index))&&(m=2),p=g.slice(c.index+m)+p,g=g.slice(0,c.index+m)}return p.length>=o.length?s:(new Ne(g,void 0,i,e),`${a}\0${e.length-1}w\x7F${p}`)}else if(!/^(?:RFC|PMID|ISBN)/u.test(g))return s;return new Ne(g,"magic-link",i,e),`${a}\0${e.length-1}i\x7F`})}});var kr,ps=y(()=>{"use strict";pn();kr=class extends yt{constructor(){super(...arguments);T(this,"type","list")}}});var us={};W(us,{parseList:()=>Fo});var Fo,cs=y(()=>{"use strict";ps();un();Fo=(d,i,e)=>{let t=/^((?:\0\d+c\x7F)*)([;:*#]+)/u.exec(d);if(!t)return d;let[r,n,s]=t,a=`${n}\0${e.length}d\x7F${d.slice(r.length)}`,o=s.split(";").length-1;if(new kr(s,i,e),!o)return a;let{html:[g]}=i,p=/:+|-\{|\0\d+[xq]\x7F/gu,l=p,u=l.exec(a),c=0,m=!1,x=!1,b=0,S=(C,A)=>(new At(C,i,e),`${a.slice(0,A)}\0${e.length-1}d\x7F${a.slice(A+C.length)}`),w=C=>{C?c&&c--:c++};for(;u&&o;){let{0:C,index:A}=u;if(C==="-{"){if(!b){let{lastIndex:F}=l;l=/-\{|\}-/gu,l.lastIndex=F}b++}else if(C==="}-"){if(b--,!b){let{lastIndex:F}=l;l=p,l.lastIndex=F}}else if(C.endsWith("x\x7F")){let{name:F,closing:j,selfClosing:J}=e[Number(C.slice(1,-2))];(!J||g.includes(F))&&w(j)}else if(C.endsWith("q\x7F")){let{bold:F,italic:j}=e[Number(C.slice(1,-2))];F&&(w(m),m=!m),j&&(w(x),x=!x)}else if(c===0){if(C.length>=o)return S(C.slice(0,o),A);o-=C.length,l.lastIndex=A+4+String(e.length).length,a=S(C,A)}u=l.exec(a)}return a}});var hs,Ee,yr,ms=y(()=>{"use strict";B();L();R();Ce();hs=new Set(["A","T","R","D","-","H","N"]),yr=class extends k{constructor(e,t=f.getConfig(),r=[]){super(void 0,t,r,{});T(this,"type","converter-flags");v(this,Ee);this.append(...e.map(n=>new G(n,"converter-flag",t,r)))}afterBuild(){N(this,Ee,this.childNodes.map(e=>e.text().trim()))}toString(){return super.toString(";")}text(){return super.text(";")}getGaps(){return 1}getUnknownFlags(){return new Set(h(this,Ee).filter(e=>/\{{3}[^{}]+\}{3}/u.test(e)))}getVariantFlags(){let e=new Set(this.getAttribute("config").variants);return new Set(h(this,Ee).filter(t=>e.has(t)))}lint(e=this.getAbsoluteIndex(),t){let r=this.getVariantFlags(),n=this.getUnknownFlags(),s=new Set(h(this,Ee).filter(c=>hs.has(c))),a=h(this,Ee).filter(c=>!c).length,o=h(this,Ee).length-n.size-a,g=super.lint(e,t);if(r.size===o||s.size===o)return g;let p={start:e,...this.getRootNode().posFromIndex(e)},{childNodes:l,length:u}=this;for(let c=0;c<u;c++){let m=l[c],x=m.text().trim();if(x&&!r.has(x)&&!n.has(x)&&(r.size>0||!s.has(x))){let b=$(m,p,"no-ignored","invalid conversion flag");r.size===0&&hs.has(x.toUpperCase())?b.fix={range:[b.startIndex,b.endIndex],text:x.toUpperCase()}:b.suggestions=[{desc:"remove",range:[b.startIndex,b.endIndex],text:""}],g.push(b)}}return g}print(){return super.print({sep:";"})}};Ee=new WeakMap});var vt,fs=y(()=>{"use strict";L();R();Ce();vt=class extends k{constructor(e,t=!0,r=f.getConfig(),n=[]){super(void 0,r,n);T(this,"type","converter-rule");let s=e.indexOf(":"),a=e.slice(0,s).indexOf("=>"),o=a===-1?e.slice(0,s):e.slice(a+2,s);t&&r.variants.includes(o.trim())?(super.insertAt(new G(o,"converter-rule-variant",r,n)),super.insertAt(new G(e.slice(s+1),"converter-rule-to",r,n)),a!==-1&&super.insertAt(new G(e.slice(0,a),"converter-rule-from",r,n),0)):super.insertAt(new G(e,"converter-rule-to",r,n))}toString(){let{childNodes:e}=this;if(e.length===3){let[t,r,n]=e;return`${t.toString()}=>${r.toString()}:${n.toString()}`}return super.toString(":")}text(){let{childNodes:e}=this;if(e.length===3){let[t,r,n]=e;return`${t.text()}=>${r.text()}:${n.text()}`}return super.text(":")}getGaps(e){return e===0&&this.length===3?2:1}print(){let{childNodes:e}=this;if(e.length===3){let[t,r,n]=e;return`<span class="wpb-converter-rule">${t.print()}=>${r.print()}:${n.print()}</span>`}return super.print({sep:":"})}}});var Ar,xs=y(()=>{"use strict";H();L();R();ms();fs();Ar=class extends k{constructor(e,t,r=f.getConfig(),n=[]){super(void 0,r,n);T(this,"type","converter");this.append(new yr(e,r,n));let[s]=t,a=s.includes(":"),o=new vt(s,a,r,n);a&&o.length===1?this.insertAt(new vt(t.join(";"),!1,r,n)):this.append(o,...t.slice(1).map(g=>new vt(g,!0,r,n)))}toString(){let{childNodes:[e,...t]}=this;return`-{${e.toString()}${e.length>0?"|":""}${t.map(String).join(";")}}-`}text(){let{childNodes:[e,...t]}=this;return`-{${e.text()}|${de(t,";")}}-`}getAttribute(e){return e==="padding"?2:super.getAttribute(e)}getGaps(e){return e||this.firstChild.length>0?1:0}print(){let{childNodes:[e,...t]}=this;return`<span class="wpb-converter">-{${e.print()}${e.length>0?"|":""}${we(t,{sep:";"})}}-</span>`}}});var Ts={};W(Ts,{parseConverter:()=>Lo});var Lo,bs=y(()=>{"use strict";xs();Lo=(d,i,e)=>{let t=`(?:${i.variants.join("|")})`,r=/-\{/gu,n=/-\{|\}-/gu,s=new RegExp(`;(?=(?:[^;]*?=>)?\\s*${t}\\s*:|(?:\\s|\0\\d+c\x7F)*$)`,"u"),a=[],o=r,g=o.exec(d);for(;g;){let{0:p,index:l}=g;if(p==="}-"){let u=a.pop(),{length:c}=e,m=d.slice(u.index+2,l),x=m.indexOf("|"),[b,S]=x===-1?[[],m]:[m.slice(0,x).split(";"),m.slice(x+1)],w=S.replace(/(&[#a-z\d]+);/giu,"$1"),C=w.split(s).map(A=>A.replace(/\x01/gu,";"));new Ar(b,C,i,e),d=`${d.slice(0,u.index)}\0${c}v\x7F${d.slice(l+2)}`,a.length===0&&(o=r),o.lastIndex=u.index+3+String(c).length}else a.push(g),o=n,o.lastIndex=l+2;g=o.exec(d)}return d}});var bn={};W(bn,{Token:()=>k});var fe,_,M,Qe,Gt,Ot,q,Tn,ks,ys,As,vs,ws,Cs,Ss,Ns,$s,Es,Is,Fs,kn,k,R=y(()=>{"use strict";H();be();B();L();Un();Vn();kn=class kn extends Xt{constructor(e,t=f.getConfig(),r=[],n){super();v(this,q);T(this,"type","plain");v(this,fe,0);v(this,_);v(this,M);v(this,Qe);v(this,Gt,!1);v(this,Ot);typeof e=="string"&&this.insertAt(e),N(this,_,t),N(this,M,r),r.push(this)}parseOnce(e=h(this,fe),t=!1){if(e<h(this,fe)||!this.getAttribute("plain")||this.length===0)return this;if(h(this,fe)>=11)return this;switch(e){case 0:if(this.type==="root"){h(this,M).shift();let r=E(this,q,ks).call(this);t&&(t=!r)}N(this,Qe,t),E(this,q,ys).call(this,t);break;case 1:E(this,q,As).call(this);break;case 2:E(this,q,vs).call(this);break;case 3:E(this,q,ws).call(this);break;case 4:E(this,q,Cs).call(this);break;case 5:E(this,q,Ss).call(this);break;case 6:E(this,q,Ns).call(this);break;case 7:E(this,q,$s).call(this);break;case 8:E(this,q,Es).call(this);break;case 9:E(this,q,Is).call(this);break;case 10:E(this,q,Fs).call(this)}if(this.type==="root")for(let r of h(this,M))r.parseOnce(e,t);return Ut(this,fe)._++,this}buildFromStr(e,t){let r=e.split(/[\0\x7F]/u).map((n,s)=>{if(s%2===0)return new It(n);if(isNaN(n.slice(-1)))return h(this,M)[Number(n.slice(0,-1))];throw new Error(`\u89E3\u6790\u9519\u8BEF\uFF01\u672A\u6B63\u786E\u6807\u8BB0\u7684 Token\uFF1A${n}`)});return t===0?r.map(String).join(""):t===1?de(r):r}afterBuild(){if(this.type==="root")for(let e of h(this,M))e.afterBuild();N(this,Gt,!0)}parse(e=11,t){for(e=Math.min(e,11);h(this,fe)<e;)this.parseOnce(h(this,fe),t);return e&&(E(this,q,Tn).call(this),this.afterBuild()),this}getAttribute(e){var t;switch(e){case"plain":return this.constructor===kn;case"config":return h(this,_);case"include":return(t=h(this,Qe))!=null?t:!!h(this.getRootNode(),Qe);case"accum":return h(this,M);default:return super.getAttribute(e)}}setAttribute(e,t){switch(e){case"stage":h(this,fe)===0&&this.type==="root"&&h(this,M).shift(),N(this,fe,t);break;default:super.setAttribute(e,t)}}insertAt(e,t=this.length){let r=typeof e=="string"?new It(e):e;return super.insertAt(r,t),r.type==="root"&&(r.type="plain"),r}normalizeTitle(e,t=0,r,n,s){return f.normalizeTitle(e,t,h(this,Qe),h(this,_),r,n,s)}lint(e=this.getAbsoluteIndex(),t){var n;let r=super.lint(e,t);if(this.type==="root"){let s={};for(let c of this.querySelectorAll("category")){let m=s[c.name];m?m.add(c):s[c.name]=new Set([c])}for(let c of Object.values(s))c.size>1&&r.push(...[...c].map(m=>{let x=I(m,{start:m.getAbsoluteIndex()},"no-duplicate","duplicated category");return x.suggestions=[{desc:"remove",range:[x.startIndex,x.endIndex],text:""}],x}));let a=/<!--\s*lint-(disable(?:(?:-next)?-line)?|enable)(\s[\sa-z,-]*)?-->/gu,o=this.toString(),g=[],p=a.exec(o),l=0,u=0;for(;p;){let{1:c,index:m}=p,x=(n=p[2])==null?void 0:n.trim();u+=o.slice(l,m).split(`
`).length-1,l=m,g.push({line:u+(c==="disable-line"?0:1),from:c==="disable"?a.lastIndex:void 0,to:c==="enable"?a.lastIndex:void 0,rules:x?new Set(x.split(",").map(b=>b.trim())):void 0}),p=a.exec(o)}r=r.filter(({rule:c,startLine:m,startIndex:x})=>{let b={pos:0};for(let{line:S,from:w,to:C,rules:A}of g){if(S>m+1)break;if(A&&!A.has(c))continue;if(S===m&&w===void 0&&C===void 0)return!1;w<=x&&w>b.pos?(b.pos=w,b.type="from"):C<=x&&C>b.pos&&(b.pos=C,b.type="to")}return b.type!=="from"})}return r}toString(e){var r;let t=this.getRootNode();return t.type==="root"&&h(t,Gt)?((r=h(this,Ot))!=null||N(this,Ot,super.toString(e)),h(this,Ot)):super.toString(e)}};fe=new WeakMap,_=new WeakMap,M=new WeakMap,Qe=new WeakMap,Gt=new WeakMap,Ot=new WeakMap,q=new WeakSet,Tn=function(){var n;N(this,fe,11);let{length:e,firstChild:t}=this,r=String(t);if(e===1&&t.type==="text"&&r.includes("\0")&&(this.replaceChildren(...this.buildFromStr(r)),this.normalize(),this.type==="root"))for(let s of h(this,M))E(n=s,q,Tn).call(n)},ks=function(){let{parseRedirect:e}=(Yn(),O(Jn)),t=this.firstChild.toString(),r=e(t,h(this,_),h(this,M));return r&&this.setText(r),!!r},ys=function(e){let{parseCommentAndExt:t}=(Oi(),O(Gi));this.setText(t(this.firstChild.toString(),h(this,_),h(this,M),e))},As=function(){let{parseBraces:e}=(Wr(),O(Ai)),t=this.type==="root"?this.firstChild.toString():`\0${this.firstChild.toString()}`,r=e(t,h(this,_),h(this,M));this.setText(this.type==="root"?r:r.slice(1))},vs=function(){var t;if((t=h(this,_).excludes)!=null&&t.includes("html"))return;let{parseHtml:e}=(Wi(),O(zi));this.setText(e(this.firstChild.toString(),h(this,_),h(this,M)))},ws=function(){var t;if((t=h(this,_).excludes)!=null&&t.includes("table"))return;let{parseTable:e}=(Zi(),O(Qi));this.setText(e(this,h(this,_),h(this,M)))},Cs=function(){var t;if((t=h(this,_).excludes)!=null&&t.includes("hr"))return;let{parseHrAndDoubleUnderscore:e}=(ts(),O(es));this.setText(e(this,h(this,_),h(this,M)))},Ss=function(){let{parseLinks:e}=(ls(),O(as));this.setText(e(this.firstChild.toString(),h(this,_),h(this,M)))},Ns=function(){var r;if((r=h(this,_).excludes)!=null&&r.includes("quote"))return;let{parseQuotes:e}=(mn(),O(ns)),t=this.firstChild.toString().split(`
`);for(let n=0;n<t.length;n++)t[n]=e(t[n],h(this,_),h(this,M));this.setText(t.join(`
`))},$s=function(){var t;if((t=h(this,_).excludes)!=null&&t.includes("extLink"))return;let{parseExternalLinks:e}=(xn(),O(is));this.setText(e(this.firstChild.toString(),h(this,_),h(this,M)))},Es=function(){var t;if((t=h(this,_).excludes)!=null&&t.includes("magicLink"))return;let{parseMagicLinks:e}=(gs(),O(ds));this.setText(e(this.firstChild.toString(),h(this,_),h(this,M)))},Is=function(){var n;if((n=h(this,_).excludes)!=null&&n.includes("list"))return;let{parseList:e}=(cs(),O(us)),t=this.firstChild.toString().split(`
`),r=this.type==="root"||this.type==="ext-inner"&&this.name==="poem"?0:1;for(;r<t.length;r++)t[r]=e(t[r],h(this,_),h(this,M));this.setText(t.join(`
`))},Fs=function(){if(h(this,_).variants.length>0){let{parseConverter:e}=(bs(),O(Ts));this.setText(e(this.firstChild.toString(),h(this,_),h(this,M)))}};k=kn});var Ze,Ls,Ro,f,L=y(()=>{In();ve();be();H();Ze={i18n:void 0,rules:En,getConfig(){return{...Rn,...this.config,excludes:[]}},msg(d,i=""){var e,t;return d&&((t=(e=this.i18n)==null?void 0:e[d])!=null?t:d).replace("$1",this.msg(i))},normalizeTitle(d,i=0,e,t=Ze.getConfig(),r,n=!1,s=!1){let{Title:a}=(On(),O(Gn));if(r)return new a(d,i,t,n,s);let{Token:o}=(R(),O(bn)),g=Ie.run(()=>{let l=new o(d,t);return l.type="root",l.parseOnce(0,e).parseOnce()}),p=new a(g.toString(),i,t,n,s);return Ie.run(()=>{for(let l of["main","fragment"]){let u=p[l];u!=null&&u.includes("\0")&&(p[l]=g.buildFromStr(u,1))}}),p},parse(d,i,e=11,t=Ze.getConfig()){d=jn(d);let{Token:r}=(R(),O(bn));return Ie.run(()=>{let s=new r(d,t);return s.type="root",s.parse(e,i)})}},Ls={},Ro=new Set(["normalizeTitle","parse"]);for(let d in Ze)Ro.has(d)||(Ls[d]={enumerable:!1});Object.defineProperties(Ze,Ls);typeof self=="object"?Object.assign(self,{Parser:Ze}):typeof globalThis=="object"&&Object.assign(globalThis,{Parser:Ze});f=Ze});L();})();
