...
${d}${C}`;const P=m=>{const A=new tr(L,b.slice(I,w==null?void 0:w.index),r,i);return m.insertAt(A),A};for(;w;)P(l),{lastIndex:I}=T,[L]=w,w=T.exec(b);n.push(l,P(l))}}return o.slice(1)}}}),oe,Zl=f({"../cm-util/dist/index.mjs"(){"use strict";oe=t=>!/^＿{2}.+＿{2}$/u.test(t)}}),Aa,to=f({"src/nowiki/hr.ts"(){"use strict";$t(),Aa=class extends et{get type(){return"hr"}}}}),Vi,Bs,Qi,ue,eo=f({"src/nowiki/doubleUnderscore.ts"(){"use strict";var t,e;Tt(),dt(),$t(),Vi=[xt(),lt("__")],ue=(e=class extends(Qi=et){constructor(r,i,n,a,o){var d,x;super(r,a,o);k(this,t);const l=r.toLowerCase(),{doubleUnderscore:[,,h,u]}=a;this.setAttribute("name",(x=i?(d=u==null?void 0:u[r])==null?void 0:d.toLowerCase():h==null?void 0:h[l])!=null?x:l),$(this,t,n)}get type(){return"double-underscore"}toString(){const r=c(this,t)?"＿＿":"__";return r+this.innerText+r}print(){{const r=c(this,t)?"＿＿":"__";return super.print({pre:r,post:r})}}},t=new WeakMap,e),Bs=W(Qi),ue=j(Bs,0,"DoubleUnderscoreToken",Vi,ue),R(Bs,1,ue)}}),ya={};M(ya,{parseHrAndDoubleUnderscore:()=>Ta});var Ta,so=f({"parser/hrAndDoubleUnderscore.ts"(){"use strict";Zl(),to(),eo(),En(),Ta=({firstChild:{data:t},type:e,name:s},r,i)=>{var h,u,d;const{doubleUnderscore:[n,a,o]}=r,l=[...n,...a];return(h=r.insensitiveDoubleUnderscore)!=null||(r.insensitiveDoubleUnderscore=new Set(n.filter(oe))),(u=r.sensitiveDoubleUnderscore)!=null||(r.sensitiveDoubleUnderscore=new Set(a.filter(oe))),(d=r.regexHrAndDoubleUnderscore)!=null||(r.regexHrAndDoubleUnderscore=new RegExp(String.raw`^((?:\0\d+[cno]\x7F)*)(-{4,})|__(${l.filter(oe).join("|")})__|＿{2}(${l.filter(x=>!oe(x)).map(x=>x.slice(2,-2)).join("|")})＿{2}`,"gimu")),e!=="root"&&(e!=="ext-inner"||s!=="poem")&&(t=`\0${t}`),t=t.replace(r.regexHrAndDoubleUnderscore,(x,p,g,v,y)=>{var I;if(g)return new Aa(g,r,i),`${p}\0${i.length-1}r`;const C=v!=null?v:y,b=r.sensitiveDoubleUnderscore.has(C),T=C.toLowerCase(),w=r.insensitiveDoubleUnderscore.has(T);return b||w?(new ue(C,b,!!y,r,i),`\0${i.length-1}${w&&((I=o==null?void 0:o[T])!=null?I:T)==="toc"?"u":"n"}`):x}),r.excludes.includes("heading")||(t=t.replace(/^((?:\0\d+[cn]\x7F)*)(={1,6})(.+)\2((?:\s|\0\d+[cn]\x7F)*)$/gmu,(x,p,g,v,y)=>{const C=`${p}\0${i.length}h`;return new Nt(g.length,[v,y],r,i),C})),e==="root"||e==="ext-inner"&&s==="poem"?t:t.slice(1)}}}),ka,ro=f({"src/nowiki/quote.ts"(){"use strict";var t,e;$t(),ka=(e=class extends et{constructor(r,i,n,a){super(r,n,a);k(this,t);$(this,t,i)}get type(){return"quote"}get bold(){return this.innerText.length!==2}get italic(){return this.innerText.length!==3}get closing(){}text(){const{parentNode:r,innerText:i}=this;return r!=null&&r.is("image-parameter")&&r.name!=="caption"?"":i}lint(r=this.getAbsoluteIndex()){}json(r,i=this.getAbsoluteIndex()){}},t=new WeakMap,e)}}),Sa={};M(Sa,{parseQuotes:()=>wr});var wr,$a=f({"parser/quotes.ts"(){"use strict";ro(),wr=(t,e,s,r)=>{var p;const i=t.split(/('{2,})/u),{length:n}=i;if(n===1)return t;let a=0,o=0,l,h,u;for(let g=1;g<n;g+=2){const v=i[g].length;switch(v){case 2:o++;break;case 4:i[g-1]+="'",i[g]="'''";case 3:if(a++,l!==void 0)break;i[g-1].endsWith(" ")?h===void 0&&u===void 0&&(u=g):i[g-1].slice(-2,-1)===" "?l=g:h!=null||(h=g);break;default:i[g-1]+="'".repeat(v-5),i[g]="'''''",o++,a++}}if(o%2===1&&a%2===1){const g=(p=l!=null?l:h)!=null?p:u;g!==void 0&&(i[g]="''",i[g-1]+="'")}let d=!1,x=!1;for(let g=1;g<n;g+=2){const v=i[g].length,y=v!==2,C=v!==3,b=new ka(i[g],{bold:y&&!!d,italic:C&&!!x},e,s);y&&(d=!d&&b),C&&(x=!x&&b),i[g]=`\0${s.length-1}q`}return i.join("")}}}),Ca={};M(Ca,{parseExternalLinks:()=>_r});var _r,Ia=f({"parser/externalLinks.ts"(){"use strict";D(),Kn(),xr(),_r=(t,e,s,r)=>{var i;return(i=e.regexExternalLinks)!=null||(e.regexExternalLinks=new RegExp(String.raw`\[((?:\0\d+[cn]\x7F)*(?:\0\d+f\x7F|(?:(?:${e.protocol}|//)${ce}|\0\d+m\x7F)${ge}(?=[[\]<>"\t${At}]|\0\d)))([${At}]*(?![${At}]))([^\]\x01-\x08\x0A-\x1F\uFFFD]*)\]`,"giu")),t.replace(e.regexExternalLinks,(n,a,o,l)=>{const{length:h}=s,u=/&[lg]t;/u.exec(a);return u&&(o="",l=a.slice(u.index)+o+l,a=a.slice(0,u.index)),r?(new me(a,"ext-link-url",e,s),`[\0${h}f${o}${l}]`):(new Et(a,o,l,e,s),`\0${h}w`)})}}}),Na,io=f({"src/link/category.ts"(){"use strict";fe(),Na=class extends ut{get type(){return"category"}get sortkey(){}json(t,e=this.getAbsoluteIndex()){}}}}),Fa={};M(Fa,{parseLinks:()=>er});var Xi,er,no=f({"parser/links.ts"(){"use strict";D(),rt(),$a(),Ia(),Xn(),Un(),io(),Xi=/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(\||\0\d+!\x7F)([\s\S]*)$/u,er=(t,e,s,r,i)=>{var l;(l=e.regexLinks)!=null||(e.regexLinks=new RegExp(String.raw`^\s*(?:${e.protocol}|//)`,"iu"));const n=e.inExt?/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(?:(\||\0\d+!\x7F)([\s\S]*?[^\]]))?\]\]([\s\S]*)$/u:/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])*)(?:(\||\0\d+!\x7F)([\s\S]*?[^\]])?)?\]\]([\s\S]*)$/u,a=t.split("[[");let o=a.shift();for(let h=0;h<a.length;h++){let u=!1,d,x,p,g;const v=a[h],y=n.exec(v);if(y)[,d,x,p,g]=y,g.startsWith("]")&&(p!=null&&p.includes("["))&&(p+="]",g=g.slice(1));else{const L=Xi.exec(v);L&&(u=!0,[,d,x,p]=L)}if(d===void 0||e.regexLinks.test(d)||/\0\d+[exhbru]\x7F/u.test(d)){o+=`[[${v}`;continue}let C=H(d).trim();const b=C.startsWith(":");if(b&&u){o+=`[[${v}`;continue}else!C&&p&&!p.includes(`
`)&&(C=H(p).trim());const{ns:T,valid:w}=V.normalizeTitle(C,0,!1,e,{halfParsed:!0,temporary:!0,decode:!0,selfLink:!0,page:r});if(w){if(u){if(T!==6){o+=`[[${v}`;continue}let L=!1;for(h++;h<a.length;h++){const P=a[h],m=P.split("]]");if(m.length>2){L=!0,p+=`[[${m[0]}]]${m[1]}`,g=m.slice(2).join("]]");break}else if(m.length===2)p+=`[[${m[0]}]]${m[1]}`;else{p+=`[[${P}`;break}}if(p=er(p,e,s,r,i),!L){o+=`[[${d}${x}${p}`;continue}}}else{o+=`[[${v}`;continue}p&&(p=wr(p,e,s,i));let I=gr;b||(T===6?(p&&(p=_r(p,e,s,!0)),I=cr):T===14&&(I=Na)),p===void 0&&x&&(p=""),o+=`\0${s.length}l${g}`,new I(d,p,e,s,x)}return o}}}),La={};M(La,{parseMagicLinks:()=>Ea});var Rs,js,Os,Ws,Ea,ao=f({"parser/magicLinks.ts"(){"use strict";D(),xr(),Rs=String.raw`[${At}\t]|&nbsp;|&#0*160;|&#x0*a0;`,js=`(?:${Rs})+`,Os=`(?:${Rs}|-)`,Ws=String.raw`(?:RFC|PMID)${js}\d+\b|ISBN${js}(?:97[89]${Os}?)?(?:\d${Os}?){9}[\dx]\b`,Ea=(t,e,s)=>{if(!e.regexMagicLinks)try{e.regexMagicLinks=new RegExp(String.raw`(^|[^\p{L}\p{N}_])(?:(?:${e.protocol})(${ce}${ge})|${Ws})`,"giu")}catch{e.regexMagicLinks=new RegExp(String.raw`(^|\W)(?:(?:${e.protocol})(${ce}${ge})|${Ws})`,"giu")}return t.replace(e.regexMagicLinks,(r,i,n)=>{let a=i?r.slice(i.length):r;if(n){let o="";const l=/&(?:lt|gt|nbsp|#x0*(?:3[ce]|a0)|#0*(?:6[02]|160));/iu.exec(a);l&&(o=a.slice(l.index),a=a.slice(0,l.index));const h=a.includes("(")?/[^,;\\.:!?][,;\\.:!?]+$/u:/[^,;\\.:!?)][,;\\.:!?)]+$/u,u=h.exec(a);if(u){let d=1;u[0][1]===";"&&/&(?:[a-z]+|#x[\da-f]+|#\d+)$/iu.test(a.slice(0,u.index))&&(d=2),o=a.slice(u.index+d)+o,a=a.slice(0,u.index+d)}return o.length>=n.length?r:(new me(a,void 0,e,s),`${i}\0${s.length-1}w${o}`)}else if(!/^(?:RFC|PMID|ISBN)/u.test(a))return r;return new me(a,"magic-link",e,s),`${i}\0${s.length-1}i`})}}}),Pa,lo=f({"util/html.ts"(){"use strict";Pa=(t,e)=>t.startsWith(e)?e.length:[...e].findIndex((s,r)=>s!==t[r])}}),Ba,oo=f({"src/nowiki/list.ts"(){"use strict";va(),Ba=class extends vr{get type(){return"list"}lint(t=this.getAbsoluteIndex()){}}}}),Ra={};M(Ra,{parseList:()=>ja});var ja,uo=f({"parser/list.ts"(){"use strict";lo(),oo(),ba(),ja=(t,e,s,r)=>{const i=/^((?:\0\d+[cno]\x7F)*)([;:*#]+)(\s*)/u.exec(t);if(!i)return e.lastPrefix="",t;const[n,a,o,l]=i,h=o.replace(/;/gu,":"),u=Pa(h,e.lastPrefix),d=((u>1?o.slice(u-1):o)+l).split(/(?=;)/u),x=d[0].startsWith(";");let p=d.length-(x?0:1);if(u>1){const _=o.slice(0,u-1);if(x){const S=_.split(/(?=;)/u);d.unshift(...S),p+=_.includes(";")?S.length:0}else d[0]=_+d[0]}e.lastPrefix=h;let g=a+d.map((_,S)=>`\0${r.length+S}d`).join("")+t.slice(n.length);for(const _ of d)new Ba(_,s,r);if(!p)return g;const{html:[v,,y]}=s,C=/:+|-\{|\0\d+[xq]\x7F/gu;let b=C,T=b.exec(g),w=0,I=!1,L=!1,P=0;const m=(_,S)=>(new br(_,s,r),`${g.slice(0,S)}\0${r.length-1}d${g.slice(S+_.length)}`),A=_=>{_?w&&w--:w++};for(;T&&p;){const{0:_,index:S}=T;if(_==="-{"){if(!P){const{lastIndex:F}=b;b=/-\{|\}-/gu,b.lastIndex=F}P++}else if(_==="}-"){if(P--,!P){const{lastIndex:F}=b;b=C,b.lastIndex=F}}else if(_.endsWith("x")){const{name:F,closing:q,selfClosing:z}=r[Number(_.slice(1,-2))];(v.includes(F)||!z&&!y.includes(F))&&A(q)}else if(_.endsWith("q")){const{bold:F,italic:q}=r[Number(_.slice(1,-2))];F&&(A(I),I=!I),q&&(A(L),L=!L)}else if(w===0){if(_.length>=p)return m(_.slice(0,p),S);p-=_.length,b.lastIndex=S+4+String(r.length).length,g=m(_,S)}T=b.exec(g)}return g}}}),Ji,Ki,qs,Yi,he,ho=f({"src/converterFlags.ts"(){"use strict";var t,e;qe(),Q(),E(),St(),Ji=new Set(["A","T","R","D","-","H","N"]),Ki=[ve(),G],he=(e=class extends(Yi=N){constructor(r,i,n=[]){super(void 0,i,n,{});k(this,t);this.safeAppend(r.map(a=>new st(a,"converter-flag",i,n)))}get type(){return"converter-flags"}afterBuild(){$(this,t,this.childNodes.map(r=>r.text().trim())),super.afterBuild()}toString(r){return super.toString(r,";")}text(){return super.text(";")}getUnknownFlags(){return new Set(c(this,t).filter(r=>/\{{3}[^{}]+\}{3}/u.test(r)))}getVariantFlags(){const r=new Set(this.getAttribute("config").variants);return new Set(c(this,t).filter(i=>r.has(i)))}isInvalidFlag(r,i,n,a){return typeof r=="object"&&(r=r.text().trim(),i=this.getVariantFlags(),n=this.getUnknownFlags(),a=new Set(c(this,t).filter(o=>Ji.has(o)))),!!r&&!i.has(r)&&!n.has(r)&&(i.size>0||!a.has(r))}lint(r=this.getAbsoluteIndex(),i){}print(){return super.print({sep:";"})}},t=new WeakMap,e),qs=W(Yi),he=j(qs,0,"ConverterFlagsToken",Ki,he),R(qs,1,he)}}),Ie,Zi,Ms,tn,_t,po=f({"src/converterRule.ts"(){"use strict";ht(),Q(),rt(),E(),St(),Ie=(t,e,s,r)=>{const i=new N(t,s,r);return i.type=`converter-rule-${e}`,i.setAttribute("stage",J),i},Zi=[G],_t=class extends(tn=N){get type(){return"converter-rule"}get variant(){}constructor(t,e=!0,s=V.getConfig(),r=[]){super(void 0,s,r,{});const i=t.indexOf(":"),n=t.slice(0,i).indexOf("=>"),a=n===-1?t.slice(0,i):t.slice(n+2,i);e&&s.variants.includes(a.trim().toLowerCase())?(super.insertAt(new st(a,"converter-rule-variant",s,r)),super.insertAt(Ie(t.slice(i+1),"to",s,r)),n!==-1&&super.insertAt(Ie(t.slice(0,n),"from",s,r),0)):super.insertAt(Ie(t,"to",s,r))}toString(t){const{childNodes:e,firstChild:s,lastChild:r}=this;return e.length===3?`${s.toString(t)}=>${e[1].toString(t)}:${r.toString(t)}`:super.toString(t,":")}text(){const{childNodes:t,firstChild:e,lastChild:s}=this;return t.length===3?`${e.text()}=>${t[1].text()}:${s.text()}`:super.text(":")}getGaps(t){return t===0&&this.length===3?2:1}print(){{const{childNodes:t}=this;if(t.length===3){const[e,s,r]=t;return`<span class="wpb-converter-rule">${e.print()}=>${s.print()}:${r.print()}</span>`}return super.print({sep:":"})}}json(t,e=this.getAbsoluteIndex()){}},Ms=W(tn),_t=j(Ms,0,"ConverterRuleToken",Zi,_t),R(Ms,1,_t)}}),en,Us,sn,de,co=f({"src/converter.ts"(){"use strict";D(),dt(),Q(),E(),ho(),po(),en=[G,lt("-{")],de=class extends(sn=N){get type(){return"converter"}constructor(t,e,s,r=[]){super(void 0,s,r),this.insertAt(new he(t,s,r));const[i]=e,n=i.includes(":"),a=new _t(i,n,s,r);(n?a.length===1:e.length===2&&!H(e[1]).trim())?this.insertAt(new _t(e.join(";"),!1,s,r)):this.safeAppend([a,...e.slice(1).map(o=>new _t(o,!0,s,r))])}toString(t){const{childNodes:[e,...s]}=this;return`-{${e.toString(t)}${e.length>0?"|":""}${s.map(r=>r.toString(t)).join(";")}}-`}text(){const{childNodes:[t,...e]}=this;return`-{${t.text()}|${yt(e,";")}}-`}getGaps(t){return t||this.firstChild.length>0?1:0}print(){{const{childNodes:[t,...e]}=this;return`<span class="wpb-converter">-{${t.print()}${t.length>0?"|":""}${Wt(e,{sep:";"})}}-</span>`}}},Us=W(sn),de=j(Us,0,"ConverterToken",en,de),R(Us,1,de)}}),Oa={};M(Oa,{parseConverter:()=>Wa});var Wa,go=f({"parser/converter.ts"(){"use strict";co(),Wa=(t,e,s)=>{var l;(l=e.regexConverter)!=null||(e.regexConverter=new RegExp(String.raw`;(?=(?:[^;]*?=>)?\s*(?:${e.variants.join("|")})\s*:|(?:\s|\0\d+[cn]\x7F)*$)`,"iu"));const r=/-\{/gu,i=/-\{|\}-/gu,n=[];let a=r,o=a.exec(t);for(;o;){const{0:h,index:u}=o;if(h==="}-"){const d=n.pop(),{length:x}=s,p=t.slice(d.index+2,u),g=p.indexOf("|"),[v,y]=g===-1?[[],p]:[p.slice(0,g).split(";"),p.slice(g+1)],C=y.replace(/(&[#a-z\d]+);/giu,"$1"),b=C.split(e.regexConverter).map(T=>T.replace(/\x01/gu,";"));new de(v,b,e,s),t=`${t.slice(0,d.index)}\0${x}v${t.slice(u+2)}`,n.length===0&&(a=r),a.lastIndex=d.index+3+String(x).length}else n.push(o),a=i,a.lastIndex=u+2;o=a.exec(t)}return t}}}),Re={};M(Re,{Token:()=>N});var N,E=f({"src/index.ts"(){"use strict";var t,e,s,r,i,n,a,o,l,qa,Ma,Ua,za,Da,Ha,Ga,Va,Qa,Xa,Ja,Ka,I;D(),ht(),Oe(),ft(),rt(),vl(),bl(),N=(I=class extends Zt{constructor(m,A=V.getConfig(),_=[],S){super();k(this,l);k(this,t,"plain");k(this,e,0);k(this,s);k(this,r);k(this,i);k(this,n,!1);k(this,a);k(this,o);typeof m=="string"&&this.insertAt(m),$(this,s,A),$(this,r,_),_.push(this)}get type(){return c(this,t)}set type(m){$(this,t,m)}get pageName(){return c(this.getRootNode(),o)}set pageName(m){if(m){const A=this.normalizeTitle(m,0,{temporary:!0,page:""});$(this,o,A.valid?A.title:void 0)}else $(this,o,m===""?"":void 0)}parseOnce(m=c(this,e),A=!1,_){if(m<c(this,e)||this.length!==1||!this.isPlain())return this;if(c(this,e)>=J)return this;switch(m){case 0:if(this.type==="root"){c(this,r).pop();const S=B(this,l,qa).call(this);A&&(A=!S)}$(this,i,A),B(this,l,Ma).call(this,A);break;case 1:B(this,l,Ua).call(this);break;case 2:B(this,l,za).call(this);break;case 3:B(this,l,Da).call(this);break;case 4:B(this,l,Ha).call(this);break;case 5:B(this,l,Ga).call(this,_);break;case 6:B(this,l,Va).call(this,_);break;case 7:B(this,l,Qa).call(this);break;case 8:B(this,l,Xa).call(this);break;case 9:B(this,l,Ja).call(this);break;case 10:B(this,l,Ka).call(this)}if(this.type==="root")for(const S of c(this,r))S==null||S.parseOnce(m,A,_);return Sr(this,e)._++,this}buildFromStr(m,A){const _=m.split(/[\0\x7F]/u).map((S,F)=>{if(F%2===0)return S&&new Xs(S);const q=Number(S.slice(0,-1));return c(this,r)[q]}).filter(S=>S!=="");return A===0?_.map(String).join(""):A===1?yt(_):_}build(){$(this,e,J);const{length:m,firstChild:A}=this,_=A==null?void 0:A.toString();if(m===1&&A.type==="text"&&_.includes("\0")&&(yr(this,0,1,this.buildFromStr(_)),this.type==="root"))for(const S of c(this,r))S==null||S.build()}afterBuild(){if(this.type==="root")for(const m of c(this,r))m==null||m.afterBuild();$(this,n,!0)}parse(m=J,A,_){for(m=Math.min(m,J);c(this,e)<m;)this.parseOnce(c(this,e),A,_);return m&&(this.build(),this.afterBuild()),this}isPlain(){return this.constructor===I}getAttribute(m){var A;switch(m){case"config":return c(this,s);case"include":return(A=c(this,i))!=null?A:!!c(this.getRootNode(),i);case"accum":return c(this,r);case"built":return c(this,n);case"stage":return c(this,e);case"invalid":return this.type==="table-inter"&&Fe(this)===2;default:return super.getAttribute(m)}}setAttribute(m,A){switch(m){case"stage":c(this,e)===0&&this.type==="root"&&c(this,r).shift(),$(this,e,A);break;default:super.setAttribute(m,A)}}insertAt(m,A=this.length){const _=typeof m=="string"?new Xs(m):m,{length:S}=this;A+=A<0?S:0,super.insertAt(_,A);const{type:F}=_;return F==="root"&&(_.type="plain"),_}normalizeTitle(m,A=0,_){return V.normalizeTitle(m,A,this.getAttribute("include"),c(this,s),{page:this.pageName,..._})}inTableAttrs(){var m;return this.isInside("table-attrs")&&((m=this.closest("table-attrs,arg,parameter"))!=null&&m.is("table-attrs")?2:1)}inHtmlAttrs(){return this.isInside("html-attrs")?2:this.inTableAttrs()}lint(m=this.getAbsoluteIndex(),A){}toString(m,A){return m?super.toString(!0,A):jt(c(this,a),()=>super.toString(!1,A),_=>{const S=this.getRootNode();S.type==="root"&&c(S,n)&&$(this,a,_)})}},t=new WeakMap,e=new WeakMap,s=new WeakMap,r=new WeakMap,i=new WeakMap,n=new WeakMap,a=new WeakMap,o=new WeakMap,l=new WeakSet,qa=function(){const{parseRedirect:m}=(Al(),O(_n)),A=this.firstChild.toString(),_=m(A,c(this,s),c(this,r));return _!==!1&&this.setText(_),!!_},Ma=function(m){const{parseCommentAndExt:A}=(He(),O(pa));this.setText(A(this.firstChild.toString(),c(this,s),c(this,r),m))},Ua=function(){const{parseBraces:m}=(pr(),O(Rn)),A=this.type==="root"?this.firstChild.toString():`\0${this.firstChild.toString()}`,_=m(A,c(this,s),c(this,r));this.setText(this.type==="root"?_:_.slice(1))},za=function(){if(c(this,s).excludes.includes("html"))return;const{parseHtml:m}=(Ql(),O(ca));this.setText(m(this.firstChild.toString(),c(this,s),c(this,r)))},Da=function(){if(c(this,s).excludes.includes("table"))return;const{parseTable:m}=(Yl(),O(wa));this.setText(m(this,c(this,s),c(this,r)))},Ha=function(){if(c(this,s).excludes.includes("hr"))return;const{parseHrAndDoubleUnderscore:m}=(so(),O(ya));this.setText(m(this,c(this,s),c(this,r)))},Ga=function(m){const{parseLinks:A}=(no(),O(Fa));this.setText(A(this.firstChild.toString(),c(this,s),c(this,r),this.pageName,m))},Va=function(m){const{parseQuotes:A}=($a(),O(Sa)),_=this.firstChild.toString().split(`
`);for(let S=0;S<_.length;S++)_[S]=A(_[S],c(this,s),c(this,r),m);this.setText(_.join(`
`))},Qa=function(){const{parseExternalLinks:m}=(Ia(),O(Ca));this.setText(m(this.firstChild.toString(),c(this,s),c(this,r)))},Xa=function(){const{parseMagicLinks:m}=(ao(),O(La));this.setText(m(this.firstChild.toString(),c(this,s),c(this,r)))},Ja=function(){if(c(this,s).excludes.includes("list"))return;const{parseList:m}=(uo(),O(Ra)),{firstChild:A,type:_,name:S}=this,F=A.toString().split(`
`),q={lastPrefix:""};let z=_==="root"||_==="ext-inner"&&S==="poem"?0:1;for(;z<F.length;z++)F[z]=m(F[z],q,c(this,s),c(this,r));this.setText(F.join(`
`))},Ka=function(){if(c(this,s).variants.length>0){const{parseConverter:m}=(go(),O(Oa));this.setText(m(this.firstChild.toString(),c(this,s),c(this,r)))}},I)}}),at,Ar,yr,Ya,ft=f({"util/debug.ts"(){"use strict";at={running:!1,run(t,e){const{running:s}=this;this.running=!0;const r=e==null?void 0:e.internal;e&&(e.internal=!0);const i=()=>{this.running=s,e&&(e.internal=r)};try{const{Token:n}=(E(),O(Re)),a=t();return a instanceof n&&!a.getAttribute("built")&&a.afterBuild(),i(),a}catch(n){throw i(),n}},internal(t,e){const{internal:s}=e;e.internal=!0;const r=t();return e.internal=s,r},rev:0},Ar=t=>e=>e.type===t,yr=(t,e,s,r=[])=>{var a,o;let i=t.getChildNodes(),n;i.length===s?(n=i,i=r):n=Array.prototype.splice.apply(i,[e,s,...r]);for(let l=0;l<r.length;l++){const h=r[l];h.setAttribute("parentNode",t),h.setAttribute("nextSibling",i[e+l+1]),h.setAttribute("previousSibling",i[e+l-1])}return(a=i[e-1])==null||a.setAttribute("nextSibling",i[e]),(o=i[e+r.length])==null||o.setAttribute("previousSibling",i[e+r.length-1]),i===r&&t.setAttribute("childNodes",i),n},Ya=(t,e)=>{const s=t.toLowerCase(),[r,i]=e,n=Object.prototype.hasOwnProperty.call(i,t);return[s,n,n?i[t]:Object.prototype.hasOwnProperty.call(r,s)&&r[s]]}}}),zs,sr,xo=f({"lib/title.ts"(){"use strict";var t,e,s,r,i,n,Za,o;je(),D(),zs=l=>{const[,{length:h},u]=/^((?:\.\.\/)*)([\s\S]*)/u.exec(l);return[h/3,u]},sr=(o=class{constructor(l,h,u,{temporary:d,decode:x,selfLink:p,page:g}={}){k(this,n);k(this,t);k(this,e);k(this,s);k(this,r);k(this,i);nt(this,"page");nt(this,"valid");nt(this,"encoded",!1);this.page=g;const v=l.trim(),y=v.startsWith("../");if(x&&l.includes("%"))try{const w=/%(?!21|3[ce]|5[bd]|7[b-d])[\da-f]{2}/iu.test(l);l=Qs(l),this.encoded=w}catch{}if(l=Gs(l).replace(/[_ ]+/gu," ").trim(),y||g&&v.startsWith("/"))$(this,r,0);else{let w=h;l.startsWith(":")&&(w=0,l=l.slice(1).trim());const I=l.split(":");if(I.length>1){const L=Ot(I[0]),P=Object.prototype.hasOwnProperty.call(u.nsid,L)&&u.nsid[L];P&&(w=P,l=I.slice(1).join(":").trim())}$(this,r,w)}const C=l.indexOf("#");if(C!==-1){let w=l.slice(C).trim().slice(1);if(w.includes("%"))try{w=Qs(w)}catch{}$(this,i,w.replace(/ /gu,"_")),l=l.slice(0,C).trim()}const[b,T]=y?zs(l):[0,l];this.valid=!!(l||p&&this.ns===0&&c(this,i)!==void 0)&&Gs(l)===l&&(b===0||g===void 0||g.split("/",b+1).length>b)&&!/^:|\0\d+[eh!+-]\x7F|[<>[\]{}|\n]|%[\da-f]{2}|(?:^|\/)\.{1,2}(?:$|\/)/iu.test(T),this.main=l,$(this,e,u.namespaces),$(this,s,u.articlePath||"/wiki/$1"),c(this,s).includes("$1")||$(this,s,c(this,s)+`${c(this,s).endsWith("/")?"":"/"}$1`)}get ns(){return c(this,r)}get fragment(){return c(this,i)}get main(){return c(this,t)}set main(l){l=l.replace(/_/gu," ").trim(),$(this,t,l&&l[0].toUpperCase()+l.slice(1))}get prefix(){const l=c(this,e)[this.ns];return l+(l&&":")}get title(){return this.getRedirection()[1]}get extension(){const{main:l}=this,h=l.lastIndexOf(".");return h===-1?void 0:l.slice(h+1).toLowerCase()}getRedirection(){const{prefix:l}=this,h=l;return B(this,n,Za).call(this,h)}setFragment(l){$(this,i,l)}getUrl(l){throw new Error("Title.getUrl method is only available in the LSP version!")}},t=new WeakMap,e=new WeakMap,s=new WeakMap,r=new WeakMap,i=new WeakMap,n=new WeakSet,Za=function(l){var u,d;let h=(l+this.main).replace(/ /gu,"_");if(h.startsWith("/"))h=((u=this.page)!=null?u:"")+h.replace(/(.)\/$/u,"$1");else if(h.startsWith("../")&&((d=this.page)!=null&&d.includes("/"))){const[x,p]=zs(h),g=this.page.split("/");g.length>x&&(h=g.slice(0,-x).join("/")+(p&&"/")+p)}return[!1,h]},o)}}),tl={};M(tl,{default:()=>V});el.exports=O(tl);var Ne,rn,It,Ds,nn,V,rt=f({"index.ts"(){ft(),ht(),D(),xo(),Ne=!0,rn=(t,e,s)=>typeof t=="string"?[!!e,s,t]:[!!t,e,s],It={config:Vs,get rules(){},get i18n(){},set i18n(t){},get lintConfig(){},set lintConfig(t){},get viewOnly(){return Ne},set viewOnly(t){Ne&&!t&&at.rev++,Ne=t},internal:!1,getConfig(t){const e=t!=null?t:this.config,{doubleUnderscore:s,ext:r,parserFunction:i,variable:n}=e;for(let a=0;a<2;a++)s.length>a+2&&s[a].length===0&&(s[a]=Object.keys(s[a+2]));return r.includes("translate")&&!n.includes("translationlanguage")&&(n.push("translationlanguage"),i[1].TRANSLATIONLANGUAGE="translationlanguage"),{...Vs,...e,excludes:[]}},msg(t,e=""){},normalizeTitle(t,e=0,s,r=It.getConfig(),i){let n;if(i!=null&&i.halfParsed)n=new sr(t,e,r,i);else{const{Token:a}=(E(),O(Re));n=at.run(()=>{const o=new a(t,r);o.type="root",o.pageName=i==null?void 0:i.page,o.parseOnce(0,s).parseOnce();const l=new sr(o.firstChild.toString(),e,r,i);o.build();for(const h of["main","fragment"]){const u=l[h];if(u!=null&&u.includes("\0")){const d=o.buildFromStr(u,1);h==="main"?l.main=d:l.setFragment(d)}}return l},this)}return n},parse(t,e,s,r,i){t=hn(t);let n,a,o,l;typeof e=="string"?(n=!!s,a=r,o=i,l=e):(n=!!e,a=s,o=r,l=i),a!=null||(a=J),o!=null||(o=this.getConfig());let h;const{Token:u}=(E(),O(Re));return at.run(()=>{const x=new u(t,o);return x.type="root",x.pageName=l,x.parse(a,n)})},parseWithRef(t,e,s,r=e.getAttribute("include")){return this.parse(t,r,s,e.getAttribute("config"),e.pageName)},createLanguageService(t={}){},lint(t,e,s,r){},print(t,e,s,r){{const[i,n,a]=rn(e,s,r);return at.internal(()=>this.parse(t,i,void 0,n,a).print(),this)}}},Ds={},nn=new Set(["lintConfig","normalizeTitle","parse","createLanguageService"]);for(const t of Object.keys(It))nn.has(t)||(Ds[t]={enumerable:!1});Object.defineProperties(It,Ds),Object.assign(typeof globalThis=="object"?globalThis:self,{Parser:It}),V=It}});rt()});mo();})();
