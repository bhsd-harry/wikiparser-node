...
`})}json(e,t=this.getAbsoluteIndex()){let n=super.json(void 0,t);return Object.assign(n,{widths:this.widths,heights:this.heights}),n}};lt=new WeakSet,ys=function(e){return this.normalizeTitle(e,6,{halfParsed:!0,temporary:!0,decode:!0}).valid},Bn=function(e){var i,s;let t=(i=this.parentNode)==null?void 0:i.getAttr(e),n=typeof t=="string"&&((s=/^(\d+)\s*(?:px)?$/u.exec(t))==null?void 0:s[1]);return n&&Number(n)||120}});var zt,On=y(()=>{"use strict";q();ur();zt=class extends Ce{get type(){return"link"}lint(r=this.getAbsoluteIndex(),e){let t=super.lint(r,e);return this.closest("ext-link-text")&&t.push(F(this,{start:r},"nested-link","internal link in an external link")),t}}});var fa,xa,yr,je,Qr=y(()=>{"use strict";q();K();V();_();j();fa=String.raw`(?:[${ke}\t]|&nbsp;|&#0*160;|&#[xX]0*[aA]0;)`,xa=new RegExp(`${fa}+`,"gu"),je=class extends k{constructor(e,t="free-ext-link",n=A.getConfig(),i){super(e,n,i,{});T(this,yr);b(this,yr,t)}get type(){return c(this,yr)}get innerText(){let e=new Map([["!","|"],["=","="]]),t=fe(this.childNodes.map(n=>{let{type:i}=n,s=String(n.name);return i==="magic-word"&&e.has(s)?e.get(s):n}));return this.type==="magic-link"&&(t=t.replace(xa," ")),t}get link(){let{innerText:e}=this;return this.type==="magic-link"?e.startsWith("ISBN")?`ISBN ${e.slice(5).replace(/[- ]/gu,"").replace(/x$/u,"X")}`:e:yi(e)}lint(e=this.getAbsoluteIndex(),t){let n=super.lint(e,t),i=new P(this,e),{type:s,childNodes:o}=this;if(s==="magic-link"){let{link:g}=this;if(g.startsWith("ISBN")){let u=[...g.slice(5)].map(h=>h==="X"?10:Number(h));(u.length===10&&u.reduce((h,f,m)=>h+f*(10-m),0)%11||u.length===13&&(u[12]===10||u.reduce((h,f,m)=>h+f*(m%2?3:1),0)%10))&&n.push(F(this,i,"invalid-isbn","invalid ISBN"))}return n}let l=s==="ext-link-url",d=l?/\|/u:/[，；。：！？（）]+/u,p=o.find(g=>g.type==="text"&&d.test(g.data));if(p){let{data:g}=p,u=w(p,i,"unterminated-url",A.msg("$1 in URL",l?'"|"':"full-width punctuation"),"warning"),{index:h,0:f}=d.exec(g),m=u.startIndex+h;u.suggestions=l?[{desc:"whitespace",range:[m,m+1],text:" "}]:[{desc:"whitespace",range:[m,m],text:" "},{desc:"escape",range:[m,m+f.length],text:encodeURI(f)}],n.push(u)}return n}getUrl(e){}};yr=new WeakMap});var Be,Wt,qn=y(()=>{"use strict";q();_();j();Qr();Wt=class extends k{constructor(e,t="",n="",i=A.getConfig(),s=[]){super(void 0,i,s,{});T(this,Be);let o=e&&/^\0\d+f\x7F$/u.test(e)?s[Number(e.slice(1,-2))]:new je(e,"ext-link-url",i,s);if(this.insertAt(o),b(this,Be,t),n){let l=new k(n,i,s,{});l.type="ext-link-text",l.setAttribute("stage",10),this.insertAt(l)}}get type(){return"ext-link"}toString(e){return this.length===1?`[${super.toString(e)}${c(this,Be)}]`:`[${super.toString(e,c(this,Be))}]`}text(){return`[${super.text(" ")}]`}getAttribute(e){return e==="padding"?1:super.getAttribute(e)}getGaps(){return c(this,Be).length}lint(e=this.getAbsoluteIndex(),t){let n=super.lint(e,t);return this.length===1&&this.closest("heading-title")&&n.push(F(this,{start:e},"var-anchor","variable anchor in a section header")),n}print(){return super.print(this.length===1?{pre:"[",post:`${c(this,Be)}]`}:{pre:"[",sep:c(this,Be),post:"]"})}};Be=new WeakMap});var kr,vs=y(()=>{"use strict";j();Ge();On();qn();kr=class extends k{get type(){return"imagemap-link"}constructor(r,e,t,n,i=[]){super(void 0,n,i),this.append(r,e.length===2?new zt(...e,n,i):new Wt(...e,n,i),new U(t,n,i))}}});var Kr,As=y(()=>{"use strict";q();ce();V();_();j();Ge();jn();vs();Kr=class extends k{get type(){return"ext-inner"}get image(){return this.childNodes.find(qt("imagemap-image"))}constructor(r,e=A.getConfig(),t=[]){if(super(void 0,e,t,{}),!r)return;let n=r.split(`
