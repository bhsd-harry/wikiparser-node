...
`})}};yr=new WeakSet,Pi=function(e){return this.normalizeTitle(e,6,!0,!0).valid}});var At,un=b(()=>{"use strict";j();Ot();At=class extends Ce{get type(){return"link"}lint(n=this.getAbsoluteIndex(),e){let t=super.lint(n,e);return this.closest("ext-link-text")&&t.push($(this,{start:n},"nested-link","internal link in an external link")),t}}});var So,Co,Vt,Ie,vr=b(()=>{"use strict";j();Q();X();R();B();So=String.raw`(?:[\p{Zs}\t]|&nbsp;|&#0*160;|&#[xX]0*[aA]0;)`,Co=new RegExp(`${So}+`,"gu"),Ie=class extends T{constructor(e,t="free-ext-link",r=f.getConfig(),i){super(e,r,i,{});k(this,Vt);A(this,Vt,t)}get type(){return c(this,Vt)}get innerText(){let e=new Map([["!","|"],["=","="]]),t=de(this.childNodes.map(r=>{let{type:i}=r,s=String(r.name);return i==="magic-word"&&e.has(s)?e.get(s):r}));return this.type==="magic-link"&&(t=t.replace(Co," ")),t}get link(){let{innerText:e}=this;return this.type==="magic-link"&&e.startsWith("ISBN")&&(e=`ISBN ${e.slice(5).replace(/[- ]/gu,"").replace(/x$/u,"X")}`),e}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t),i=new I(this,e);if(this.type==="magic-link"){let{link:g}=this;if(g.startsWith("ISBN")){let p=[...g.slice(5)].map(d=>d==="X"?10:Number(d));(p.length===10&&p.reduce((d,u,h)=>d+u*(10-h),0)%11||p.length===13&&(p[12]===10||p.reduce((d,u,h)=>d+u*(h%2?3:1),0)%10))&&r.push($(this,i,"invalid-isbn","invalid ISBN"))}return r}let s=this.type==="ext-link-url",o=s?/\|/u:/[，；。：！？（）]+/u,l=this.childNodes.find(g=>g.type==="text"&&o.test(g.data));if(l){let{data:g}=l,p=S(l,i,"unterminated-url",f.msg("$1 in URL",s?'"|"':"full-width punctuation"),"warning"),{index:d,0:u}=o.exec(g),h=p.startIndex+d;p.suggestions=s?[{desc:"whitespace",range:[h,h+1],text:" "}]:[{desc:"whitespace",range:[h,h],text:" "},{desc:"escape",range:[h,h+u.length],text:encodeURI(u)}],r.push(p)}return r}};Vt=new WeakMap});var Le,wt,cn=b(()=>{"use strict";Se();j();R();B();vr();wt=class extends T{constructor(e,t="",r="",i=f.getConfig(),s=[]){super(void 0,i,s,{});k(this,Le);let o=e&&/\0\d+f\x7F/u.test(e)?s[Number(e.slice(1,-2))]:new Ie(e,"ext-link-url",i,s);if(this.insertAt(o),A(this,Le,t),r){let l=new T(r,i,s,{});l.type="ext-link-text",l.setAttribute("stage",10),this.insertAt(l)}}get type(){return"ext-link"}toString(){return this.length===1?`[${super.toString()}${c(this,Le)}]`:`[${super.toString(c(this,Le))}]`}text(){return`[${super.text(" ")}]`}getAttribute(e){return e==="padding"?1:super.getAttribute(e)}getGaps(){return c(this,Le).length}lint(e=this.getAbsoluteIndex(),t){let r=super.lint(e,t);return this.length===1&&this.closest("heading-title")&&r.push($(this,{start:e},"var-anchor","variable anchor in a section header")),r}print(){return super.print(this.length===1?{pre:"[",post:`${c(this,Le)}]`}:{pre:"[",sep:c(this,Le),post:"]"})}};Le=new WeakMap});var Xt,qi=b(()=>{"use strict";R();B();_e();un();cn();Xt=class extends T{get type(){return"imagemap-link"}constructor(n,e,t,r=f.getConfig(),i=[]){super(void 0,r,i),this.append(n,e.length===2?new At(...e,r,i):new wt(...e,r,i),new D(t,r,i))}}});var _i={};V(_i,{ImagemapToken:()=>hn});var hn,Oi=b(()=>{"use strict";j();Q();Te();R();B();_e();gn();qi();hn=class extends T{get type(){return"ext-inner"}get image(){return this.childNodes.find(xt("imagemap-image"))}constructor(n,e=f.getConfig(),t=[]){if(super(void 0,e,t,{}),!n)return;let r=n.split(`
