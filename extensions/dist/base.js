(() => {
const workerJS = () => {
    importScripts('https://testingcf.jsdelivr.net/gh/bhsd-harry/wikiparser-node@1.4.4-b/bundle/bundle.min.js');
...
const json = async (wikitext, include, qid) => JSON.parse(await getFeedback('json', qid, false, wikitext, include));
