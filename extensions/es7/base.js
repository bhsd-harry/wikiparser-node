...
var _a;
const version = '1.16.0', src = (_a = document.currentScript) === null || _a === void 0 ? void 0 : _a.src, file = /\/extensions\/dist\/base\.(?:min\.)?js$/u, CDN = src && file.test(src)
    ? src.replace(file, '')
...
const workerJS = () => {
    ...
    self.onmessage = ({ data }) => {
        ...
        switch (command) {
            ...
            case 'foldingRanges':
                (() => __awaiter(void 0, void 0, void 0, function* () {
                    postMessage([qid, yield getLSP(qid).provideFoldingRanges(wikitext), wikitext]);
                }))();
                break;
            case 'links':
                (() => __awaiter(void 0, void 0, void 0, function* () {
