...
Object.defineProperty(AstElement.prototype, 'children', {
	get() {
		const /** @type {AstElement} */ {childNodes} = this,
			/** @type {AstElement[]} */ children = childNodes.filter(ele => ele instanceof AstElement);
		return children;
	},
});
Object.defineProperty(AstElement.prototype, 'childElementCount', {
	get() {
		const /** @type {AstElement} */ {children} = this;
		return children.length;
	},
});
Object.defineProperty(AstElement.prototype, 'firstElementChild', {
	get() {
		const /** @type {AstElement} */ {children} = this;
		return children[0];
	},
});
Object.defineProperty(AstElement.prototype, 'lastElementChild', {
	get() {
		const /** @type {AstElement} */ {children} = this;
		return children.at(-1);
	},
});
Object.defineProperty(AstElement.prototype, 'parentElement', {
	get() {
		const /** @type {{parentNode: AstElement}} */ {parentNode} = this;
		return parentNode;
	},
});
Object.defineProperty(AstElement.prototype, 'nextElementSibling', {
	get() {
		const /** @type {AstElement} */ {parentElement} = this,
			children = parentElement?.children;
		return children?.[children?.indexOf(this) + 1];
	},
});
Object.defineProperty(AstElement.prototype, 'previousElementSibling', {
	get() {
		const /** @type {AstElement} */ {parentElement} = this,
			children = parentElement?.children;
		return children?.[children?.indexOf(this) - 1];
