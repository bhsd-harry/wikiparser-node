...
Object.defineProperty(AstNode.prototype, 'firstChild', {
	get() {
		const /** @type {AstNode} */ {childNodes} = this;
		return childNodes[0];
	},
});
Object.defineProperty(AstNode.prototype, 'lastChild', {
	get() {
		const /** @type {AstNode} */ {childNodes} = this;
		return childNodes.at(-1);
	},
});
Object.defineProperty(AstNode.prototype, 'nextSibling', {
	get() {
		const /** @type {AstNode} */ {parentNode} = this,
			childNodes = parentNode?.childNodes;
		return childNodes?.[childNodes?.indexOf(this) + 1];
	},
});
Object.defineProperty(AstNode.prototype, 'previousSibling', {
	get() {
		const /** @type {AstNode} */ {parentNode} = this,
			childNodes = parentNode?.childNodes;
		return childNodes?.[childNodes?.indexOf(this) - 1];
