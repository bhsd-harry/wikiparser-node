...
const blockAttrs = new Set(['align']),
	...
	obsoleteTdAttrs = new Set(['axis', 'align', 'bgcolor', 'height', 'nowrap', 'width', 'valign']),
...
export const htmlAttrs = /* #__PURE__ */ ((): Record<string, Set<string>> => ({
	div: blockAttrs,
	h1: blockAttrs,
	h2: blockAttrs,
	h3: blockAttrs,
...
export const obsoleteAttrs = /* #__PURE__ */ ((): Record<string, Set<string>> => ({
...
export const extParams = /* #__PURE__ */ ((): Record<string, string[]> => ({
	dynamicpagelist: [
		'category',
		'notcategory',
		'namespace',
